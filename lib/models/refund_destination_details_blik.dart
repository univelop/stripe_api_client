...
/// auto generated
class RefundDestinationDetailsBlik implements AdditionalDataHolder, Parsable {
  ...
  /// Instantiates a new [RefundDestinationDetailsBlik] and sets the default values.
  RefundDestinationDetailsBlik() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static RefundDestinationDetailsBlik createFromDiscriminatorValue(
      ParseNode parseNode) {
