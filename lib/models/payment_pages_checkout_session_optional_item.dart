...
class PaymentPagesCheckoutSessionOptionalItem
  ...
  /// Instantiates a new [PaymentPagesCheckoutSessionOptionalItem] and sets the default values.
  PaymentPagesCheckoutSessionOptionalItem() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PaymentPagesCheckoutSessionOptionalItem createFromDiscriminatorValue(
      ParseNode parseNode) {
