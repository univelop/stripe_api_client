...
/// auto generated
class ConnectEmbeddedPayoutsFeatures implements AdditionalDataHolder, Parsable {
  ...
  /// Instantiates a new [ConnectEmbeddedPayoutsFeatures] and sets the default values.
  ConnectEmbeddedPayoutsFeatures() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ConnectEmbeddedPayoutsFeatures createFromDiscriminatorValue(
      ParseNode parseNode) {
