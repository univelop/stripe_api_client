...
class TreasurySharedResourceBillingDetails
  ...
  /// Instantiates a new [TreasurySharedResourceBillingDetails] and sets the default values.
  TreasurySharedResourceBillingDetails() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static TreasurySharedResourceBillingDetails createFromDiscriminatorValue(
      ParseNode parseNode) {
