...
import './payment_links_resource_invoice_settings_metadata.dart';
...
class PaymentLinksResourceInvoiceSettings
  ...
  PaymentLinksResourceInvoiceSettingsMetadata? metadata;

  ///  Options for invoice PDF rendering.
  InvoiceSettingCheckoutRenderingOptions? renderingOptions;

  /// Instantiates a new [PaymentLinksResourceInvoiceSettings] and sets the default values.
  PaymentLinksResourceInvoiceSettings() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PaymentLinksResourceInvoiceSettings createFromDiscriminatorValue(
      ParseNode parseNode) {
  ...
  Map<String, void Function(ParseNode)> getFieldDeserializers() {
    ...
    deserializerMap['metadata'] = (node) => metadata =
        node.getObjectValue<PaymentLinksResourceInvoiceSettingsMetadata>(
  ...
  void serialize(SerializationWriter writer) {
    ...
    writer.writeObjectValue<PaymentLinksResourceInvoiceSettingsMetadata>(
        'metadata', metadata);
