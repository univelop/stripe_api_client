...
class PayoutFailureBalanceTransaction implements Parsable {
  ...
  static PayoutFailureBalanceTransaction createFromDiscriminatorValue(
      ParseNode parseNode) {
    var result = PayoutFailureBalanceTransaction();
