...
class InvoiceitemCustomer implements Parsable {
  ...
  static InvoiceitemCustomer createFromDiscriminatorValue(ParseNode parseNode) {
    var result = InvoiceitemCustomer();
