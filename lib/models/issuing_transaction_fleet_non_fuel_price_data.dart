...
class IssuingTransactionFleetNonFuelPriceData
  ...
  /// Instantiates a new [IssuingTransactionFleetNonFuelPriceData] and sets the default values.
  IssuingTransactionFleetNonFuelPriceData() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static IssuingTransactionFleetNonFuelPriceData createFromDiscriminatorValue(
      ParseNode parseNode) {
