...
/// auto generated
class SourceTypeCard implements AdditionalDataHolder, Parsable {
  ...
  /// Instantiates a new [SourceTypeCard] and sets the default values.
  SourceTypeCard() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static SourceTypeCard createFromDiscriminatorValue(ParseNode parseNode) {
