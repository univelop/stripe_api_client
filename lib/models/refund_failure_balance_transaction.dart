...
class RefundFailureBalanceTransaction implements Parsable {
  ...
  static RefundFailureBalanceTransaction createFromDiscriminatorValue(
      ParseNode parseNode) {
    var result = RefundFailureBalanceTransaction();
