...
class OutboundPaymentTransaction implements Parsable {
  ...
  static OutboundPaymentTransaction createFromDiscriminatorValue(
      ParseNode parseNode) {
    var result = OutboundPaymentTransaction();
