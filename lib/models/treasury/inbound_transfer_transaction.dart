...
class InboundTransferTransaction implements Parsable {
  ...
  static InboundTransferTransaction createFromDiscriminatorValue(
      ParseNode parseNode) {
    var result = InboundTransferTransaction();
