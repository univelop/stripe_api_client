...
class SetupIntentSingleUseMandate implements Parsable {
  ...
  static SetupIntentSingleUseMandate createFromDiscriminatorValue(
      ParseNode parseNode) {
    var result = SetupIntentSingleUseMandate();
