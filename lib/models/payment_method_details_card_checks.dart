...
/// auto generated
class PaymentMethodDetailsCardChecks implements AdditionalDataHolder, Parsable {
  ...
  /// Instantiates a new [PaymentMethodDetailsCardChecks] and sets the default values.
  PaymentMethodDetailsCardChecks() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PaymentMethodDetailsCardChecks createFromDiscriminatorValue(
      ParseNode parseNode) {
