...
/// auto generated
class PlanTier implements AdditionalDataHolder, Parsable {
  ...
  /// Instantiates a new [PlanTier] and sets the default values.
  PlanTier() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PlanTier createFromDiscriminatorValue(ParseNode parseNode) {
    return PlanTier();
  }
