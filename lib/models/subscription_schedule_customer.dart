...
class SubscriptionScheduleCustomer implements Parsable {
  ...
  static SubscriptionScheduleCustomer createFromDiscriminatorValue(
      ParseNode parseNode) {
    var result = SubscriptionScheduleCustomer();
