...
class TransferReversalBalanceTransaction implements Parsable {
  ...
  static TransferReversalBalanceTransaction createFromDiscriminatorValue(
      ParseNode parseNode) {
    var result = TransferReversalBalanceTransaction();
