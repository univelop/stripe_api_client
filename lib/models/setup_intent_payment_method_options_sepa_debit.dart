...
class SetupIntentPaymentMethodOptionsSepaDebit
  ...
  /// Instantiates a new [SetupIntentPaymentMethodOptionsSepaDebit] and sets the default values.
  SetupIntentPaymentMethodOptionsSepaDebit() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static SetupIntentPaymentMethodOptionsSepaDebit createFromDiscriminatorValue(
      ParseNode parseNode) {
  ...
  Map<String, void Function(ParseNode)> getFieldDeserializers() {
    ...
    deserializerMap['mandate_options'] = (node) => mandateOptions = node
        .getObjectValue<SetupIntentPaymentMethodOptionsMandateOptionsSepaDebit>(
