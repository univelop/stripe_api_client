...
class PaymentIntentNextActionKonbiniMinistop
  ...
  /// Instantiates a new [PaymentIntentNextActionKonbiniMinistop] and sets the default values.
  PaymentIntentNextActionKonbiniMinistop() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PaymentIntentNextActionKonbiniMinistop createFromDiscriminatorValue(
      ParseNode parseNode) {
