...
class PaymentLinksResourceCustomFieldsNumeric
  ...
  /// Instantiates a new [PaymentLinksResourceCustomFieldsNumeric] and sets the default values.
  PaymentLinksResourceCustomFieldsNumeric() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PaymentLinksResourceCustomFieldsNumeric createFromDiscriminatorValue(
      ParseNode parseNode) {
