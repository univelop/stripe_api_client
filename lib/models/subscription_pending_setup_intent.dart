...
class SubscriptionPendingSetupIntent implements Parsable {
  ...
  static SubscriptionPendingSetupIntent createFromDiscriminatorValue(
      ParseNode parseNode) {
    var result = SubscriptionPendingSetupIntent();
