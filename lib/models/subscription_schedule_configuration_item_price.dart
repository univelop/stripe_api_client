...
class SubscriptionScheduleConfigurationItemPrice implements Parsable {
  ...
  static SubscriptionScheduleConfigurationItemPrice
      createFromDiscriminatorValue(ParseNode parseNode) {
    var result = SubscriptionScheduleConfigurationItemPrice();
