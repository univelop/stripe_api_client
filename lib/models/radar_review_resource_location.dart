...
/// auto generated
class RadarReviewResourceLocation implements AdditionalDataHolder, Parsable {
  ...
  /// Instantiates a new [RadarReviewResourceLocation] and sets the default values.
  RadarReviewResourceLocation() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static RadarReviewResourceLocation createFromDiscriminatorValue(
      ParseNode parseNode) {
