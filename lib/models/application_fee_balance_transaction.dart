...
class ApplicationFeeBalanceTransaction implements Parsable {
  ...
  static ApplicationFeeBalanceTransaction createFromDiscriminatorValue(
      ParseNode parseNode) {
    var result = ApplicationFeeBalanceTransaction();
