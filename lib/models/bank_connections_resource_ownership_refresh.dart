...
class BankConnectionsResourceOwnershipRefresh
  ...
  /// Instantiates a new [BankConnectionsResourceOwnershipRefresh] and sets the default values.
  BankConnectionsResourceOwnershipRefresh() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static BankConnectionsResourceOwnershipRefresh createFromDiscriminatorValue(
      ParseNode parseNode) {
  ...
  Map<String, void Function(ParseNode)> getFieldDeserializers() {
    ...
    deserializerMap['status'] = (node) => status =
        node.getEnumValue<BankConnectionsResourceOwnershipRefreshStatus>(
            (stringValue) => BankConnectionsResourceOwnershipRefreshStatus
                .values
  ...
  void serialize(SerializationWriter writer) {
    ...
    writer.writeEnumValue<BankConnectionsResourceOwnershipRefreshStatus>(
