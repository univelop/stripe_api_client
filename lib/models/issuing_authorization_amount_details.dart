...
class IssuingAuthorizationAmountDetails
  ...
  /// Instantiates a new [IssuingAuthorizationAmountDetails] and sets the default values.
  IssuingAuthorizationAmountDetails() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static IssuingAuthorizationAmountDetails createFromDiscriminatorValue(
      ParseNode parseNode) {
