...
class SubscriptionScheduleTestClock implements Parsable {
  ...
  static SubscriptionScheduleTestClock createFromDiscriminatorValue(
      ParseNode parseNode) {
    var result = SubscriptionScheduleTestClock();
