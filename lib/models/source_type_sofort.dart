...
/// auto generated
class SourceTypeSofort implements AdditionalDataHolder, Parsable {
  ...
  /// Instantiates a new [SourceTypeSofort] and sets the default values.
  SourceTypeSofort() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static SourceTypeSofort createFromDiscriminatorValue(ParseNode parseNode) {
