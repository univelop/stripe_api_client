...
class BankConnectionsResourceBalanceCurrent
    implements AdditionalDataHolder, Parsable {
  ///  Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
  @override
  Map<String, Object?> additionalData;

  /// Instantiates a new [BankConnectionsResourceBalanceCurrent] and sets the default values.
  BankConnectionsResourceBalanceCurrent() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static BankConnectionsResourceBalanceCurrent createFromDiscriminatorValue(
      ParseNode parseNode) {
    return BankConnectionsResourceBalanceCurrent();
  }
