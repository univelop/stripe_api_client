...
/// auto generated
class PaymentFlowsAmountDetailsResourceLineItemsListResourceLineItemResourceTax
  ...
  /// Instantiates a new [PaymentFlowsAmountDetailsResourceLineItemsListResourceLineItemResourceTax] and sets the default values.
  PaymentFlowsAmountDetailsResourceLineItemsListResourceLineItemResourceTax()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PaymentFlowsAmountDetailsResourceLineItemsListResourceLineItemResourceTax
