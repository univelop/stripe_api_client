...
class IssuingAuthorizationFleetTaxData
  ...
  /// Instantiates a new [IssuingAuthorizationFleetTaxData] and sets the default values.
  IssuingAuthorizationFleetTaxData() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static IssuingAuthorizationFleetTaxData createFromDiscriminatorValue(
      ParseNode parseNode) {
