...
class PaymentMethodDetailsCardInstallments
  ...
  /// Instantiates a new [PaymentMethodDetailsCardInstallments] and sets the default values.
  PaymentMethodDetailsCardInstallments() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PaymentMethodDetailsCardInstallments createFromDiscriminatorValue(
      ParseNode parseNode) {
