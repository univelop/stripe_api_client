...
class PaymentIntentPaymentMethodOptionsBacsDebit
  ...
  PaymentIntentPaymentMethodOptionsBacsDebitSetupFutureUsage? setupFutureUsage;

  ///  Controls when Stripe will attempt to debit the funds from the customer's account. The date must be a string in YYYY-MM-DD format. The date must be in the future and between 3 and 15 calendar days from now.
  String? targetDate;

  /// Instantiates a new [PaymentIntentPaymentMethodOptionsBacsDebit] and sets the default values.
  PaymentIntentPaymentMethodOptionsBacsDebit() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PaymentIntentPaymentMethodOptionsBacsDebit
