...
class IssuingAuthorizationFleetCardholderPromptData
  ...
  /// Instantiates a new [IssuingAuthorizationFleetCardholderPromptData] and sets the default values.
  IssuingAuthorizationFleetCardholderPromptData() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static IssuingAuthorizationFleetCardholderPromptData
  ...
  Map<String, void Function(ParseNode)> getFieldDeserializers() {
    ...
    deserializerMap['alphanumeric_id'] =
        (node) => alphanumericId = node.getStringValue();
