...
class PaymentFlowsPrivatePaymentMethodsKakaoPayPaymentMethodOptions
  ...
  /// Instantiates a new [PaymentFlowsPrivatePaymentMethodsKakaoPayPaymentMethodOptions] and sets the default values.
  PaymentFlowsPrivatePaymentMethodsKakaoPayPaymentMethodOptions()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PaymentFlowsPrivatePaymentMethodsKakaoPayPaymentMethodOptions
