...
class PaymentIntentNextActionVerifyWithMicrodeposits
  ...
  /// Instantiates a new [PaymentIntentNextActionVerifyWithMicrodeposits] and sets the default values.
  PaymentIntentNextActionVerifyWithMicrodeposits() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PaymentIntentNextActionVerifyWithMicrodeposits
