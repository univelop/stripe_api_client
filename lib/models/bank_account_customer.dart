...
class BankAccountCustomer implements Parsable {
  ...
  static BankAccountCustomer createFromDiscriminatorValue(ParseNode parseNode) {
    var result = BankAccountCustomer();
