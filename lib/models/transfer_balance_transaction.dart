...
class TransferBalanceTransaction implements Parsable {
  ...
  static TransferBalanceTransaction createFromDiscriminatorValue(
      ParseNode parseNode) {
    var result = TransferBalanceTransaction();
