...
class TaxProductResourceTaxTransactionShippingCost
  ...
  /// Instantiates a new [TaxProductResourceTaxTransactionShippingCost] and sets the default values.
  TaxProductResourceTaxTransactionShippingCost() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static TaxProductResourceTaxTransactionShippingCost
  ...
  Map<String, void Function(ParseNode)> getFieldDeserializers() {
    ...
    deserializerMap['tax_behavior'] = (node) => taxBehavior = node
        .getEnumValue<TaxProductResourceTaxTransactionShippingCostTaxBehavior>(
            (stringValue) =>
                TaxProductResourceTaxTransactionShippingCostTaxBehavior.values
