...
class PaymentMethodCardWalletVisaCheckout
  ...
  /// Instantiates a new [PaymentMethodCardWalletVisaCheckout] and sets the default values.
  PaymentMethodCardWalletVisaCheckout() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PaymentMethodCardWalletVisaCheckout createFromDiscriminatorValue(
      ParseNode parseNode) {
