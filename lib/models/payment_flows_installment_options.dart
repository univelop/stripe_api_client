...
/// auto generated
class PaymentFlowsInstallmentOptions implements AdditionalDataHolder, Parsable {
  ...
  /// Instantiates a new [PaymentFlowsInstallmentOptions] and sets the default values.
  PaymentFlowsInstallmentOptions() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PaymentFlowsInstallmentOptions createFromDiscriminatorValue(
      ParseNode parseNode) {
