...
/// auto generated
class BalanceDetail implements AdditionalDataHolder, Parsable {
  ...
  /// Instantiates a new [BalanceDetail] and sets the default values.
  BalanceDetail() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static BalanceDetail createFromDiscriminatorValue(ParseNode parseNode) {
