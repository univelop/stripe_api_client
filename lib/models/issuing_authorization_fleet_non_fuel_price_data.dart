...
class IssuingAuthorizationFleetNonFuelPriceData
  ...
  /// Instantiates a new [IssuingAuthorizationFleetNonFuelPriceData] and sets the default values.
  IssuingAuthorizationFleetNonFuelPriceData() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static IssuingAuthorizationFleetNonFuelPriceData createFromDiscriminatorValue(
      ParseNode parseNode) {
