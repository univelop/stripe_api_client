...
import './payment_intent_payment_method_options_us_bank_account_preferred_settlement_speed.dart';
...
class PaymentIntentPaymentMethodOptionsUsBankAccount
  ...
  /// Instantiates a new [PaymentIntentPaymentMethodOptionsUsBankAccount] and sets the default values.
  PaymentIntentPaymentMethodOptionsUsBankAccount() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PaymentIntentPaymentMethodOptionsUsBankAccount
