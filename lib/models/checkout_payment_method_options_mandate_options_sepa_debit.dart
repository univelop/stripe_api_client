...
class CheckoutPaymentMethodOptionsMandateOptionsSepaDebit
  ...
  /// Instantiates a new [CheckoutPaymentMethodOptionsMandateOptionsSepaDebit] and sets the default values.
  CheckoutPaymentMethodOptionsMandateOptionsSepaDebit() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static CheckoutPaymentMethodOptionsMandateOptionsSepaDebit
