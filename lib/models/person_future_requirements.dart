...
/// auto generated
class PersonFutureRequirements implements AdditionalDataHolder, Parsable {
  ...
  /// Instantiates a new [PersonFutureRequirements] and sets the default values.
  PersonFutureRequirements() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PersonFutureRequirements createFromDiscriminatorValue(
      ParseNode parseNode) {
