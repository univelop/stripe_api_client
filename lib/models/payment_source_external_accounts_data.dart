...
class PaymentSourceExternalAccountsData implements Parsable {
  ...
  static PaymentSourceExternalAccountsData createFromDiscriminatorValue(
      ParseNode parseNode) {
    var result = PaymentSourceExternalAccountsData();
