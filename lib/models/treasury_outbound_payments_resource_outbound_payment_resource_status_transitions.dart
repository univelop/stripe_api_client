...
class TreasuryOutboundPaymentsResourceOutboundPaymentResourceStatusTransitions
  ...
  /// Instantiates a new [TreasuryOutboundPaymentsResourceOutboundPaymentResourceStatusTransitions] and sets the default values.
  TreasuryOutboundPaymentsResourceOutboundPaymentResourceStatusTransitions()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static TreasuryOutboundPaymentsResourceOutboundPaymentResourceStatusTransitions
