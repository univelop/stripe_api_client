...
class AccountCapabilityFutureRequirements
  ...
  AccountCapabilityFutureRequirementsDisabledReason? disabledReason;
  ...
  /// Instantiates a new [AccountCapabilityFutureRequirements] and sets the default values.
  AccountCapabilityFutureRequirements() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static AccountCapabilityFutureRequirements createFromDiscriminatorValue(
      ParseNode parseNode) {
  ...
  Map<String, void Function(ParseNode)> getFieldDeserializers() {
    ...
    deserializerMap['disabled_reason'] = (node) => disabledReason =
        node.getEnumValue<AccountCapabilityFutureRequirementsDisabledReason>(
            (stringValue) => AccountCapabilityFutureRequirementsDisabledReason
                .values
  ...
  void serialize(SerializationWriter writer) {
    ...
    writer.writeEnumValue<AccountCapabilityFutureRequirementsDisabledReason>(
