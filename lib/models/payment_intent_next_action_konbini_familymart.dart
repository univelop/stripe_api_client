...
class PaymentIntentNextActionKonbiniFamilymart
  ...
  /// Instantiates a new [PaymentIntentNextActionKonbiniFamilymart] and sets the default values.
  PaymentIntentNextActionKonbiniFamilymart() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PaymentIntentNextActionKonbiniFamilymart createFromDiscriminatorValue(
      ParseNode parseNode) {
