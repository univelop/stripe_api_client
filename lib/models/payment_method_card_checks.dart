...
/// auto generated
class PaymentMethodCardChecks implements AdditionalDataHolder, Parsable {
  ...
  /// Instantiates a new [PaymentMethodCardChecks] and sets the default values.
  PaymentMethodCardChecks() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PaymentMethodCardChecks createFromDiscriminatorValue(
      ParseNode parseNode) {
