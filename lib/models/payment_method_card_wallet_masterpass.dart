...
class PaymentMethodCardWalletMasterpass
  ...
  /// Instantiates a new [PaymentMethodCardWalletMasterpass] and sets the default values.
  PaymentMethodCardWalletMasterpass() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PaymentMethodCardWalletMasterpass createFromDiscriminatorValue(
      ParseNode parseNode) {
