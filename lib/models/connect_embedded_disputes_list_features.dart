...
class ConnectEmbeddedDisputesListFeatures
  ...
  /// Instantiates a new [ConnectEmbeddedDisputesListFeatures] and sets the default values.
  ConnectEmbeddedDisputesListFeatures() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ConnectEmbeddedDisputesListFeatures createFromDiscriminatorValue(
      ParseNode parseNode) {
