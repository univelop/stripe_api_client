...
class GelatoDataDocumentReportIssuedDate
  ...
  /// Instantiates a new [GelatoDataDocumentReportIssuedDate] and sets the default values.
  GelatoDataDocumentReportIssuedDate() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static GelatoDataDocumentReportIssuedDate createFromDiscriminatorValue(
      ParseNode parseNode) {
