...
class CustomerSourcesData implements Parsable {
  ...
  static CustomerSourcesData createFromDiscriminatorValue(ParseNode parseNode) {
    var result = CustomerSourcesData();
