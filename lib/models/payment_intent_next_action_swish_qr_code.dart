...
class PaymentIntentNextActionSwishQrCode
  ...
  /// Instantiates a new [PaymentIntentNextActionSwishQrCode] and sets the default values.
  PaymentIntentNextActionSwishQrCode() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PaymentIntentNextActionSwishQrCode createFromDiscriminatorValue(
      ParseNode parseNode) {
