...
/// auto generated
class LegalEntityUboDeclaration implements AdditionalDataHolder, Parsable {
  ...
  /// Instantiates a new [LegalEntityUboDeclaration] and sets the default values.
  LegalEntityUboDeclaration() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static LegalEntityUboDeclaration createFromDiscriminatorValue(
      ParseNode parseNode) {
