...
class GelatoDataDocumentReportExpirationDate
  ...
  /// Instantiates a new [GelatoDataDocumentReportExpirationDate] and sets the default values.
  GelatoDataDocumentReportExpirationDate() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static GelatoDataDocumentReportExpirationDate createFromDiscriminatorValue(
      ParseNode parseNode) {
