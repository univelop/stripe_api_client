...
class PaymentPagesCheckoutSessionOptionalItemAdjustableQuantity
  ...
  /// Instantiates a new [PaymentPagesCheckoutSessionOptionalItemAdjustableQuantity] and sets the default values.
  PaymentPagesCheckoutSessionOptionalItemAdjustableQuantity()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PaymentPagesCheckoutSessionOptionalItemAdjustableQuantity
