...
class PaymentLinksResourceCustomFieldsText
  ...
  /// Instantiates a new [PaymentLinksResourceCustomFieldsText] and sets the default values.
  PaymentLinksResourceCustomFieldsText() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PaymentLinksResourceCustomFieldsText createFromDiscriminatorValue(
      ParseNode parseNode) {
