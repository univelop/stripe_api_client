...
class PaymentPagesCheckoutSessionCustomFieldsOption
  ...
  /// Instantiates a new [PaymentPagesCheckoutSessionCustomFieldsOption] and sets the default values.
  PaymentPagesCheckoutSessionCustomFieldsOption() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PaymentPagesCheckoutSessionCustomFieldsOption
