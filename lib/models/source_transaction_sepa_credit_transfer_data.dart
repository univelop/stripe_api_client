...
class SourceTransactionSepaCreditTransferData
  ...
  /// Instantiates a new [SourceTransactionSepaCreditTransferData] and sets the default values.
  SourceTransactionSepaCreditTransferData() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static SourceTransactionSepaCreditTransferData createFromDiscriminatorValue(
      ParseNode parseNode) {
