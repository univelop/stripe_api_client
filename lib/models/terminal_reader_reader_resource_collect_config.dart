...
class TerminalReaderReaderResourceCollectConfig
  ...
  /// Instantiates a new [TerminalReaderReaderResourceCollectConfig] and sets the default values.
  TerminalReaderReaderResourceCollectConfig() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static TerminalReaderReaderResourceCollectConfig createFromDiscriminatorValue(
      ParseNode parseNode) {
