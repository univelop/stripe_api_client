...
class PaymentsPrimitivesPaymentRecordsResourcePaymentMethodDetails
  ...
  PaymentsPrimitivesPaymentRecordsResourceBillingDetails? billingDetails;
  ...
  PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetails? card;
  ...
  PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCustomDetails? custom;
  ...
  PaymentMethodDetailsPaymentRecordUsBankAccount? usBankAccount;
  ...
  /// Instantiates a new [PaymentsPrimitivesPaymentRecordsResourcePaymentMethodDetails] and sets the default values.
  PaymentsPrimitivesPaymentRecordsResourcePaymentMethodDetails()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PaymentsPrimitivesPaymentRecordsResourcePaymentMethodDetails
  ...
  Map<String, void Function(ParseNode)> getFieldDeserializers() {
    ...
    deserializerMap['billing_details'] = (node) => billingDetails = node
        .getObjectValue<PaymentsPrimitivesPaymentRecordsResourceBillingDetails>(
    ...
    deserializerMap['us_bank_account'] = (node) => usBankAccount =
        node.getObjectValue<PaymentMethodDetailsPaymentRecordUsBankAccount>(
  ...
  void serialize(SerializationWriter writer) {
    ...
    writer.writeObjectValue<PaymentMethodDetailsPaymentRecordUsBankAccount>(
