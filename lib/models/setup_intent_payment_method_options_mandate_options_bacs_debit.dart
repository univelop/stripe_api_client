...
class SetupIntentPaymentMethodOptionsMandateOptionsBacsDebit
  ...
  /// Instantiates a new [SetupIntentPaymentMethodOptionsMandateOptionsBacsDebit] and sets the default values.
  SetupIntentPaymentMethodOptionsMandateOptionsBacsDebit()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static SetupIntentPaymentMethodOptionsMandateOptionsBacsDebit
