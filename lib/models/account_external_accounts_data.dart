...
class AccountExternalAccountsData implements Parsable {
  ...
  static AccountExternalAccountsData createFromDiscriminatorValue(
      ParseNode parseNode) {
    var result = AccountExternalAccountsData();
