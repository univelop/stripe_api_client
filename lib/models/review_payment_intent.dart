...
class ReviewPaymentIntent implements Parsable {
  ...
  static ReviewPaymentIntent createFromDiscriminatorValue(ParseNode parseNode) {
    var result = ReviewPaymentIntent();
