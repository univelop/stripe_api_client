...
class PaymentIntentPaymentMethodOptionsNzBankAccount
  ...
  /// Instantiates a new [PaymentIntentPaymentMethodOptionsNzBankAccount] and sets the default values.
  PaymentIntentPaymentMethodOptionsNzBankAccount() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PaymentIntentPaymentMethodOptionsNzBankAccount
