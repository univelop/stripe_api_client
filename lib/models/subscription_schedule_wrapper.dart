...
class SubscriptionScheduleWrapper implements Parsable {
  ...
  static SubscriptionScheduleWrapper createFromDiscriminatorValue(
      ParseNode parseNode) {
    var result = SubscriptionScheduleWrapper();
