...
class PaymentMethodOptionsCustomerBalanceBankTransfer
  ...
  PaymentMethodOptionsCustomerBalanceBankTransferType? type_;

  /// Instantiates a new [PaymentMethodOptionsCustomerBalanceBankTransfer] and sets the default values.
  PaymentMethodOptionsCustomerBalanceBankTransfer() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PaymentMethodOptionsCustomerBalanceBankTransfer
  ...
  Map<String, void Function(ParseNode)> getFieldDeserializers() {
    ...
    deserializerMap['type'] = (node) => type_ =
        node.getEnumValue<PaymentMethodOptionsCustomerBalanceBankTransferType>(
            (stringValue) => PaymentMethodOptionsCustomerBalanceBankTransferType
                .values
                .where((enumVal) => enumVal.value == stringValue)
                .firstOrNull);
  ...
  void serialize(SerializationWriter writer) {
    ...
    writer.writeEnumValue<PaymentMethodOptionsCustomerBalanceBankTransferType>(
