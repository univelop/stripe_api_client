...
class OutboundTransfersPaymentMethodDetailsUsBankAccount
  ...
  OutboundTransfersPaymentMethodDetailsUsBankAccountAccountType? accountType;
  ...
  OutboundTransfersPaymentMethodDetailsUsBankAccountMandate? mandate;
  ...
  /// Instantiates a new [OutboundTransfersPaymentMethodDetailsUsBankAccount] and sets the default values.
  OutboundTransfersPaymentMethodDetailsUsBankAccount() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static OutboundTransfersPaymentMethodDetailsUsBankAccount
  ...
  Map<String, void Function(ParseNode)> getFieldDeserializers() {
    ...
    deserializerMap['account_type'] = (node) => accountType = node.getEnumValue<
        ...
        (stringValue) =>
            OutboundTransfersPaymentMethodDetailsUsBankAccountAccountType.values
                .where((enumVal) => enumVal.value == stringValue)
                .firstOrNull);
    ...
    deserializerMap['network'] = (node) => network = node.getEnumValue<
        ...
        (stringValue) =>
            OutboundTransfersPaymentMethodDetailsUsBankAccountNetwork.values
                .where((enumVal) => enumVal.value == stringValue)
                .firstOrNull);
