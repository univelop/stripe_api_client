...
class TreasuryFinancialAccountsResourceOutboundAchToggleSettings
  ...
  /// Instantiates a new [TreasuryFinancialAccountsResourceOutboundAchToggleSettings] and sets the default values.
  TreasuryFinancialAccountsResourceOutboundAchToggleSettings()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static TreasuryFinancialAccountsResourceOutboundAchToggleSettings
