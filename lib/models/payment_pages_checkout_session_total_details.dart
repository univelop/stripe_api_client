...
class PaymentPagesCheckoutSessionTotalDetails
  ...
  /// Instantiates a new [PaymentPagesCheckoutSessionTotalDetails] and sets the default values.
  PaymentPagesCheckoutSessionTotalDetails() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PaymentPagesCheckoutSessionTotalDetails createFromDiscriminatorValue(
      ParseNode parseNode) {
  ...
  Map<String, void Function(ParseNode)> getFieldDeserializers() {
    ...
    deserializerMap['breakdown'] = (node) => breakdown = node.getObjectValue<
