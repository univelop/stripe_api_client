...
class PaymentMethodDetailsCardPresentReceipt
  ...
  /// Instantiates a new [PaymentMethodDetailsCardPresentReceipt] and sets the default values.
  PaymentMethodDetailsCardPresentReceipt() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PaymentMethodDetailsCardPresentReceipt createFromDiscriminatorValue(
      ParseNode parseNode) {
  ...
  Map<String, void Function(ParseNode)> getFieldDeserializers() {
    ...
    deserializerMap['account_type'] = (node) => accountType =
        node.getEnumValue<PaymentMethodDetailsCardPresentReceiptAccountType>(
            (stringValue) => PaymentMethodDetailsCardPresentReceiptAccountType
                .values
  ...
  void serialize(SerializationWriter writer) {
    writer.writeEnumValue<PaymentMethodDetailsCardPresentReceiptAccountType>(
