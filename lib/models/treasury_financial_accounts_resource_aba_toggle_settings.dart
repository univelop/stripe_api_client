...
class TreasuryFinancialAccountsResourceAbaToggleSettings
  ...
  /// Instantiates a new [TreasuryFinancialAccountsResourceAbaToggleSettings] and sets the default values.
  TreasuryFinancialAccountsResourceAbaToggleSettings() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static TreasuryFinancialAccountsResourceAbaToggleSettings
  ...
  Map<String, void Function(ParseNode)> getFieldDeserializers() {
    ...
    deserializerMap['status'] = (node) => status = node
        .getEnumValue<TreasuryFinancialAccountsResourceAbaToggleSettingsStatus>(
            (stringValue) =>
                TreasuryFinancialAccountsResourceAbaToggleSettingsStatus.values
