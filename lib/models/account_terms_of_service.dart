...
/// auto generated
class AccountTermsOfService implements AdditionalDataHolder, Parsable {
  ...
  /// Instantiates a new [AccountTermsOfService] and sets the default values.
  AccountTermsOfService() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static AccountTermsOfService createFromDiscriminatorValue(
      ParseNode parseNode) {
