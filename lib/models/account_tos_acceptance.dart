...
/// auto generated
class AccountTosAcceptance implements AdditionalDataHolder, Parsable {
  ...
  /// Instantiates a new [AccountTosAcceptance] and sets the default values.
  AccountTosAcceptance() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static AccountTosAcceptance createFromDiscriminatorValue(
      ParseNode parseNode) {
