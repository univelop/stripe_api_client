...
class RefundDestinationDetailsMxBankTransfer
  ...
  /// Instantiates a new [RefundDestinationDetailsMxBankTransfer] and sets the default values.
  RefundDestinationDetailsMxBankTransfer() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static RefundDestinationDetailsMxBankTransfer createFromDiscriminatorValue(
      ParseNode parseNode) {
