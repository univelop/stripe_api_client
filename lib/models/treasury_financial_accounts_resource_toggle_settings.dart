...
class TreasuryFinancialAccountsResourceToggleSettings
  ...
  /// Instantiates a new [TreasuryFinancialAccountsResourceToggleSettings] and sets the default values.
  TreasuryFinancialAccountsResourceToggleSettings() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static TreasuryFinancialAccountsResourceToggleSettings
  ...
  Map<String, void Function(ParseNode)> getFieldDeserializers() {
    ...
    deserializerMap['status'] = (node) => status = node
        .getEnumValue<TreasuryFinancialAccountsResourceToggleSettingsStatus>(
            (stringValue) =>
                TreasuryFinancialAccountsResourceToggleSettingsStatus.values
  ...
  void serialize(SerializationWriter writer) {
    ...
    writer
        .writeEnumValue<TreasuryFinancialAccountsResourceToggleSettingsStatus>(
