...
class CreditGrantCustomer implements Parsable {
  ...
  static CreditGrantCustomer createFromDiscriminatorValue(ParseNode parseNode) {
    var result = CreditGrantCustomer();
