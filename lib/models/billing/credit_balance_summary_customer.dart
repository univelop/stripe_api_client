...
class CreditBalanceSummaryCustomer implements Parsable {
  ...
  static CreditBalanceSummaryCustomer createFromDiscriminatorValue(
      ParseNode parseNode) {
    var result = CreditBalanceSummaryCustomer();
