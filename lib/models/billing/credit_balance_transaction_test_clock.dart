...
class CreditBalanceTransactionTestClock implements Parsable {
  ...
  static CreditBalanceTransactionTestClock createFromDiscriminatorValue(
      ParseNode parseNode) {
    var result = CreditBalanceTransactionTestClock();
