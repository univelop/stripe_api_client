...
class CardIssuingAccountTermsOfService
  ...
  /// Instantiates a new [CardIssuingAccountTermsOfService] and sets the default values.
  CardIssuingAccountTermsOfService() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static CardIssuingAccountTermsOfService createFromDiscriminatorValue(
      ParseNode parseNode) {
