...
class TaxProductRegistrationsResourceCountryOptionsUsLocalAmusementTax
  ...
  /// Instantiates a new [TaxProductRegistrationsResourceCountryOptionsUsLocalAmusementTax] and sets the default values.
  TaxProductRegistrationsResourceCountryOptionsUsLocalAmusementTax()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static TaxProductRegistrationsResourceCountryOptionsUsLocalAmusementTax
