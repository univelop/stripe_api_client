...
class DisputeVisaCompellingEvidence3PriorUndisputedTransaction
  ...
  /// Instantiates a new [DisputeVisaCompellingEvidence3PriorUndisputedTransaction] and sets the default values.
  DisputeVisaCompellingEvidence3PriorUndisputedTransaction()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static DisputeVisaCompellingEvidence3PriorUndisputedTransaction
