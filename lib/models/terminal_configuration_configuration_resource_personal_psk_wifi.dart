...
class TerminalConfigurationConfigurationResourcePersonalPskWifi
  ...
  /// Instantiates a new [TerminalConfigurationConfigurationResourcePersonalPskWifi] and sets the default values.
  TerminalConfigurationConfigurationResourcePersonalPskWifi()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static TerminalConfigurationConfigurationResourcePersonalPskWifi
