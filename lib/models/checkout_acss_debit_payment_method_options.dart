...
class CheckoutAcssDebitPaymentMethodOptions
  ...
  /// Instantiates a new [CheckoutAcssDebitPaymentMethodOptions] and sets the default values.
  CheckoutAcssDebitPaymentMethodOptions() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static CheckoutAcssDebitPaymentMethodOptions createFromDiscriminatorValue(
      ParseNode parseNode) {
  ...
  void serialize(SerializationWriter writer) {
    writer.writeEnumValue<CheckoutAcssDebitPaymentMethodOptionsCurrency>(
        'currency', currency, (e) => e?.value);
    writer.writeObjectValue<CheckoutAcssDebitMandateOptions>(
        'mandate_options', mandateOptions);
    writer
        .writeEnumValue<CheckoutAcssDebitPaymentMethodOptionsSetupFutureUsage>(
