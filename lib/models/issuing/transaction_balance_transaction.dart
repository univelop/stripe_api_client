...
class TransactionBalanceTransaction implements Parsable {
  ...
  static TransactionBalanceTransaction createFromDiscriminatorValue(
      ParseNode parseNode) {
    var result = TransactionBalanceTransaction();
