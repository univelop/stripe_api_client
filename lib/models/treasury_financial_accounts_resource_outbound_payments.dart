...
class TreasuryFinancialAccountsResourceOutboundPayments
  ...
  /// Instantiates a new [TreasuryFinancialAccountsResourceOutboundPayments] and sets the default values.
  TreasuryFinancialAccountsResourceOutboundPayments() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static TreasuryFinancialAccountsResourceOutboundPayments
