...
class InvoiceSettingSubscriptionScheduleSetting
  ...
  /// Instantiates a new [InvoiceSettingSubscriptionScheduleSetting] and sets the default values.
  InvoiceSettingSubscriptionScheduleSetting() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static InvoiceSettingSubscriptionScheduleSetting createFromDiscriminatorValue(
      ParseNode parseNode) {
