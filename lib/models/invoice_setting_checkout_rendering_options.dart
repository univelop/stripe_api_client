...
class InvoiceSettingCheckoutRenderingOptions
  ...
  /// Instantiates a new [InvoiceSettingCheckoutRenderingOptions] and sets the default values.
  InvoiceSettingCheckoutRenderingOptions() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static InvoiceSettingCheckoutRenderingOptions createFromDiscriminatorValue(
      ParseNode parseNode) {
