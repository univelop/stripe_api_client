...
class DisputeTransactionShippingAddress
  ...
  /// Instantiates a new [DisputeTransactionShippingAddress] and sets the default values.
  DisputeTransactionShippingAddress() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static DisputeTransactionShippingAddress createFromDiscriminatorValue(
      ParseNode parseNode) {
