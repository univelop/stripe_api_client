...
class SetupIntentCustomer implements Parsable {
  ...
  static SetupIntentCustomer createFromDiscriminatorValue(ParseNode parseNode) {
    var result = SetupIntentCustomer();
