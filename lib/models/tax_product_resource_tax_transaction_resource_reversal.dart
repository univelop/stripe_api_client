...
class TaxProductResourceTaxTransactionResourceReversal
  ...
  /// Instantiates a new [TaxProductResourceTaxTransactionResourceReversal] and sets the default values.
  TaxProductResourceTaxTransactionResourceReversal() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static TaxProductResourceTaxTransactionResourceReversal
