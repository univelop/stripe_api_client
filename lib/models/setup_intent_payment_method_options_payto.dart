...
/// auto generated
class SetupIntentPaymentMethodOptionsPayto
  ...
  /// Instantiates a new [SetupIntentPaymentMethodOptionsPayto] and sets the default values.
  SetupIntentPaymentMethodOptionsPayto() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static SetupIntentPaymentMethodOptionsPayto createFromDiscriminatorValue(
      ParseNode parseNode) {
