...
class SubscriptionScheduleApplication implements Parsable {
  ...
  static SubscriptionScheduleApplication createFromDiscriminatorValue(
      ParseNode parseNode) {
    var result = SubscriptionScheduleApplication();
