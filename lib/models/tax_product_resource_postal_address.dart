...
class TaxProductResourcePostalAddress
  ...
  /// Instantiates a new [TaxProductResourcePostalAddress] and sets the default values.
  TaxProductResourcePostalAddress() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static TaxProductResourcePostalAddress createFromDiscriminatorValue(
      ParseNode parseNode) {
