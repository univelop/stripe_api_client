...
/// auto generated
class InvoicesResourceShippingCost implements AdditionalDataHolder, Parsable {
  ...
  /// Instantiates a new [InvoicesResourceShippingCost] and sets the default values.
  InvoicesResourceShippingCost() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static InvoicesResourceShippingCost createFromDiscriminatorValue(
      ParseNode parseNode) {
  ...
  Map<String, void Function(ParseNode)> getFieldDeserializers() {
    ...
    deserializerMap['shipping_rate'] = (node) => shippingRate =
        node.getObjectValue<InvoicesResourceShippingCostShippingRate>(
  ...
  void serialize(SerializationWriter writer) {
    ...
    writer.writeObjectValue<InvoicesResourceShippingCostShippingRate>(
