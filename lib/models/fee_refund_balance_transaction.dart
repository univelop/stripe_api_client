...
class FeeRefundBalanceTransaction implements Parsable {
  ...
  static FeeRefundBalanceTransaction createFromDiscriminatorValue(
      ParseNode parseNode) {
    var result = FeeRefundBalanceTransaction();
