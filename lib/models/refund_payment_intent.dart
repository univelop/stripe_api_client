...
class RefundPaymentIntent implements Parsable {
  ...
  static RefundPaymentIntent createFromDiscriminatorValue(ParseNode parseNode) {
    var result = RefundPaymentIntent();
