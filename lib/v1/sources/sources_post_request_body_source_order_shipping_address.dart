...
/// auto generated
class SourcesPostRequestBodySourceOrderShippingAddress
  ...
  /// Instantiates a new [SourcesPostRequestBodySourceOrderShippingAddress] and sets the default values.
  SourcesPostRequestBodySourceOrderShippingAddress() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static SourcesPostRequestBodySourceOrderShippingAddress
      createFromDiscriminatorValue(ParseNode parseNode) {
    return SourcesPostRequestBodySourceOrderShippingAddress();
  }
