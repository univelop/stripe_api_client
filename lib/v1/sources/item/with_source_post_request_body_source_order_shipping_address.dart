...
/// auto generated
class WithSourcePostRequestBodySourceOrderShippingAddress
  ...
  /// Instantiates a new [WithSourcePostRequestBodySourceOrderShippingAddress] and sets the default values.
  WithSourcePostRequestBodySourceOrderShippingAddress() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithSourcePostRequestBodySourceOrderShippingAddress
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithSourcePostRequestBodySourceOrderShippingAddress();
  }
