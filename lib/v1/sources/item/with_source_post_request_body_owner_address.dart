...
/// auto generated
class WithSourcePostRequestBodyOwnerAddress
  ...
  /// Instantiates a new [WithSourcePostRequestBodyOwnerAddress] and sets the default values.
  WithSourcePostRequestBodyOwnerAddress() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithSourcePostRequestBodyOwnerAddress createFromDiscriminatorValue(
      ParseNode parseNode) {
    return WithSourcePostRequestBodyOwnerAddress();
  }
