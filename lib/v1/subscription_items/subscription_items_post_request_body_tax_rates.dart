...
class SubscriptionItemsPostRequestBodyTaxRates implements Parsable {
  ///  Composed type representation for type [Iterable<String>?]
  Iterable<String>? string_;

  ///  Composed type representation for type [String?]
  String? subscriptionItemsPostRequestBodyTaxRatesString;

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static SubscriptionItemsPostRequestBodyTaxRates createFromDiscriminatorValue(
      ParseNode parseNode) {
    var result = SubscriptionItemsPostRequestBodyTaxRates();
    if (parseNode.getStringValue() != null) {
      result.subscriptionItemsPostRequestBodyTaxRatesString =
  ...
  void serialize(SerializationWriter writer) {
    if (subscriptionItemsPostRequestBodyTaxRatesString != null) {
      writer.writeStringValue(
          null, subscriptionItemsPostRequestBodyTaxRatesString);
