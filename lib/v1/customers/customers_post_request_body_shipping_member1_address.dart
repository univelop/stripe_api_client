...
/// auto generated
class CustomersPostRequestBodyShippingMember1Address
  ...
  /// Instantiates a new [CustomersPostRequestBodyShippingMember1Address] and sets the default values.
  CustomersPostRequestBodyShippingMember1Address() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static CustomersPostRequestBodyShippingMember1Address
      createFromDiscriminatorValue(ParseNode parseNode) {
    return CustomersPostRequestBodyShippingMember1Address();
  }
