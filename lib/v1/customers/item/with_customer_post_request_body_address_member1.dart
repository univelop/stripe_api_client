...
/// auto generated
class WithCustomerPostRequestBodyAddressMember1
  ...
  /// Instantiates a new [WithCustomerPostRequestBodyAddressMember1] and sets the default values.
  WithCustomerPostRequestBodyAddressMember1() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithCustomerPostRequestBodyAddressMember1 createFromDiscriminatorValue(
      ParseNode parseNode) {
    return WithCustomerPostRequestBodyAddressMember1();
  }
