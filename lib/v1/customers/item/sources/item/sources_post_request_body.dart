...
import './sources_post_request_body_account_holder_type.dart';
...
class SourcesPostRequestBody implements Parsable {
  ...
  SourcesPostRequestBodyAccountHolderType? accountHolderType;
  ...
  Map<String, void Function(ParseNode)> getFieldDeserializers() {
    ...
    deserializerMap['account_holder_type'] = (node) => accountHolderType =
        node.getEnumValue<SourcesPostRequestBodyAccountHolderType>(
            (stringValue) => SourcesPostRequestBodyAccountHolderType.values
  ...
  void serialize(SerializationWriter writer) {
    ...
    writer.writeEnumValue<SourcesPostRequestBodyAccountHolderType>(
