...
import './sources_post_request_body_card_member1_metadata.dart';
import './sources_post_request_body_card_member1_object.dart';

/// auto generated
class SourcesPostRequestBodyCardMember1
  ...
  SourcesPostRequestBodyCardMember1Metadata? metadata;
  ...
  ///  The object property
  SourcesPostRequestBodyCardMember1Object? object;

  /// Instantiates a new [SourcesPostRequestBodyCardMember1] and sets the default values.
  SourcesPostRequestBodyCardMember1() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static SourcesPostRequestBodyCardMember1 createFromDiscriminatorValue(
      ParseNode parseNode) {
    return SourcesPostRequestBodyCardMember1();
  }
  ...
  Map<String, void Function(ParseNode)> getFieldDeserializers() {
    ...
    deserializerMap['metadata'] = (node) => metadata = node.getObjectValue<
            SourcesPostRequestBodyCardMember1Metadata>(
        SourcesPostRequestBodyCardMember1Metadata.createFromDiscriminatorValue);
    deserializerMap['name'] = (node) => name = node.getStringValue();
    deserializerMap['number'] = (node) => number = node.getStringValue();
    deserializerMap['object'] = (node) => object =
        node.getEnumValue<SourcesPostRequestBodyCardMember1Object>(
            (stringValue) => SourcesPostRequestBodyCardMember1Object.values
  ...
  void serialize(SerializationWriter writer) {
    ...
    writer.writeObjectValue<SourcesPostRequestBodyCardMember1Metadata>(
        'metadata', metadata);
    writer.writeStringValue('name', name);
    writer.writeStringValue('number', number);
    writer.writeEnumValue<SourcesPostRequestBodyCardMember1Object>(
