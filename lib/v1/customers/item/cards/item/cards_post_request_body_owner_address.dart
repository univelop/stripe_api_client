...
/// auto generated
class CardsPostRequestBodyOwnerAddress
  ...
  /// Instantiates a new [CardsPostRequestBodyOwnerAddress] and sets the default values.
  CardsPostRequestBodyOwnerAddress() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static CardsPostRequestBodyOwnerAddress createFromDiscriminatorValue(
      ParseNode parseNode) {
    return CardsPostRequestBodyOwnerAddress();
  }
