...
class CardsDeleteResponse implements Parsable {
  ...
  static CardsDeleteResponse createFromDiscriminatorValue(ParseNode parseNode) {
    var result = CardsDeleteResponse();
