...
import './cards_post_request_body_card_member1_metadata.dart';
import './cards_post_request_body_card_member1_object.dart';

/// auto generated
class CardsPostRequestBodyCardMember1
  ...
  CardsPostRequestBodyCardMember1Metadata? metadata;
  ...
  ///  The object property
  CardsPostRequestBodyCardMember1Object? object;

  /// Instantiates a new [CardsPostRequestBodyCardMember1] and sets the default values.
  CardsPostRequestBodyCardMember1() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static CardsPostRequestBodyCardMember1 createFromDiscriminatorValue(
      ParseNode parseNode) {
    return CardsPostRequestBodyCardMember1();
  }
  ...
  Map<String, void Function(ParseNode)> getFieldDeserializers() {
    ...
    deserializerMap['metadata'] = (node) => metadata = node.getObjectValue<
            CardsPostRequestBodyCardMember1Metadata>(
        CardsPostRequestBodyCardMember1Metadata.createFromDiscriminatorValue);
    deserializerMap['name'] = (node) => name = node.getStringValue();
    deserializerMap['number'] = (node) => number = node.getStringValue();
    deserializerMap['object'] = (node) => object =
        node.getEnumValue<CardsPostRequestBodyCardMember1Object>(
            (stringValue) => CardsPostRequestBodyCardMember1Object.values
  ...
  void serialize(SerializationWriter writer) {
    ...
    writer.writeObjectValue<CardsPostRequestBodyCardMember1Metadata>(
        'metadata', metadata);
    writer.writeStringValue('name', name);
    writer.writeStringValue('number', number);
    writer.writeEnumValue<CardsPostRequestBodyCardMember1Object>(
