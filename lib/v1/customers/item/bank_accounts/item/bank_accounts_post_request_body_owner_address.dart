...
/// auto generated
class BankAccountsPostRequestBodyOwnerAddress
  ...
  /// Instantiates a new [BankAccountsPostRequestBodyOwnerAddress] and sets the default values.
  BankAccountsPostRequestBodyOwnerAddress() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static BankAccountsPostRequestBodyOwnerAddress createFromDiscriminatorValue(
      ParseNode parseNode) {
    return BankAccountsPostRequestBodyOwnerAddress();
  }
