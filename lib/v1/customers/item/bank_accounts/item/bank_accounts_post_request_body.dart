...
import './bank_accounts_post_request_body_owner.dart';
...
class BankAccountsPostRequestBody implements Parsable {
  ...
  ///  The owner property
  BankAccountsPostRequestBodyOwner? owner;
  ...
  Map<String, void Function(ParseNode)> getFieldDeserializers() {
    ...
    deserializerMap['owner'] = (node) => owner =
        node.getObjectValue<BankAccountsPostRequestBodyOwner>(
            BankAccountsPostRequestBodyOwner.createFromDiscriminatorValue);
  ...
  void serialize(SerializationWriter writer) {
    ...
    writer.writeObjectValue<BankAccountsPostRequestBodyOwner>('owner', owner);
  }
}
