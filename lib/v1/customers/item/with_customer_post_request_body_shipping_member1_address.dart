...
/// auto generated
class WithCustomerPostRequestBodyShippingMember1Address
  ...
  /// Instantiates a new [WithCustomerPostRequestBodyShippingMember1Address] and sets the default values.
  WithCustomerPostRequestBodyShippingMember1Address() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithCustomerPostRequestBodyShippingMember1Address
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithCustomerPostRequestBodyShippingMember1Address();
  }
