...
class WithSubscriptionExposedPostRequestBodyAddInvoiceItemsTaxRates
    implements Parsable {
  ///  Composed type representation for type [Iterable<String>?]
  Iterable<String>? string_;

  ///  Composed type representation for type [String?]
  String? withSubscriptionExposedPostRequestBodyAddInvoiceItemsTaxRatesString;

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithSubscriptionExposedPostRequestBodyAddInvoiceItemsTaxRates
      createFromDiscriminatorValue(ParseNode parseNode) {
    var result =
        WithSubscriptionExposedPostRequestBodyAddInvoiceItemsTaxRates();
    if (parseNode.getStringValue() != null) {
      result.withSubscriptionExposedPostRequestBodyAddInvoiceItemsTaxRatesString =
  ...
  void serialize(SerializationWriter writer) {
    if (withSubscriptionExposedPostRequestBodyAddInvoiceItemsTaxRatesString !=
        null) {
      writer.writeStringValue(null,
          withSubscriptionExposedPostRequestBodyAddInvoiceItemsTaxRatesString);
