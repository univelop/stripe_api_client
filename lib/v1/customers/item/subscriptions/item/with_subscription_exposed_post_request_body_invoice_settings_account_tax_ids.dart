...
class WithSubscriptionExposedPostRequestBodyInvoiceSettingsAccountTaxIds
    implements Parsable {
  ...
  String?
      withSubscriptionExposedPostRequestBodyInvoiceSettingsAccountTaxIdsString;

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithSubscriptionExposedPostRequestBodyInvoiceSettingsAccountTaxIds
      createFromDiscriminatorValue(ParseNode parseNode) {
    var result =
        WithSubscriptionExposedPostRequestBodyInvoiceSettingsAccountTaxIds();
    if (parseNode.getStringValue() != null) {
      result.withSubscriptionExposedPostRequestBodyInvoiceSettingsAccountTaxIdsString =
  ...
  void serialize(SerializationWriter writer) {
    if (withSubscriptionExposedPostRequestBodyInvoiceSettingsAccountTaxIdsString !=
        null) {
