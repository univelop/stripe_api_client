...
class WithSubscriptionExposedPostRequestBodyApplicationFeePercent
    implements Parsable {
  ...
  static WithSubscriptionExposedPostRequestBodyApplicationFeePercent
      createFromDiscriminatorValue(ParseNode parseNode) {
    var result = WithSubscriptionExposedPostRequestBodyApplicationFeePercent();
