...
class SubscriptionsPostRequestBodyAddInvoiceItemsTaxRates implements Parsable {
  ///  Composed type representation for type [Iterable<String>?]
  Iterable<String>? string_;

  ///  Composed type representation for type [String?]
  String? subscriptionsPostRequestBodyAddInvoiceItemsTaxRatesString;

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static SubscriptionsPostRequestBodyAddInvoiceItemsTaxRates
      createFromDiscriminatorValue(ParseNode parseNode) {
    var result = SubscriptionsPostRequestBodyAddInvoiceItemsTaxRates();
    if (parseNode.getStringValue() != null) {
      result.subscriptionsPostRequestBodyAddInvoiceItemsTaxRatesString =
  ...
  void serialize(SerializationWriter writer) {
    if (subscriptionsPostRequestBodyAddInvoiceItemsTaxRatesString != null) {
      writer.writeStringValue(
          null, subscriptionsPostRequestBodyAddInvoiceItemsTaxRatesString);
