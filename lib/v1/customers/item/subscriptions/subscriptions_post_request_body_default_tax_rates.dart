...
class SubscriptionsPostRequestBodyDefaultTaxRates implements Parsable {
  ///  Composed type representation for type [Iterable<String>?]
  Iterable<String>? string_;

  ///  Composed type representation for type [String?]
  String? subscriptionsPostRequestBodyDefaultTaxRatesString;

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static SubscriptionsPostRequestBodyDefaultTaxRates
      createFromDiscriminatorValue(ParseNode parseNode) {
    var result = SubscriptionsPostRequestBodyDefaultTaxRates();
    if (parseNode.getStringValue() != null) {
      result.subscriptionsPostRequestBodyDefaultTaxRatesString =
  ...
  void serialize(SerializationWriter writer) {
    if (subscriptionsPostRequestBodyDefaultTaxRatesString != null) {
      writer.writeStringValue(
          null, subscriptionsPostRequestBodyDefaultTaxRatesString);
