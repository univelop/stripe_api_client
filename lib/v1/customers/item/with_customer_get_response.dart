...
/// auto generated
/// Composed type wrapper for classes [Customer], [DeletedCustomer]
class WithCustomerGetResponse implements Parsable {
  ...
  static WithCustomerGetResponse createFromDiscriminatorValue(
      ParseNode parseNode) {
    var result = WithCustomerGetResponse();
