...
/// auto generated
class CustomersPostRequestBodyAddressMember1
  ...
  /// Instantiates a new [CustomersPostRequestBodyAddressMember1] and sets the default values.
  CustomersPostRequestBodyAddressMember1() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static CustomersPostRequestBodyAddressMember1 createFromDiscriminatorValue(
      ParseNode parseNode) {
    return CustomersPostRequestBodyAddressMember1();
  }
