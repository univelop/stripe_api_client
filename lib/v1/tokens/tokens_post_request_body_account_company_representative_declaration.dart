...
/// auto generated
class TokensPostRequestBodyAccountCompanyRepresentativeDeclaration
  ...
  /// Instantiates a new [TokensPostRequestBodyAccountCompanyRepresentativeDeclaration] and sets the default values.
  TokensPostRequestBodyAccountCompanyRepresentativeDeclaration()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static TokensPostRequestBodyAccountCompanyRepresentativeDeclaration
      createFromDiscriminatorValue(ParseNode parseNode) {
    return TokensPostRequestBodyAccountCompanyRepresentativeDeclaration();
  }
