...
/// auto generated
class TokensPostRequestBodyPersonRegisteredAddress
  ...
  /// Instantiates a new [TokensPostRequestBodyPersonRegisteredAddress] and sets the default values.
  TokensPostRequestBodyPersonRegisteredAddress() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static TokensPostRequestBodyPersonRegisteredAddress
      createFromDiscriminatorValue(ParseNode parseNode) {
    return TokensPostRequestBodyPersonRegisteredAddress();
  }
