...
/// auto generated
class TokensPostRequestBodyPersonAddressKanji
  ...
  /// Instantiates a new [TokensPostRequestBodyPersonAddressKanji] and sets the default values.
  TokensPostRequestBodyPersonAddressKanji() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static TokensPostRequestBodyPersonAddressKanji createFromDiscriminatorValue(
      ParseNode parseNode) {
    return TokensPostRequestBodyPersonAddressKanji();
  }
