...
/// auto generated
class TokensPostRequestBodyAccountCompanyDirectorshipDeclaration
  ...
  /// Instantiates a new [TokensPostRequestBodyAccountCompanyDirectorshipDeclaration] and sets the default values.
  TokensPostRequestBodyAccountCompanyDirectorshipDeclaration()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static TokensPostRequestBodyAccountCompanyDirectorshipDeclaration
      createFromDiscriminatorValue(ParseNode parseNode) {
    return TokensPostRequestBodyAccountCompanyDirectorshipDeclaration();
  }
