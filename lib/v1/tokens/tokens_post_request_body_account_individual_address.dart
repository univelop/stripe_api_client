...
/// auto generated
class TokensPostRequestBodyAccountIndividualAddress
  ...
  /// Instantiates a new [TokensPostRequestBodyAccountIndividualAddress] and sets the default values.
  TokensPostRequestBodyAccountIndividualAddress() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static TokensPostRequestBodyAccountIndividualAddress
      createFromDiscriminatorValue(ParseNode parseNode) {
    return TokensPostRequestBodyAccountIndividualAddress();
  }
