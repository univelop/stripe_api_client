...
/// auto generated
class TokensPostRequestBodyAccountIndividualRegisteredAddress
  ...
  /// Instantiates a new [TokensPostRequestBodyAccountIndividualRegisteredAddress] and sets the default values.
  TokensPostRequestBodyAccountIndividualRegisteredAddress()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static TokensPostRequestBodyAccountIndividualRegisteredAddress
      createFromDiscriminatorValue(ParseNode parseNode) {
    return TokensPostRequestBodyAccountIndividualRegisteredAddress();
  }
