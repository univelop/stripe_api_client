...
/// auto generated
class TokensPostRequestBodyAccountCompanyAddressKanji
  ...
  /// Instantiates a new [TokensPostRequestBodyAccountCompanyAddressKanji] and sets the default values.
  TokensPostRequestBodyAccountCompanyAddressKanji() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static TokensPostRequestBodyAccountCompanyAddressKanji
      createFromDiscriminatorValue(ParseNode parseNode) {
    return TokensPostRequestBodyAccountCompanyAddressKanji();
  }
