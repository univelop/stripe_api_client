...
/// auto generated
class TokensPostRequestBodyPersonAddressKana
  ...
  /// Instantiates a new [TokensPostRequestBodyPersonAddressKana] and sets the default values.
  TokensPostRequestBodyPersonAddressKana() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static TokensPostRequestBodyPersonAddressKana createFromDiscriminatorValue(
      ParseNode parseNode) {
    return TokensPostRequestBodyPersonAddressKana();
  }
