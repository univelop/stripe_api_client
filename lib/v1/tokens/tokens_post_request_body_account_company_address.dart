...
/// auto generated
class TokensPostRequestBodyAccountCompanyAddress
  ...
  /// Instantiates a new [TokensPostRequestBodyAccountCompanyAddress] and sets the default values.
  TokensPostRequestBodyAccountCompanyAddress() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static TokensPostRequestBodyAccountCompanyAddress
      createFromDiscriminatorValue(ParseNode parseNode) {
    return TokensPostRequestBodyAccountCompanyAddress();
  }
