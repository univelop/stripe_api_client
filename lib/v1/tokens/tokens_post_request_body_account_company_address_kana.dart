...
/// auto generated
class TokensPostRequestBodyAccountCompanyAddressKana
  ...
  /// Instantiates a new [TokensPostRequestBodyAccountCompanyAddressKana] and sets the default values.
  TokensPostRequestBodyAccountCompanyAddressKana() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static TokensPostRequestBodyAccountCompanyAddressKana
      createFromDiscriminatorValue(ParseNode parseNode) {
    return TokensPostRequestBodyAccountCompanyAddressKana();
  }
