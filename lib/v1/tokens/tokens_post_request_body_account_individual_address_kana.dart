...
/// auto generated
class TokensPostRequestBodyAccountIndividualAddressKana
  ...
  /// Instantiates a new [TokensPostRequestBodyAccountIndividualAddressKana] and sets the default values.
  TokensPostRequestBodyAccountIndividualAddressKana() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static TokensPostRequestBodyAccountIndividualAddressKana
      createFromDiscriminatorValue(ParseNode parseNode) {
    return TokensPostRequestBodyAccountIndividualAddressKana();
  }
