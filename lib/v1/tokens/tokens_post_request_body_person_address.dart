...
/// auto generated
class TokensPostRequestBodyPersonAddress
  ...
  /// Instantiates a new [TokensPostRequestBodyPersonAddress] and sets the default values.
  TokensPostRequestBodyPersonAddress() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static TokensPostRequestBodyPersonAddress createFromDiscriminatorValue(
      ParseNode parseNode) {
    return TokensPostRequestBodyPersonAddress();
  }
