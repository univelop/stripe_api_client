...
/// auto generated
class TokensPostRequestBodyAccountIndividualAddressKanji
  ...
  /// Instantiates a new [TokensPostRequestBodyAccountIndividualAddressKanji] and sets the default values.
  TokensPostRequestBodyAccountIndividualAddressKanji() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static TokensPostRequestBodyAccountIndividualAddressKanji
      createFromDiscriminatorValue(ParseNode parseNode) {
    return TokensPostRequestBodyAccountIndividualAddressKanji();
  }
