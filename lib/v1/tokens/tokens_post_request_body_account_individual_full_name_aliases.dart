...
class TokensPostRequestBodyAccountIndividualFullNameAliases
    implements Parsable {
  ///  Composed type representation for type [Iterable<String>?]
  Iterable<String>? string_;

  ///  Composed type representation for type [String?]
  String? tokensPostRequestBodyAccountIndividualFullNameAliasesString;

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static TokensPostRequestBodyAccountIndividualFullNameAliases
      createFromDiscriminatorValue(ParseNode parseNode) {
    var result = TokensPostRequestBodyAccountIndividualFullNameAliases();
    if (parseNode.getStringValue() != null) {
      result.tokensPostRequestBodyAccountIndividualFullNameAliasesString =
  ...
  void serialize(SerializationWriter writer) {
    if (tokensPostRequestBodyAccountIndividualFullNameAliasesString != null) {
      writer.writeStringValue(
          null, tokensPostRequestBodyAccountIndividualFullNameAliasesString);
