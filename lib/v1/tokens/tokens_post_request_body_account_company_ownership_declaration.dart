...
/// auto generated
class TokensPostRequestBodyAccountCompanyOwnershipDeclaration
  ...
  /// Instantiates a new [TokensPostRequestBodyAccountCompanyOwnershipDeclaration] and sets the default values.
  TokensPostRequestBodyAccountCompanyOwnershipDeclaration()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static TokensPostRequestBodyAccountCompanyOwnershipDeclaration
      createFromDiscriminatorValue(ParseNode parseNode) {
    return TokensPostRequestBodyAccountCompanyOwnershipDeclaration();
  }
