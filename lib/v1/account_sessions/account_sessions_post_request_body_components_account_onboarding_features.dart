...
/// auto generated
class AccountSessionsPostRequestBodyComponentsAccountOnboardingFeatures
  ...
  /// Instantiates a new [AccountSessionsPostRequestBodyComponentsAccountOnboardingFeatures] and sets the default values.
  AccountSessionsPostRequestBodyComponentsAccountOnboardingFeatures()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static AccountSessionsPostRequestBodyComponentsAccountOnboardingFeatures
      createFromDiscriminatorValue(ParseNode parseNode) {
    return AccountSessionsPostRequestBodyComponentsAccountOnboardingFeatures();
  }
