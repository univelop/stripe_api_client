...
/// auto generated
class AccountSessionsPostRequestBodyComponentsPaymentDisputesFeatures
  ...
  /// Instantiates a new [AccountSessionsPostRequestBodyComponentsPaymentDisputesFeatures] and sets the default values.
  AccountSessionsPostRequestBodyComponentsPaymentDisputesFeatures()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static AccountSessionsPostRequestBodyComponentsPaymentDisputesFeatures
      createFromDiscriminatorValue(ParseNode parseNode) {
    return AccountSessionsPostRequestBodyComponentsPaymentDisputesFeatures();
  }
