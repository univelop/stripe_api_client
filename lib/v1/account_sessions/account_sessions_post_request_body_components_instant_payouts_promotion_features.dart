...
/// auto generated
class AccountSessionsPostRequestBodyComponentsInstantPayoutsPromotionFeatures
  ...
  /// Instantiates a new [AccountSessionsPostRequestBodyComponentsInstantPayoutsPromotionFeatures] and sets the default values.
  AccountSessionsPostRequestBodyComponentsInstantPayoutsPromotionFeatures()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static AccountSessionsPostRequestBodyComponentsInstantPayoutsPromotionFeatures
      createFromDiscriminatorValue(ParseNode parseNode) {
    return AccountSessionsPostRequestBodyComponentsInstantPayoutsPromotionFeatures();
  }
