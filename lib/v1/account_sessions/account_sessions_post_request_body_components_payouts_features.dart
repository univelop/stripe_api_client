...
/// auto generated
class AccountSessionsPostRequestBodyComponentsPayoutsFeatures
  ...
  /// Instantiates a new [AccountSessionsPostRequestBodyComponentsPayoutsFeatures] and sets the default values.
  AccountSessionsPostRequestBodyComponentsPayoutsFeatures()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static AccountSessionsPostRequestBodyComponentsPayoutsFeatures
      createFromDiscriminatorValue(ParseNode parseNode) {
    return AccountSessionsPostRequestBodyComponentsPayoutsFeatures();
  }
