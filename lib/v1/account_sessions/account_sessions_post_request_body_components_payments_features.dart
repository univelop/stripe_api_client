...
/// auto generated
class AccountSessionsPostRequestBodyComponentsPaymentsFeatures
  ...
  /// Instantiates a new [AccountSessionsPostRequestBodyComponentsPaymentsFeatures] and sets the default values.
  AccountSessionsPostRequestBodyComponentsPaymentsFeatures()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static AccountSessionsPostRequestBodyComponentsPaymentsFeatures
      createFromDiscriminatorValue(ParseNode parseNode) {
    return AccountSessionsPostRequestBodyComponentsPaymentsFeatures();
  }
