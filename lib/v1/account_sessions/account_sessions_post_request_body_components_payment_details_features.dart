...
/// auto generated
class AccountSessionsPostRequestBodyComponentsPaymentDetailsFeatures
  ...
  /// Instantiates a new [AccountSessionsPostRequestBodyComponentsPaymentDetailsFeatures] and sets the default values.
  AccountSessionsPostRequestBodyComponentsPaymentDetailsFeatures()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static AccountSessionsPostRequestBodyComponentsPaymentDetailsFeatures
      createFromDiscriminatorValue(ParseNode parseNode) {
    return AccountSessionsPostRequestBodyComponentsPaymentDetailsFeatures();
  }
