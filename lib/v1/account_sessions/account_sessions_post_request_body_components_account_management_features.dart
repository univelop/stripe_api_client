...
/// auto generated
class AccountSessionsPostRequestBodyComponentsAccountManagementFeatures
  ...
  /// Instantiates a new [AccountSessionsPostRequestBodyComponentsAccountManagementFeatures] and sets the default values.
  AccountSessionsPostRequestBodyComponentsAccountManagementFeatures()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static AccountSessionsPostRequestBodyComponentsAccountManagementFeatures
      createFromDiscriminatorValue(ParseNode parseNode) {
    return AccountSessionsPostRequestBodyComponentsAccountManagementFeatures();
  }
