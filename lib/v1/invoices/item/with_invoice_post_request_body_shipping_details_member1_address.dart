...
/// auto generated
class WithInvoicePostRequestBodyShippingDetailsMember1Address
  ...
  /// Instantiates a new [WithInvoicePostRequestBodyShippingDetailsMember1Address] and sets the default values.
  WithInvoicePostRequestBodyShippingDetailsMember1Address()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithInvoicePostRequestBodyShippingDetailsMember1Address
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithInvoicePostRequestBodyShippingDetailsMember1Address();
  }
