...
class AddLinesPostRequestBodyLinesTaxRates implements Parsable {
  ///  Composed type representation for type [String?]
  String? addLinesPostRequestBodyLinesTaxRatesString;
  ...
  static AddLinesPostRequestBodyLinesTaxRates createFromDiscriminatorValue(
      ParseNode parseNode) {
    var result = AddLinesPostRequestBodyLinesTaxRates();
    if (parseNode.getStringValue() != null) {
      result.addLinesPostRequestBodyLinesTaxRatesString =
