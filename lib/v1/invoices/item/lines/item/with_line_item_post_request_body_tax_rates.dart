...
class WithLineItemPostRequestBodyTaxRates implements Parsable {
  ///  Composed type representation for type [Iterable<String>?]
  Iterable<String>? string_;

  ///  Composed type representation for type [String?]
  String? withLineItemPostRequestBodyTaxRatesString;

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithLineItemPostRequestBodyTaxRates createFromDiscriminatorValue(
      ParseNode parseNode) {
    var result = WithLineItemPostRequestBodyTaxRates();
    if (parseNode.getStringValue() != null) {
      result.withLineItemPostRequestBodyTaxRatesString =
