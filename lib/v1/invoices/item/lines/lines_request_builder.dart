...
import './item/with_line_item_item_request_builder.dart';
...
class LinesRequestBuilder extends BaseRequestBuilder<LinesRequestBuilder> {
  /// Gets an item from the ApiSdk.v1.invoices.item.lines.item collection
  ///  [lineItemId] Invoice line item ID
  WithLineItemItemRequestBuilder byLineItemId(String lineItemId) {
    var urlTplParams = Map.of(pathParameters);
    urlTplParams.putIfAbsent('line_item_id', () => lineItemId);
    return WithLineItemItemRequestBuilder(urlTplParams, requestAdapter);
  }
  ...
  LinesRequestBuilder(
      ...
      : super(
            requestAdapter,
            "{+baseurl}/v1/invoices/{invoice}/lines{?ending_before*,expand*,limit*,starting_after*}",
            pathParameters);
