...
/// auto generated
class CreatePreviewPostRequestBodyScheduleDetailsPhasesTransferData
  ...
  /// Instantiates a new [CreatePreviewPostRequestBodyScheduleDetailsPhasesTransferData] and sets the default values.
  CreatePreviewPostRequestBodyScheduleDetailsPhasesTransferData()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static CreatePreviewPostRequestBodyScheduleDetailsPhasesTransferData
      createFromDiscriminatorValue(ParseNode parseNode) {
    return CreatePreviewPostRequestBodyScheduleDetailsPhasesTransferData();
  }
