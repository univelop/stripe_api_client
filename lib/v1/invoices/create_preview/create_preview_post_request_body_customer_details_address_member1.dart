...
/// auto generated
class CreatePreviewPostRequestBodyCustomerDetailsAddressMember1
  ...
  /// Instantiates a new [CreatePreviewPostRequestBodyCustomerDetailsAddressMember1] and sets the default values.
  CreatePreviewPostRequestBodyCustomerDetailsAddressMember1()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static CreatePreviewPostRequestBodyCustomerDetailsAddressMember1
      createFromDiscriminatorValue(ParseNode parseNode) {
    return CreatePreviewPostRequestBodyCustomerDetailsAddressMember1();
  }
