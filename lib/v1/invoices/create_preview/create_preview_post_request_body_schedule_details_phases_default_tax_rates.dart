...
class CreatePreviewPostRequestBodyScheduleDetailsPhasesDefaultTaxRates
    implements Parsable {
  ///  Composed type representation for type [String?]
  String?
      createPreviewPostRequestBodyScheduleDetailsPhasesDefaultTaxRatesString;
  ...
  static CreatePreviewPostRequestBodyScheduleDetailsPhasesDefaultTaxRates
      createFromDiscriminatorValue(ParseNode parseNode) {
    var result =
        CreatePreviewPostRequestBodyScheduleDetailsPhasesDefaultTaxRates();
    if (parseNode.getStringValue() != null) {
      result.createPreviewPostRequestBodyScheduleDetailsPhasesDefaultTaxRatesString =
  ...
  void serialize(SerializationWriter writer) {
    if (createPreviewPostRequestBodyScheduleDetailsPhasesDefaultTaxRatesString !=
        null) {
