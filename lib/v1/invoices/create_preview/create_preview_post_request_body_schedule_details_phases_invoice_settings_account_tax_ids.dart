...
class CreatePreviewPostRequestBodyScheduleDetailsPhasesInvoiceSettingsAccountTaxIds
    implements Parsable {
  ///  Composed type representation for type [String?]
  String?
      createPreviewPostRequestBodyScheduleDetailsPhasesInvoiceSettingsAccountTaxIdsString;
  ...
  static CreatePreviewPostRequestBodyScheduleDetailsPhasesInvoiceSettingsAccountTaxIds
      createFromDiscriminatorValue(ParseNode parseNode) {
    var result =
        CreatePreviewPostRequestBodyScheduleDetailsPhasesInvoiceSettingsAccountTaxIds();
    if (parseNode.getStringValue() != null) {
      result.createPreviewPostRequestBodyScheduleDetailsPhasesInvoiceSettingsAccountTaxIdsString =
  ...
  void serialize(SerializationWriter writer) {
    if (createPreviewPostRequestBodyScheduleDetailsPhasesInvoiceSettingsAccountTaxIdsString !=
        null) {
