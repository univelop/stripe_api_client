...
class CreatePreviewPostRequestBodyScheduleDetailsPhasesAddInvoiceItemsTaxRates
    implements Parsable {
  ///  Composed type representation for type [String?]
  String?
      createPreviewPostRequestBodyScheduleDetailsPhasesAddInvoiceItemsTaxRatesString;
  ...
  static CreatePreviewPostRequestBodyScheduleDetailsPhasesAddInvoiceItemsTaxRates
      createFromDiscriminatorValue(ParseNode parseNode) {
    var result =
        CreatePreviewPostRequestBodyScheduleDetailsPhasesAddInvoiceItemsTaxRates();
    if (parseNode.getStringValue() != null) {
      result.createPreviewPostRequestBodyScheduleDetailsPhasesAddInvoiceItemsTaxRatesString =
  ...
  void serialize(SerializationWriter writer) {
    if (createPreviewPostRequestBodyScheduleDetailsPhasesAddInvoiceItemsTaxRatesString !=
        null) {
