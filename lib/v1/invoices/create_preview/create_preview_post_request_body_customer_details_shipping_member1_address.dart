...
/// auto generated
class CreatePreviewPostRequestBodyCustomerDetailsShippingMember1Address
  ...
  /// Instantiates a new [CreatePreviewPostRequestBodyCustomerDetailsShippingMember1Address] and sets the default values.
  CreatePreviewPostRequestBodyCustomerDetailsShippingMember1Address()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static CreatePreviewPostRequestBodyCustomerDetailsShippingMember1Address
      createFromDiscriminatorValue(ParseNode parseNode) {
    return CreatePreviewPostRequestBodyCustomerDetailsShippingMember1Address();
  }
