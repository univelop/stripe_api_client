...
/// auto generated
class InvoicesPostRequestBodyShippingDetailsAddress
  ...
  /// Instantiates a new [InvoicesPostRequestBodyShippingDetailsAddress] and sets the default values.
  InvoicesPostRequestBodyShippingDetailsAddress() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static InvoicesPostRequestBodyShippingDetailsAddress
      createFromDiscriminatorValue(ParseNode parseNode) {
    return InvoicesPostRequestBodyShippingDetailsAddress();
  }
