...
class PaymentIntentsPostRequestBodyOffSession implements Parsable {
  ...
  static PaymentIntentsPostRequestBodyOffSession createFromDiscriminatorValue(
      ParseNode parseNode) {
    var result = PaymentIntentsPostRequestBodyOffSession();
