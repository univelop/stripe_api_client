...
/// auto generated
class PaymentIntentsPostRequestBodyPaymentMethodDataAuBecsDebit
  ...
  /// Instantiates a new [PaymentIntentsPostRequestBodyPaymentMethodDataAuBecsDebit] and sets the default values.
  PaymentIntentsPostRequestBodyPaymentMethodDataAuBecsDebit()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PaymentIntentsPostRequestBodyPaymentMethodDataAuBecsDebit
      createFromDiscriminatorValue(ParseNode parseNode) {
    return PaymentIntentsPostRequestBodyPaymentMethodDataAuBecsDebit();
  }
