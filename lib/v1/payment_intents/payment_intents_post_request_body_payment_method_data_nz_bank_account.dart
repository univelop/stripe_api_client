...
/// auto generated
class PaymentIntentsPostRequestBodyPaymentMethodDataNzBankAccount
  ...
  /// Instantiates a new [PaymentIntentsPostRequestBodyPaymentMethodDataNzBankAccount] and sets the default values.
  PaymentIntentsPostRequestBodyPaymentMethodDataNzBankAccount()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PaymentIntentsPostRequestBodyPaymentMethodDataNzBankAccount
      createFromDiscriminatorValue(ParseNode parseNode) {
    return PaymentIntentsPostRequestBodyPaymentMethodDataNzBankAccount();
  }
