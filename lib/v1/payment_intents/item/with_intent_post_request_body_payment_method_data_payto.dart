...
/// auto generated
class WithIntentPostRequestBodyPaymentMethodDataPayto
  ...
  /// Instantiates a new [WithIntentPostRequestBodyPaymentMethodDataPayto] and sets the default values.
  WithIntentPostRequestBodyPaymentMethodDataPayto() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithIntentPostRequestBodyPaymentMethodDataPayto
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithIntentPostRequestBodyPaymentMethodDataPayto();
  }
