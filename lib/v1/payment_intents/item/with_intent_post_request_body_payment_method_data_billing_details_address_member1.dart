...
/// auto generated
class WithIntentPostRequestBodyPaymentMethodDataBillingDetailsAddressMember1
  ...
  /// Instantiates a new [WithIntentPostRequestBodyPaymentMethodDataBillingDetailsAddressMember1] and sets the default values.
  WithIntentPostRequestBodyPaymentMethodDataBillingDetailsAddressMember1()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithIntentPostRequestBodyPaymentMethodDataBillingDetailsAddressMember1
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithIntentPostRequestBodyPaymentMethodDataBillingDetailsAddressMember1();
  }
