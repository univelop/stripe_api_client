...
/// auto generated
class ConfirmPostRequestBodyShippingMember1Address
  ...
  /// Instantiates a new [ConfirmPostRequestBodyShippingMember1Address] and sets the default values.
  ConfirmPostRequestBodyShippingMember1Address() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ConfirmPostRequestBodyShippingMember1Address
      createFromDiscriminatorValue(ParseNode parseNode) {
    return ConfirmPostRequestBodyShippingMember1Address();
  }
