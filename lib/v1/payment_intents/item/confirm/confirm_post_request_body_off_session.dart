...
class ConfirmPostRequestBodyOffSession implements Parsable {
  ...
  static ConfirmPostRequestBodyOffSession createFromDiscriminatorValue(
      ParseNode parseNode) {
    var result = ConfirmPostRequestBodyOffSession();
