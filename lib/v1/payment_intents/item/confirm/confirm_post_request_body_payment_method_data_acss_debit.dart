...
/// auto generated
class ConfirmPostRequestBodyPaymentMethodDataAcssDebit
  ...
  /// Instantiates a new [ConfirmPostRequestBodyPaymentMethodDataAcssDebit] and sets the default values.
  ConfirmPostRequestBodyPaymentMethodDataAcssDebit() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ConfirmPostRequestBodyPaymentMethodDataAcssDebit
      createFromDiscriminatorValue(ParseNode parseNode) {
    return ConfirmPostRequestBodyPaymentMethodDataAcssDebit();
  }
