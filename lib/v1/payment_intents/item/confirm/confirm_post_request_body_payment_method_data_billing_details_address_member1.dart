...
/// auto generated
class ConfirmPostRequestBodyPaymentMethodDataBillingDetailsAddressMember1
  ...
  /// Instantiates a new [ConfirmPostRequestBodyPaymentMethodDataBillingDetailsAddressMember1] and sets the default values.
  ConfirmPostRequestBodyPaymentMethodDataBillingDetailsAddressMember1()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ConfirmPostRequestBodyPaymentMethodDataBillingDetailsAddressMember1
      createFromDiscriminatorValue(ParseNode parseNode) {
    return ConfirmPostRequestBodyPaymentMethodDataBillingDetailsAddressMember1();
  }
