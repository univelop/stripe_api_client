...
/// auto generated
class WithIntentPostRequestBodyPaymentMethodDataAcssDebit
  ...
  /// Instantiates a new [WithIntentPostRequestBodyPaymentMethodDataAcssDebit] and sets the default values.
  WithIntentPostRequestBodyPaymentMethodDataAcssDebit() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithIntentPostRequestBodyPaymentMethodDataAcssDebit
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithIntentPostRequestBodyPaymentMethodDataAcssDebit();
  }
