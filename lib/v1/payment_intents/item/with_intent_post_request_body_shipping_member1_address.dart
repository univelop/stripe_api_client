...
/// auto generated
class WithIntentPostRequestBodyShippingMember1Address
  ...
  /// Instantiates a new [WithIntentPostRequestBodyShippingMember1Address] and sets the default values.
  WithIntentPostRequestBodyShippingMember1Address() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithIntentPostRequestBodyShippingMember1Address
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithIntentPostRequestBodyShippingMember1Address();
  }
