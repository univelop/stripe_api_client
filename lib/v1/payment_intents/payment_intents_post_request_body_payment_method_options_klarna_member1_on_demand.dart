...
import './payment_intents_post_request_body_payment_method_options_klarna_member1_on_demand_purchase_interval.dart';

/// auto generated
class PaymentIntentsPostRequestBodyPaymentMethodOptionsKlarnaMember1OnDemand
  ...
  PaymentIntentsPostRequestBodyPaymentMethodOptionsKlarnaMember1OnDemandPurchaseInterval?
      purchaseInterval;

  ///  The purchase_interval_count property
  int? purchaseIntervalCount;

  /// Instantiates a new [PaymentIntentsPostRequestBodyPaymentMethodOptionsKlarnaMember1OnDemand] and sets the default values.
  PaymentIntentsPostRequestBodyPaymentMethodOptionsKlarnaMember1OnDemand()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PaymentIntentsPostRequestBodyPaymentMethodOptionsKlarnaMember1OnDemand
      createFromDiscriminatorValue(ParseNode parseNode) {
    return PaymentIntentsPostRequestBodyPaymentMethodOptionsKlarnaMember1OnDemand();
  }
