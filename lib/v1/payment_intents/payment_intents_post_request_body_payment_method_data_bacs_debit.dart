...
/// auto generated
class PaymentIntentsPostRequestBodyPaymentMethodDataBacsDebit
  ...
  /// Instantiates a new [PaymentIntentsPostRequestBodyPaymentMethodDataBacsDebit] and sets the default values.
  PaymentIntentsPostRequestBodyPaymentMethodDataBacsDebit()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PaymentIntentsPostRequestBodyPaymentMethodDataBacsDebit
      createFromDiscriminatorValue(ParseNode parseNode) {
    return PaymentIntentsPostRequestBodyPaymentMethodDataBacsDebit();
  }
