...
import './payment_intents_post_request_body_payment_method_data_us_bank_account_account_holder_type.dart';
import './payment_intents_post_request_body_payment_method_data_us_bank_account_account_type.dart';

/// auto generated
class PaymentIntentsPostRequestBodyPaymentMethodDataUsBankAccount
    implements AdditionalDataHolder, Parsable {
  ///  The account_holder_type property
  PaymentIntentsPostRequestBodyPaymentMethodDataUsBankAccountAccountHolderType?
      accountHolderType;
  ...
  PaymentIntentsPostRequestBodyPaymentMethodDataUsBankAccountAccountType?
      accountType;
  ...
  /// Instantiates a new [PaymentIntentsPostRequestBodyPaymentMethodDataUsBankAccount] and sets the default values.
  PaymentIntentsPostRequestBodyPaymentMethodDataUsBankAccount()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PaymentIntentsPostRequestBodyPaymentMethodDataUsBankAccount
      createFromDiscriminatorValue(ParseNode parseNode) {
    return PaymentIntentsPostRequestBodyPaymentMethodDataUsBankAccount();
  }
