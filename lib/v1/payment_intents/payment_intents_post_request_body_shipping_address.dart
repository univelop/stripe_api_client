...
/// auto generated
class PaymentIntentsPostRequestBodyShippingAddress
  ...
  /// Instantiates a new [PaymentIntentsPostRequestBodyShippingAddress] and sets the default values.
  PaymentIntentsPostRequestBodyShippingAddress() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PaymentIntentsPostRequestBodyShippingAddress
      createFromDiscriminatorValue(ParseNode parseNode) {
    return PaymentIntentsPostRequestBodyShippingAddress();
  }
