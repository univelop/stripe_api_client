...
/// auto generated
class PaymentIntentsPostRequestBodyPaymentMethodDataPayto
  ...
  /// Instantiates a new [PaymentIntentsPostRequestBodyPaymentMethodDataPayto] and sets the default values.
  PaymentIntentsPostRequestBodyPaymentMethodDataPayto() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PaymentIntentsPostRequestBodyPaymentMethodDataPayto
      createFromDiscriminatorValue(ParseNode parseNode) {
    return PaymentIntentsPostRequestBodyPaymentMethodDataPayto();
  }
