...
class FeaturesRequestBuilder
  ...
  /// Gets an item from the ApiSdk.v1.products.item.features.item collection
  ...
  FeaturesRequestBuilder(
      ...
      : super(
            requestAdapter,
            "{+baseurl}/v1/products/{%2Did}/features{?ending_before*,expand*,limit*,starting_after*}",
            pathParameters);
  ...
  ///  [body] The request body
  ///  [requestConfiguration] Configuration for the request such as headers, query parameters, and middleware options.
  Future<ProductFeature?> postAsync(FeaturesPostRequestBody body,
