...
/// auto generated
class ProductsPostRequestBodyDefaultPriceDataCustomUnitAmount
  ...
  /// Instantiates a new [ProductsPostRequestBodyDefaultPriceDataCustomUnitAmount] and sets the default values.
  ProductsPostRequestBodyDefaultPriceDataCustomUnitAmount()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ProductsPostRequestBodyDefaultPriceDataCustomUnitAmount
      createFromDiscriminatorValue(ParseNode parseNode) {
    return ProductsPostRequestBodyDefaultPriceDataCustomUnitAmount();
  }
