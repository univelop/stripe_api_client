...
import './with_session_post_request_body_options_document_member1_allowed_types.dart';

/// auto generated
class WithSessionPostRequestBodyOptionsDocumentMember1
  ...
  Iterable<WithSessionPostRequestBodyOptionsDocumentMember1AllowedTypes>?
      allowedTypes;
  ...
  /// Instantiates a new [WithSessionPostRequestBodyOptionsDocumentMember1] and sets the default values.
  WithSessionPostRequestBodyOptionsDocumentMember1() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithSessionPostRequestBodyOptionsDocumentMember1
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithSessionPostRequestBodyOptionsDocumentMember1();
  }
  ...
  Map<String, void Function(ParseNode)> getFieldDeserializers() {
    ...
    deserializerMap['allowed_types'] = (node) => allowedTypes =
        node.getCollectionOfEnumValues<
                WithSessionPostRequestBodyOptionsDocumentMember1AllowedTypes>(
            (stringValue) =>
                WithSessionPostRequestBodyOptionsDocumentMember1AllowedTypes
                    .values
