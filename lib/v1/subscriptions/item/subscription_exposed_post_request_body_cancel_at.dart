...
class SubscriptionExposedPostRequestBodyCancelAt implements Parsable {
  ...
  static SubscriptionExposedPostRequestBodyCancelAt
      createFromDiscriminatorValue(ParseNode parseNode) {
    var result = SubscriptionExposedPostRequestBodyCancelAt();
