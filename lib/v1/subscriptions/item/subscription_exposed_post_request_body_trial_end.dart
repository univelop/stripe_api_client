...
class SubscriptionExposedPostRequestBodyTrialEnd implements Parsable {
  ...
  static SubscriptionExposedPostRequestBodyTrialEnd
      createFromDiscriminatorValue(ParseNode parseNode) {
    var result = SubscriptionExposedPostRequestBodyTrialEnd();
