...
import './subscription_exposed_post_request_body_add_invoice_items_price_data_tax_behavior.dart';

/// auto generated
class SubscriptionExposedPostRequestBodyAddInvoiceItemsPriceData
  ...
  SubscriptionExposedPostRequestBodyAddInvoiceItemsPriceDataTaxBehavior?
      taxBehavior;
  ...
  /// Instantiates a new [SubscriptionExposedPostRequestBodyAddInvoiceItemsPriceData] and sets the default values.
  SubscriptionExposedPostRequestBodyAddInvoiceItemsPriceData()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static SubscriptionExposedPostRequestBodyAddInvoiceItemsPriceData
      createFromDiscriminatorValue(ParseNode parseNode) {
    return SubscriptionExposedPostRequestBodyAddInvoiceItemsPriceData();
  }
