...
class SubscriptionExposedPostRequestBodyDefaultTaxRates implements Parsable {
  ///  Composed type representation for type [Iterable<String>?]
  Iterable<String>? string_;

  ///  Composed type representation for type [String?]
  String? subscriptionExposedPostRequestBodyDefaultTaxRatesString;

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static SubscriptionExposedPostRequestBodyDefaultTaxRates
      createFromDiscriminatorValue(ParseNode parseNode) {
    var result = SubscriptionExposedPostRequestBodyDefaultTaxRates();
    if (parseNode.getStringValue() != null) {
      result.subscriptionExposedPostRequestBodyDefaultTaxRatesString =
  ...
  void serialize(SerializationWriter writer) {
    if (subscriptionExposedPostRequestBodyDefaultTaxRatesString != null) {
      writer.writeStringValue(
          null, subscriptionExposedPostRequestBodyDefaultTaxRatesString);
