...
/// auto generated
class SubscriptionsPostRequestBodyAddInvoiceItemsDiscounts
  ...
  /// Instantiates a new [SubscriptionsPostRequestBodyAddInvoiceItemsDiscounts] and sets the default values.
  SubscriptionsPostRequestBodyAddInvoiceItemsDiscounts() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static SubscriptionsPostRequestBodyAddInvoiceItemsDiscounts
      createFromDiscriminatorValue(ParseNode parseNode) {
    return SubscriptionsPostRequestBodyAddInvoiceItemsDiscounts();
  }
