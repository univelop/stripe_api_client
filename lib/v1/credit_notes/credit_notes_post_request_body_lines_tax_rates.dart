...
class CreditNotesPostRequestBodyLinesTaxRates implements Parsable {
  ///  Composed type representation for type [String?]
  String? creditNotesPostRequestBodyLinesTaxRatesString;
  ...
  static CreditNotesPostRequestBodyLinesTaxRates createFromDiscriminatorValue(
      ParseNode parseNode) {
    var result = CreditNotesPostRequestBodyLinesTaxRates();
    if (parseNode.getStringValue() != null) {
      result.creditNotesPostRequestBodyLinesTaxRatesString =
  ...
  void serialize(SerializationWriter writer) {
    if (creditNotesPostRequestBodyLinesTaxRatesString != null) {
      writer.writeStringValue(
          null, creditNotesPostRequestBodyLinesTaxRatesString);
