...
import './payment_method_configurations_post_request_body_klarna_display_preference.dart';
...
class PaymentMethodConfigurationsPostRequestBodyKlarna
  ...
  /// Instantiates a new [PaymentMethodConfigurationsPostRequestBodyKlarna] and sets the default values.
  PaymentMethodConfigurationsPostRequestBodyKlarna() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PaymentMethodConfigurationsPostRequestBodyKlarna
      createFromDiscriminatorValue(ParseNode parseNode) {
    return PaymentMethodConfigurationsPostRequestBodyKlarna();
  }
