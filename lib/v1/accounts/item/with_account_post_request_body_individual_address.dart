...
/// auto generated
class WithAccountPostRequestBodyIndividualAddress
  ...
  /// Instantiates a new [WithAccountPostRequestBodyIndividualAddress] and sets the default values.
  WithAccountPostRequestBodyIndividualAddress() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithAccountPostRequestBodyIndividualAddress
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithAccountPostRequestBodyIndividualAddress();
  }
