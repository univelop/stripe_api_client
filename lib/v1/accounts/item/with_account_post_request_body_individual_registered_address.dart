...
/// auto generated
class WithAccountPostRequestBodyIndividualRegisteredAddress
  ...
  /// Instantiates a new [WithAccountPostRequestBodyIndividualRegisteredAddress] and sets the default values.
  WithAccountPostRequestBodyIndividualRegisteredAddress() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithAccountPostRequestBodyIndividualRegisteredAddress
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithAccountPostRequestBodyIndividualRegisteredAddress();
  }
