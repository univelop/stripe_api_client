...
import './external_accounts_post_request_body_account_holder_type.dart';
import './external_accounts_post_request_body_account_type.dart';
import './external_accounts_post_request_body_documents.dart';

/// auto generated
class ExternalAccountsPostRequestBody implements Parsable {
  ///  The name of the person or business that owns the bank account.
  String? accountHolderName;

  ///  The type of entity that holds the account. This can be either `individual` or `company`.
  ExternalAccountsPostRequestBodyAccountHolderType? accountHolderType;

  ///  The bank account type. This can only be `checking` or `savings` in most countries. In Japan, this can only be `futsu` or `toza`.
  ExternalAccountsPostRequestBodyAccountType? accountType;
  ...
  ExternalAccountsPostRequestBodyDocuments? documents;
  ...
  static ExternalAccountsPostRequestBody createFromDiscriminatorValue(
      ParseNode parseNode) {
    return ExternalAccountsPostRequestBody();
  }
  ...
  Map<String, void Function(ParseNode)> getFieldDeserializers() {
    ...
    deserializerMap['account_holder_type'] = (node) => accountHolderType =
        node.getEnumValue<ExternalAccountsPostRequestBodyAccountHolderType>(
            (stringValue) => ExternalAccountsPostRequestBodyAccountHolderType
                .values
                .where((enumVal) => enumVal.value == stringValue)
                .firstOrNull);
    deserializerMap['account_type'] = (node) => accountType =
        node.getEnumValue<ExternalAccountsPostRequestBodyAccountType>(
            (stringValue) => ExternalAccountsPostRequestBodyAccountType.values
                .where((enumVal) => enumVal.value == stringValue)
                .firstOrNull);
    ...
    deserializerMap['documents'] = (node) => documents = node.getObjectValue<
            ExternalAccountsPostRequestBodyDocuments>(
        ExternalAccountsPostRequestBodyDocuments.createFromDiscriminatorValue);
  ...
  void serialize(SerializationWriter writer) {
    ...
    writer.writeEnumValue<ExternalAccountsPostRequestBodyAccountHolderType>(
        'account_holder_type', accountHolderType, (e) => e?.value);
    writer.writeEnumValue<ExternalAccountsPostRequestBodyAccountType>(
    ...
    writer.writeObjectValue<ExternalAccountsPostRequestBodyDocuments>(
        'documents', documents);
