...
import './external_accounts_delete_request_body.dart';
import './external_accounts_get_request_body.dart';
import './external_accounts_item_request_builder_get_query_parameters.dart';
...
class ExternalAccountsItemRequestBuilder
  ...
  ExternalAccountsItemRequestBuilder(
      ...
      : super(
            requestAdapter,
            "{+baseurl}/v1/accounts/{account}/external_accounts/{id}{?expand*}",
            pathParameters);
  ...
  Future<DeletedExternalAccount?> deleteAsync(
      ExternalAccountsDeleteRequestBody body,
  ...
  ///  [body] The request body
  ///  [requestConfiguration] Configuration for the request such as headers, query parameters, and middleware options.
  Future<ExternalAccount?> getAsync(ExternalAccountsGetRequestBody body,
      [void Function(
              RequestConfiguration<
                  ExternalAccountsItemRequestBuilderGetQueryParameters>)?
          requestConfiguration]) async {
  ...
  RequestInformation toGetRequestInformation(
      ExternalAccountsGetRequestBody body,
      [void Function(
              RequestConfiguration<
                  ExternalAccountsItemRequestBuilderGetQueryParameters>)?
          requestConfiguration]) {
    var requestInfo = RequestInformation(
        ...
        urlTemplate: urlTemplate,
        pathParameters: pathParameters);
    requestInfo.configure<ExternalAccountsItemRequestBuilderGetQueryParameters>(
        requestConfiguration,
        () => ExternalAccountsItemRequestBuilderGetQueryParameters());
    requestInfo.headers.put('Accept', 'application/json');
    requestInfo.setContentFromParsable(
