...
class ExternalAccountsGetResponseData implements Parsable {
  ...
  static ExternalAccountsGetResponseData createFromDiscriminatorValue(
      ParseNode parseNode) {
    var result = ExternalAccountsGetResponseData();
