...
/// auto generated
class WithAccountPostRequestBodyCompanyRepresentativeDeclaration
  ...
  /// Instantiates a new [WithAccountPostRequestBodyCompanyRepresentativeDeclaration] and sets the default values.
  WithAccountPostRequestBodyCompanyRepresentativeDeclaration()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithAccountPostRequestBodyCompanyRepresentativeDeclaration
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithAccountPostRequestBodyCompanyRepresentativeDeclaration();
  }
