...
/// auto generated
class WithAccountPostRequestBodyIndividualAddressKanji
  ...
  /// Instantiates a new [WithAccountPostRequestBodyIndividualAddressKanji] and sets the default values.
  WithAccountPostRequestBodyIndividualAddressKanji() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithAccountPostRequestBodyIndividualAddressKanji
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithAccountPostRequestBodyIndividualAddressKanji();
  }
