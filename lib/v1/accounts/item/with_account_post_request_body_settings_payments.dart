...
/// auto generated
class WithAccountPostRequestBodySettingsPayments
  ...
  /// Instantiates a new [WithAccountPostRequestBodySettingsPayments] and sets the default values.
  WithAccountPostRequestBodySettingsPayments() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithAccountPostRequestBodySettingsPayments
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithAccountPostRequestBodySettingsPayments();
  }
