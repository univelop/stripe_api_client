...
import './persons_post_request_body_relationship_percent_ownership.dart';

/// auto generated
/// The relationship that this person has with the account's legal entity.
class PersonsPostRequestBodyRelationship
  ...
  PersonsPostRequestBodyRelationshipPercentOwnership? percentOwnership;
  ...
  /// Instantiates a new [PersonsPostRequestBodyRelationship] and sets the default values.
  PersonsPostRequestBodyRelationship() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PersonsPostRequestBodyRelationship createFromDiscriminatorValue(
      ParseNode parseNode) {
    return PersonsPostRequestBodyRelationship();
  }
  ...
  Map<String, void Function(ParseNode)> getFieldDeserializers() {
    ...
    deserializerMap['percent_ownership'] = (node) => percentOwnership =
        node.getObjectValue<PersonsPostRequestBodyRelationshipPercentOwnership>(
            PersonsPostRequestBodyRelationshipPercentOwnership
  ...
  void serialize(SerializationWriter writer) {
    ...
    writer.writeObjectValue<PersonsPostRequestBodyRelationshipPercentOwnership>(
