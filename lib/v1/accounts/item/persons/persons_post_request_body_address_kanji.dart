...
class PersonsPostRequestBodyAddressKanji
  ...
  /// Instantiates a new [PersonsPostRequestBodyAddressKanji] and sets the default values.
  PersonsPostRequestBodyAddressKanji() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PersonsPostRequestBodyAddressKanji createFromDiscriminatorValue(
      ParseNode parseNode) {
    return PersonsPostRequestBodyAddressKanji();
  }
