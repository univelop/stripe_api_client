...
class WithPersonPostRequestBodyRegisteredAddress
  ...
  /// Instantiates a new [WithPersonPostRequestBodyRegisteredAddress] and sets the default values.
  WithPersonPostRequestBodyRegisteredAddress() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithPersonPostRequestBodyRegisteredAddress
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithPersonPostRequestBodyRegisteredAddress();
  }
