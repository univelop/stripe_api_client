...
class WithPersonPostRequestBodyAddress
  ...
  /// Instantiates a new [WithPersonPostRequestBodyAddress] and sets the default values.
  WithPersonPostRequestBodyAddress() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithPersonPostRequestBodyAddress createFromDiscriminatorValue(
      ParseNode parseNode) {
    return WithPersonPostRequestBodyAddress();
  }
