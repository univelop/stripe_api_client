...
class WithPersonPostRequestBodyFullNameAliases implements Parsable {
  ///  Composed type representation for type [Iterable<String>?]
  Iterable<String>? string_;

  ///  Composed type representation for type [String?]
  String? withPersonPostRequestBodyFullNameAliasesString;

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithPersonPostRequestBodyFullNameAliases createFromDiscriminatorValue(
      ParseNode parseNode) {
    var result = WithPersonPostRequestBodyFullNameAliases();
    if (parseNode.getStringValue() != null) {
      result.withPersonPostRequestBodyFullNameAliasesString =
  ...
  void serialize(SerializationWriter writer) {
    if (withPersonPostRequestBodyFullNameAliasesString != null) {
      writer.writeStringValue(
          null, withPersonPostRequestBodyFullNameAliasesString);
