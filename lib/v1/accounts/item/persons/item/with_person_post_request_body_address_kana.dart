...
class WithPersonPostRequestBodyAddressKana
  ...
  /// Instantiates a new [WithPersonPostRequestBodyAddressKana] and sets the default values.
  WithPersonPostRequestBodyAddressKana() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithPersonPostRequestBodyAddressKana createFromDiscriminatorValue(
      ParseNode parseNode) {
    return WithPersonPostRequestBodyAddressKana();
  }
