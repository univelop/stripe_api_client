...
class PersonsPostRequestBodyAddressKana
  ...
  /// Instantiates a new [PersonsPostRequestBodyAddressKana] and sets the default values.
  PersonsPostRequestBodyAddressKana() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PersonsPostRequestBodyAddressKana createFromDiscriminatorValue(
      ParseNode parseNode) {
    return PersonsPostRequestBodyAddressKana();
  }
