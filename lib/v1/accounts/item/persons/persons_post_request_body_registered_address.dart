...
class PersonsPostRequestBodyRegisteredAddress
  ...
  /// Instantiates a new [PersonsPostRequestBodyRegisteredAddress] and sets the default values.
  PersonsPostRequestBodyRegisteredAddress() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PersonsPostRequestBodyRegisteredAddress createFromDiscriminatorValue(
      ParseNode parseNode) {
    return PersonsPostRequestBodyRegisteredAddress();
  }
