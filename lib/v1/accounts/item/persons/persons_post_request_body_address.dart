...
class PersonsPostRequestBodyAddress implements AdditionalDataHolder, Parsable {
  ...
  /// Instantiates a new [PersonsPostRequestBodyAddress] and sets the default values.
  PersonsPostRequestBodyAddress() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PersonsPostRequestBodyAddress createFromDiscriminatorValue(
      ParseNode parseNode) {
    return PersonsPostRequestBodyAddress();
  }
