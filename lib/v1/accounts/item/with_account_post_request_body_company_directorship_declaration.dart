...
/// auto generated
class WithAccountPostRequestBodyCompanyDirectorshipDeclaration
  ...
  /// Instantiates a new [WithAccountPostRequestBodyCompanyDirectorshipDeclaration] and sets the default values.
  WithAccountPostRequestBodyCompanyDirectorshipDeclaration()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithAccountPostRequestBodyCompanyDirectorshipDeclaration
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithAccountPostRequestBodyCompanyDirectorshipDeclaration();
  }
