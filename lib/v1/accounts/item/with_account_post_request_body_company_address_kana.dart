...
/// auto generated
class WithAccountPostRequestBodyCompanyAddressKana
  ...
  /// Instantiates a new [WithAccountPostRequestBodyCompanyAddressKana] and sets the default values.
  WithAccountPostRequestBodyCompanyAddressKana() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithAccountPostRequestBodyCompanyAddressKana
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithAccountPostRequestBodyCompanyAddressKana();
  }
