...
/// auto generated
class WithAccountPostRequestBodyBusinessProfileSupportAddress
  ...
  /// Instantiates a new [WithAccountPostRequestBodyBusinessProfileSupportAddress] and sets the default values.
  WithAccountPostRequestBodyBusinessProfileSupportAddress()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithAccountPostRequestBodyBusinessProfileSupportAddress
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithAccountPostRequestBodyBusinessProfileSupportAddress();
  }
