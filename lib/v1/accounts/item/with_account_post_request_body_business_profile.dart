...
import './with_account_post_request_body_business_profile_annual_revenue.dart';
import './with_account_post_request_body_business_profile_minority_owned_business_designation.dart';
import './with_account_post_request_body_business_profile_monthly_estimated_revenue.dart';
import './with_account_post_request_body_business_profile_support_address.dart';
import './with_account_post_request_body_business_profile_support_url.dart';

/// auto generated
/// Business information about the account.
class WithAccountPostRequestBodyBusinessProfile
  ...
  WithAccountPostRequestBodyBusinessProfileAnnualRevenue? annualRevenue;
  ...
  Iterable<
          WithAccountPostRequestBodyBusinessProfileMinorityOwnedBusinessDesignation>?
  ...
  WithAccountPostRequestBodyBusinessProfileSupportAddress? supportAddress;
  ...
  WithAccountPostRequestBodyBusinessProfileSupportUrl? supportUrl;

  ///  The url property
  String? url;

  /// Instantiates a new [WithAccountPostRequestBodyBusinessProfile] and sets the default values.
  WithAccountPostRequestBodyBusinessProfile() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithAccountPostRequestBodyBusinessProfile createFromDiscriminatorValue(
      ParseNode parseNode) {
    return WithAccountPostRequestBodyBusinessProfile();
  }
  ...
  Map<String, void Function(ParseNode)> getFieldDeserializers() {
    ...
    deserializerMap['annual_revenue'] = (node) => annualRevenue = node
        .getObjectValue<WithAccountPostRequestBodyBusinessProfileAnnualRevenue>(
    ...
    deserializerMap['support_address'] = (node) => supportAddress =
        node.getObjectValue<
                WithAccountPostRequestBodyBusinessProfileSupportAddress>(
            WithAccountPostRequestBodyBusinessProfileSupportAddress
                .createFromDiscriminatorValue);
    ...
    deserializerMap['support_url'] = (node) => supportUrl = node
        .getObjectValue<WithAccountPostRequestBodyBusinessProfileSupportUrl>(
            WithAccountPostRequestBodyBusinessProfileSupportUrl
                .createFromDiscriminatorValue);
  ...
  void serialize(SerializationWriter writer) {
    ...
    writer
        .writeObjectValue<WithAccountPostRequestBodyBusinessProfileSupportUrl>(
