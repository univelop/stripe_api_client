...
class PeoplePostRequestBodyAddressKana
  ...
  /// Instantiates a new [PeoplePostRequestBodyAddressKana] and sets the default values.
  PeoplePostRequestBodyAddressKana() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PeoplePostRequestBodyAddressKana createFromDiscriminatorValue(
      ParseNode parseNode) {
    return PeoplePostRequestBodyAddressKana();
  }
