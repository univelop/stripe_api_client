...
class PeoplePostRequestBodyAddress implements AdditionalDataHolder, Parsable {
  ...
  /// Instantiates a new [PeoplePostRequestBodyAddress] and sets the default values.
  PeoplePostRequestBodyAddress() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PeoplePostRequestBodyAddress createFromDiscriminatorValue(
      ParseNode parseNode) {
    return PeoplePostRequestBodyAddress();
  }
