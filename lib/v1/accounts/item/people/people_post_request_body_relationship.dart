...
import './people_post_request_body_relationship_percent_ownership.dart';

/// auto generated
/// The relationship that this person has with the account's legal entity.
class PeoplePostRequestBodyRelationship
  ...
  PeoplePostRequestBodyRelationshipPercentOwnership? percentOwnership;
  ...
  /// Instantiates a new [PeoplePostRequestBodyRelationship] and sets the default values.
  PeoplePostRequestBodyRelationship() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PeoplePostRequestBodyRelationship createFromDiscriminatorValue(
      ParseNode parseNode) {
    return PeoplePostRequestBodyRelationship();
  }
  ...
  Map<String, void Function(ParseNode)> getFieldDeserializers() {
    ...
    deserializerMap['percent_ownership'] = (node) => percentOwnership =
        node.getObjectValue<PeoplePostRequestBodyRelationshipPercentOwnership>(
            PeoplePostRequestBodyRelationshipPercentOwnership
  ...
  void serialize(SerializationWriter writer) {
    ...
    writer.writeObjectValue<PeoplePostRequestBodyRelationshipPercentOwnership>(
