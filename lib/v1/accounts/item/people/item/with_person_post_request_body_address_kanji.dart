...
class WithPersonPostRequestBodyAddressKanji
  ...
  /// Instantiates a new [WithPersonPostRequestBodyAddressKanji] and sets the default values.
  WithPersonPostRequestBodyAddressKanji() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithPersonPostRequestBodyAddressKanji createFromDiscriminatorValue(
      ParseNode parseNode) {
    return WithPersonPostRequestBodyAddressKanji();
  }
