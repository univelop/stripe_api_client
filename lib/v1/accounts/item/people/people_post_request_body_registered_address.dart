...
class PeoplePostRequestBodyRegisteredAddress
  ...
  /// Instantiates a new [PeoplePostRequestBodyRegisteredAddress] and sets the default values.
  PeoplePostRequestBodyRegisteredAddress() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PeoplePostRequestBodyRegisteredAddress createFromDiscriminatorValue(
      ParseNode parseNode) {
    return PeoplePostRequestBodyRegisteredAddress();
  }
