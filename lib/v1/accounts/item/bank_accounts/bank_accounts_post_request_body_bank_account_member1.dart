...
import './bank_accounts_post_request_body_bank_account_member1_account_type.dart';
import './bank_accounts_post_request_body_bank_account_member1_documents.dart';
...
class BankAccountsPostRequestBodyBankAccountMember1
  ...
  BankAccountsPostRequestBodyBankAccountMember1AccountType? accountType;
  ...
  BankAccountsPostRequestBodyBankAccountMember1Documents? documents;
  ...
  Map<String, void Function(ParseNode)> getFieldDeserializers() {
    ...
    deserializerMap['account_type'] = (node) => accountType = node
        .getEnumValue<BankAccountsPostRequestBodyBankAccountMember1AccountType>(
            (stringValue) =>
                BankAccountsPostRequestBodyBankAccountMember1AccountType.values
                    .where((enumVal) => enumVal.value == stringValue)
                    .firstOrNull);
    deserializerMap['country'] = (node) => country = node.getStringValue();
    deserializerMap['currency'] = (node) => currency = node.getStringValue();
    deserializerMap['documents'] = (node) => documents = node
        .getObjectValue<BankAccountsPostRequestBodyBankAccountMember1Documents>(
  ...
  void serialize(SerializationWriter writer) {
    ...
    writer.writeEnumValue<
            BankAccountsPostRequestBodyBankAccountMember1AccountType>(
