...
import './bank_accounts_post_request_body_account_holder_type.dart';
import './bank_accounts_post_request_body_account_type.dart';
import './bank_accounts_post_request_body_documents.dart';

/// auto generated
class BankAccountsPostRequestBody implements Parsable {
  ///  The name of the person or business that owns the bank account.
  String? accountHolderName;

  ///  The type of entity that holds the account. This can be either `individual` or `company`.
  BankAccountsPostRequestBodyAccountHolderType? accountHolderType;

  ///  The bank account type. This can only be `checking` or `savings` in most countries. In Japan, this can only be `futsu` or `toza`.
  BankAccountsPostRequestBodyAccountType? accountType;
  ...
  BankAccountsPostRequestBodyDocuments? documents;
  ...
  static BankAccountsPostRequestBody createFromDiscriminatorValue(
      ParseNode parseNode) {
  ...
  Map<String, void Function(ParseNode)> getFieldDeserializers() {
    ...
    deserializerMap['account_holder_type'] = (node) => accountHolderType =
        node.getEnumValue<BankAccountsPostRequestBodyAccountHolderType>(
            (stringValue) => BankAccountsPostRequestBodyAccountHolderType.values
                .where((enumVal) => enumVal.value == stringValue)
                .firstOrNull);
    deserializerMap['account_type'] = (node) => accountType =
        node.getEnumValue<BankAccountsPostRequestBodyAccountType>(
            (stringValue) => BankAccountsPostRequestBodyAccountType.values
                .where((enumVal) => enumVal.value == stringValue)
                .firstOrNull);
    ...
    deserializerMap['documents'] = (node) => documents =
        node.getObjectValue<BankAccountsPostRequestBodyDocuments>(
            BankAccountsPostRequestBodyDocuments.createFromDiscriminatorValue);
  ...
  void serialize(SerializationWriter writer) {
    ...
    writer.writeEnumValue<BankAccountsPostRequestBodyAccountHolderType>(
        'account_holder_type', accountHolderType, (e) => e?.value);
    writer.writeEnumValue<BankAccountsPostRequestBodyAccountType>(
    ...
    writer.writeObjectValue<BankAccountsPostRequestBodyDocuments>(
        'documents', documents);
