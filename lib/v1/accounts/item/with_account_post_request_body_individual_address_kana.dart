...
/// auto generated
class WithAccountPostRequestBodyIndividualAddressKana
  ...
  /// Instantiates a new [WithAccountPostRequestBodyIndividualAddressKana] and sets the default values.
  WithAccountPostRequestBodyIndividualAddressKana() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithAccountPostRequestBodyIndividualAddressKana
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithAccountPostRequestBodyIndividualAddressKana();
  }
