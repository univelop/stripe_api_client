...
/// auto generated
class WithAccountPostRequestBodyCompanyAddress
  ...
  /// Instantiates a new [WithAccountPostRequestBodyCompanyAddress] and sets the default values.
  WithAccountPostRequestBodyCompanyAddress() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithAccountPostRequestBodyCompanyAddress createFromDiscriminatorValue(
      ParseNode parseNode) {
    return WithAccountPostRequestBodyCompanyAddress();
  }
