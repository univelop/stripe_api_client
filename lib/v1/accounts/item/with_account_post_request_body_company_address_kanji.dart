...
/// auto generated
class WithAccountPostRequestBodyCompanyAddressKanji
  ...
  /// Instantiates a new [WithAccountPostRequestBodyCompanyAddressKanji] and sets the default values.
  WithAccountPostRequestBodyCompanyAddressKanji() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithAccountPostRequestBodyCompanyAddressKanji
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithAccountPostRequestBodyCompanyAddressKanji();
  }
