...
/// auto generated
class AccountsPostRequestBodyCompanyAddressKanji
  ...
  /// Instantiates a new [AccountsPostRequestBodyCompanyAddressKanji] and sets the default values.
  AccountsPostRequestBodyCompanyAddressKanji() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static AccountsPostRequestBodyCompanyAddressKanji
      createFromDiscriminatorValue(ParseNode parseNode) {
    return AccountsPostRequestBodyCompanyAddressKanji();
  }
