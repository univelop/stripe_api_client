...
/// auto generated
class AccountsPostRequestBodyCompanyRepresentativeDeclaration
  ...
  /// Instantiates a new [AccountsPostRequestBodyCompanyRepresentativeDeclaration] and sets the default values.
  AccountsPostRequestBodyCompanyRepresentativeDeclaration()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static AccountsPostRequestBodyCompanyRepresentativeDeclaration
      createFromDiscriminatorValue(ParseNode parseNode) {
    return AccountsPostRequestBodyCompanyRepresentativeDeclaration();
  }
