...
/// auto generated
class AccountsPostRequestBodyBusinessProfileSupportAddress
  ...
  /// Instantiates a new [AccountsPostRequestBodyBusinessProfileSupportAddress] and sets the default values.
  AccountsPostRequestBodyBusinessProfileSupportAddress() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static AccountsPostRequestBodyBusinessProfileSupportAddress
      createFromDiscriminatorValue(ParseNode parseNode) {
    return AccountsPostRequestBodyBusinessProfileSupportAddress();
  }
