...
/// auto generated
class AccountsPostRequestBodySettingsBranding
  ...
  /// Instantiates a new [AccountsPostRequestBodySettingsBranding] and sets the default values.
  AccountsPostRequestBodySettingsBranding() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static AccountsPostRequestBodySettingsBranding createFromDiscriminatorValue(
      ParseNode parseNode) {
    return AccountsPostRequestBodySettingsBranding();
  }
