...
/// auto generated
class AccountsPostRequestBodyCompanyAddressKana
  ...
  /// Instantiates a new [AccountsPostRequestBodyCompanyAddressKana] and sets the default values.
  AccountsPostRequestBodyCompanyAddressKana() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static AccountsPostRequestBodyCompanyAddressKana createFromDiscriminatorValue(
      ParseNode parseNode) {
    return AccountsPostRequestBodyCompanyAddressKana();
  }
