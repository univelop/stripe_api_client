...
/// auto generated
class AccountsPostRequestBodyIndividualRegisteredAddress
  ...
  /// Instantiates a new [AccountsPostRequestBodyIndividualRegisteredAddress] and sets the default values.
  AccountsPostRequestBodyIndividualRegisteredAddress() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static AccountsPostRequestBodyIndividualRegisteredAddress
      createFromDiscriminatorValue(ParseNode parseNode) {
    return AccountsPostRequestBodyIndividualRegisteredAddress();
  }
