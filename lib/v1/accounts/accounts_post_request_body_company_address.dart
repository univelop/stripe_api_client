...
/// auto generated
class AccountsPostRequestBodyCompanyAddress
  ...
  /// Instantiates a new [AccountsPostRequestBodyCompanyAddress] and sets the default values.
  AccountsPostRequestBodyCompanyAddress() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static AccountsPostRequestBodyCompanyAddress createFromDiscriminatorValue(
      ParseNode parseNode) {
    return AccountsPostRequestBodyCompanyAddress();
  }
