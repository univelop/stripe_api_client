...
import './accounts_post_request_body_individual_relationship_percent_ownership.dart';

/// auto generated
class AccountsPostRequestBodyIndividualRelationship
  ...
  AccountsPostRequestBodyIndividualRelationshipPercentOwnership?
      percentOwnership;

  ///  The title property
  String? title;

  /// Instantiates a new [AccountsPostRequestBodyIndividualRelationship] and sets the default values.
  AccountsPostRequestBodyIndividualRelationship() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static AccountsPostRequestBodyIndividualRelationship
      createFromDiscriminatorValue(ParseNode parseNode) {
    return AccountsPostRequestBodyIndividualRelationship();
  }
