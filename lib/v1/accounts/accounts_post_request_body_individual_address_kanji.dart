...
/// auto generated
class AccountsPostRequestBodyIndividualAddressKanji
  ...
  /// Instantiates a new [AccountsPostRequestBodyIndividualAddressKanji] and sets the default values.
  AccountsPostRequestBodyIndividualAddressKanji() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static AccountsPostRequestBodyIndividualAddressKanji
      createFromDiscriminatorValue(ParseNode parseNode) {
    return AccountsPostRequestBodyIndividualAddressKanji();
  }
