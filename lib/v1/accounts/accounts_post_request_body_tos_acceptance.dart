...
class AccountsPostRequestBodyTosAcceptance
  ...
  /// Instantiates a new [AccountsPostRequestBodyTosAcceptance] and sets the default values.
  AccountsPostRequestBodyTosAcceptance() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static AccountsPostRequestBodyTosAcceptance createFromDiscriminatorValue(
      ParseNode parseNode) {
    return AccountsPostRequestBodyTosAcceptance();
  }
