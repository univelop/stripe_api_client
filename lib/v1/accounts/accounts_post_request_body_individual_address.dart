...
/// auto generated
class AccountsPostRequestBodyIndividualAddress
  ...
  /// Instantiates a new [AccountsPostRequestBodyIndividualAddress] and sets the default values.
  AccountsPostRequestBodyIndividualAddress() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static AccountsPostRequestBodyIndividualAddress createFromDiscriminatorValue(
      ParseNode parseNode) {
    return AccountsPostRequestBodyIndividualAddress();
  }
