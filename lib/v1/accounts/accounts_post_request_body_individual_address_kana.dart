...
/// auto generated
class AccountsPostRequestBodyIndividualAddressKana
  ...
  /// Instantiates a new [AccountsPostRequestBodyIndividualAddressKana] and sets the default values.
  AccountsPostRequestBodyIndividualAddressKana() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static AccountsPostRequestBodyIndividualAddressKana
      createFromDiscriminatorValue(ParseNode parseNode) {
    return AccountsPostRequestBodyIndividualAddressKana();
  }
