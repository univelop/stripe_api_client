...
/// auto generated
enum AccountsPostRequestBodyBusinessProfileMinorityOwnedBusinessDesignation {
  ...
  const AccountsPostRequestBodyBusinessProfileMinorityOwnedBusinessDesignation(
      this.value);
  final String value;
}
