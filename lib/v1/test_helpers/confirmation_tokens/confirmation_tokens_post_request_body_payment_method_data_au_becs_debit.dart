...
/// auto generated
class ConfirmationTokensPostRequestBodyPaymentMethodDataAuBecsDebit
  ...
  /// Instantiates a new [ConfirmationTokensPostRequestBodyPaymentMethodDataAuBecsDebit] and sets the default values.
  ConfirmationTokensPostRequestBodyPaymentMethodDataAuBecsDebit()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ConfirmationTokensPostRequestBodyPaymentMethodDataAuBecsDebit
      createFromDiscriminatorValue(ParseNode parseNode) {
    return ConfirmationTokensPostRequestBodyPaymentMethodDataAuBecsDebit();
  }
