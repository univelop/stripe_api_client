...
/// auto generated
class ConfirmationTokensPostRequestBodyShippingAddress
  ...
  /// Instantiates a new [ConfirmationTokensPostRequestBodyShippingAddress] and sets the default values.
  ConfirmationTokensPostRequestBodyShippingAddress() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ConfirmationTokensPostRequestBodyShippingAddress
      createFromDiscriminatorValue(ParseNode parseNode) {
    return ConfirmationTokensPostRequestBodyShippingAddress();
  }
