...
/// auto generated
class ConfirmationTokensPostRequestBodyPaymentMethodDataNzBankAccount
  ...
  /// Instantiates a new [ConfirmationTokensPostRequestBodyPaymentMethodDataNzBankAccount] and sets the default values.
  ConfirmationTokensPostRequestBodyPaymentMethodDataNzBankAccount()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ConfirmationTokensPostRequestBodyPaymentMethodDataNzBankAccount
      createFromDiscriminatorValue(ParseNode parseNode) {
    return ConfirmationTokensPostRequestBodyPaymentMethodDataNzBankAccount();
  }
