...
/// auto generated
class ConfirmationTokensPostRequestBodyPaymentMethodDataAcssDebit
  ...
  /// Instantiates a new [ConfirmationTokensPostRequestBodyPaymentMethodDataAcssDebit] and sets the default values.
  ConfirmationTokensPostRequestBodyPaymentMethodDataAcssDebit()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ConfirmationTokensPostRequestBodyPaymentMethodDataAcssDebit
      createFromDiscriminatorValue(ParseNode parseNode) {
    return ConfirmationTokensPostRequestBodyPaymentMethodDataAcssDebit();
  }
