...
import './confirmation_tokens_post_request_body_payment_method_data_us_bank_account_account_holder_type.dart';
import './confirmation_tokens_post_request_body_payment_method_data_us_bank_account_account_type.dart';

/// auto generated
class ConfirmationTokensPostRequestBodyPaymentMethodDataUsBankAccount
    implements AdditionalDataHolder, Parsable {
  ///  The account_holder_type property
  ConfirmationTokensPostRequestBodyPaymentMethodDataUsBankAccountAccountHolderType?
      accountHolderType;
  ...
  ConfirmationTokensPostRequestBodyPaymentMethodDataUsBankAccountAccountType?
      accountType;
  ...
  /// Instantiates a new [ConfirmationTokensPostRequestBodyPaymentMethodDataUsBankAccount] and sets the default values.
  ConfirmationTokensPostRequestBodyPaymentMethodDataUsBankAccount()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ConfirmationTokensPostRequestBodyPaymentMethodDataUsBankAccount
      createFromDiscriminatorValue(ParseNode parseNode) {
    return ConfirmationTokensPostRequestBodyPaymentMethodDataUsBankAccount();
  }
