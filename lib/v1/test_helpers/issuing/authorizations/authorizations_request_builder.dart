...
import './authorizations_post_request_body.dart';
...
class AuthorizationsRequestBuilder
  ...
  /// Gets an item from the ApiSdk.v1.test_helpers.issuing.authorizations.item collection
  ...
  AuthorizationsRequestBuilder(
      ...
      : super(
            requestAdapter,
            "{+baseurl}/v1/test_helpers/issuing/authorizations",
            pathParameters);
  ...
  Future<Authorization?> postAsync(AuthorizationsPostRequestBody body,
