...
/// auto generated
class CapturePostRequestBodyPurchaseDetailsFleetReportedBreakdownTax
  ...
  /// Instantiates a new [CapturePostRequestBodyPurchaseDetailsFleetReportedBreakdownTax] and sets the default values.
  CapturePostRequestBodyPurchaseDetailsFleetReportedBreakdownTax()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static CapturePostRequestBodyPurchaseDetailsFleetReportedBreakdownTax
      createFromDiscriminatorValue(ParseNode parseNode) {
    return CapturePostRequestBodyPurchaseDetailsFleetReportedBreakdownTax();
  }
