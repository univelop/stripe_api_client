...
/// auto generated
class CapturePostRequestBodyPurchaseDetailsFlightSegments
  ...
  /// Instantiates a new [CapturePostRequestBodyPurchaseDetailsFlightSegments] and sets the default values.
  CapturePostRequestBodyPurchaseDetailsFlightSegments() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static CapturePostRequestBodyPurchaseDetailsFlightSegments
      createFromDiscriminatorValue(ParseNode parseNode) {
    return CapturePostRequestBodyPurchaseDetailsFlightSegments();
  }
