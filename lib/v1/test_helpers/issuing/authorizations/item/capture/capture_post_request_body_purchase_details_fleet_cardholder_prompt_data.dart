...
/// auto generated
class CapturePostRequestBodyPurchaseDetailsFleetCardholderPromptData
  ...
  /// Instantiates a new [CapturePostRequestBodyPurchaseDetailsFleetCardholderPromptData] and sets the default values.
  CapturePostRequestBodyPurchaseDetailsFleetCardholderPromptData()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static CapturePostRequestBodyPurchaseDetailsFleetCardholderPromptData
      createFromDiscriminatorValue(ParseNode parseNode) {
    return CapturePostRequestBodyPurchaseDetailsFleetCardholderPromptData();
  }
