...
/// auto generated
class FinalizeAmountPostRequestBodyFleetReportedBreakdownTax
  ...
  /// Instantiates a new [FinalizeAmountPostRequestBodyFleetReportedBreakdownTax] and sets the default values.
  FinalizeAmountPostRequestBodyFleetReportedBreakdownTax()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static FinalizeAmountPostRequestBodyFleetReportedBreakdownTax
      createFromDiscriminatorValue(ParseNode parseNode) {
    return FinalizeAmountPostRequestBodyFleetReportedBreakdownTax();
  }
