...
/// auto generated
class FinalizeAmountPostRequestBodyFleetCardholderPromptData
  ...
  /// Instantiates a new [FinalizeAmountPostRequestBodyFleetCardholderPromptData] and sets the default values.
  FinalizeAmountPostRequestBodyFleetCardholderPromptData()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static FinalizeAmountPostRequestBodyFleetCardholderPromptData
      createFromDiscriminatorValue(ParseNode parseNode) {
    return FinalizeAmountPostRequestBodyFleetCardholderPromptData();
  }
