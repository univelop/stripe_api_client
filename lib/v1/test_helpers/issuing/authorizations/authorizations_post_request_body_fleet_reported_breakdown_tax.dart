...
/// auto generated
class AuthorizationsPostRequestBodyFleetReportedBreakdownTax
  ...
  /// Instantiates a new [AuthorizationsPostRequestBodyFleetReportedBreakdownTax] and sets the default values.
  AuthorizationsPostRequestBodyFleetReportedBreakdownTax()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static AuthorizationsPostRequestBodyFleetReportedBreakdownTax
      createFromDiscriminatorValue(ParseNode parseNode) {
    return AuthorizationsPostRequestBodyFleetReportedBreakdownTax();
  }
