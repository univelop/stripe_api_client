...
/// auto generated
class CreateForceCapturePostRequestBodyPurchaseDetailsFleetReportedBreakdownTax
  ...
  /// Instantiates a new [CreateForceCapturePostRequestBodyPurchaseDetailsFleetReportedBreakdownTax] and sets the default values.
  CreateForceCapturePostRequestBodyPurchaseDetailsFleetReportedBreakdownTax()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static CreateForceCapturePostRequestBodyPurchaseDetailsFleetReportedBreakdownTax
      createFromDiscriminatorValue(ParseNode parseNode) {
    return CreateForceCapturePostRequestBodyPurchaseDetailsFleetReportedBreakdownTax();
  }
