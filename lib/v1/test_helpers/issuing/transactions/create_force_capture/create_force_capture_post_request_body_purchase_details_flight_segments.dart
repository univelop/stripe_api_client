...
/// auto generated
class CreateForceCapturePostRequestBodyPurchaseDetailsFlightSegments
  ...
  /// Instantiates a new [CreateForceCapturePostRequestBodyPurchaseDetailsFlightSegments] and sets the default values.
  CreateForceCapturePostRequestBodyPurchaseDetailsFlightSegments()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static CreateForceCapturePostRequestBodyPurchaseDetailsFlightSegments
      createFromDiscriminatorValue(ParseNode parseNode) {
    return CreateForceCapturePostRequestBodyPurchaseDetailsFlightSegments();
  }
