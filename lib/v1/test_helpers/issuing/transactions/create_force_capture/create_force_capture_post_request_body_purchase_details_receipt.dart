...
/// auto generated
class CreateForceCapturePostRequestBodyPurchaseDetailsReceipt
  ...
  /// Instantiates a new [CreateForceCapturePostRequestBodyPurchaseDetailsReceipt] and sets the default values.
  CreateForceCapturePostRequestBodyPurchaseDetailsReceipt()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static CreateForceCapturePostRequestBodyPurchaseDetailsReceipt
      createFromDiscriminatorValue(ParseNode parseNode) {
    return CreateForceCapturePostRequestBodyPurchaseDetailsReceipt();
  }
