...
/// auto generated
class CreateUnlinkedRefundPostRequestBodyPurchaseDetailsReceipt
  ...
  /// Instantiates a new [CreateUnlinkedRefundPostRequestBodyPurchaseDetailsReceipt] and sets the default values.
  CreateUnlinkedRefundPostRequestBodyPurchaseDetailsReceipt()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static CreateUnlinkedRefundPostRequestBodyPurchaseDetailsReceipt
      createFromDiscriminatorValue(ParseNode parseNode) {
    return CreateUnlinkedRefundPostRequestBodyPurchaseDetailsReceipt();
  }
