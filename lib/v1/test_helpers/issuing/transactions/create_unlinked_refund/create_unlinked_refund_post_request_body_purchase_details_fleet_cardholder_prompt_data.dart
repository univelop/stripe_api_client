...
/// auto generated
class CreateUnlinkedRefundPostRequestBodyPurchaseDetailsFleetCardholderPromptData
  ...
  /// Instantiates a new [CreateUnlinkedRefundPostRequestBodyPurchaseDetailsFleetCardholderPromptData] and sets the default values.
  CreateUnlinkedRefundPostRequestBodyPurchaseDetailsFleetCardholderPromptData()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static CreateUnlinkedRefundPostRequestBodyPurchaseDetailsFleetCardholderPromptData
      createFromDiscriminatorValue(ParseNode parseNode) {
    return CreateUnlinkedRefundPostRequestBodyPurchaseDetailsFleetCardholderPromptData();
  }
