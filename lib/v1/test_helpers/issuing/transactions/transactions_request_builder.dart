...
import './create_force_capture/create_force_capture_request_builder.dart';
import './create_unlinked_refund/create_unlinked_refund_request_builder.dart';
...
class TransactionsRequestBuilder
  ...
  ///  The create_force_capture property
  CreateForceCaptureRequestBuilder get createForceCapture {
    return CreateForceCaptureRequestBuilder(pathParameters, requestAdapter);
  }

  ///  The create_unlinked_refund property
  CreateUnlinkedRefundRequestBuilder get createUnlinkedRefund {
    return CreateUnlinkedRefundRequestBuilder(pathParameters, requestAdapter);
  }

  /// Gets an item from the ApiSdk.v1.test_helpers.issuing.transactions.item collection
  ...
  TransactionsRequestBuilder(
      ...
      : super(requestAdapter, "{+baseurl}/v1/test_helpers/issuing/transactions",
            pathParameters);
