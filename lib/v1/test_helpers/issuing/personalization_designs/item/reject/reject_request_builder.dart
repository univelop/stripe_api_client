...
class RejectRequestBuilder extends BaseRequestBuilder<RejectRequestBuilder> {
  ...
  RejectRequestBuilder(
      ...
      : super(
            requestAdapter,
            "{+baseurl}/v1/test_helpers/issuing/personalization_designs/{personalization_design}/reject",
            pathParameters);
  ...
  Future<PersonalizationDesign?> postAsync(RejectPostRequestBody body,
