...
import './post_post_request_body.dart';

/// auto generated
/// Builds and executes requests for operations under \v1\test_helpers\treasury\outbound_transfers\{outbound_transfer}\post
class PostRequestBuilder extends BaseRequestBuilder<PostRequestBuilder> {
  /// Clones the requestbuilder.
  @override
  PostRequestBuilder clone() {
  ...
  ///  [requestAdapter] The request adapter to use to execute the requests.
  PostRequestBuilder.withUrl(String rawUrl, RequestAdapter requestAdapter)
      : super(
            requestAdapter,
            "{+baseurl}/v1/test_helpers/treasury/outbound_transfers/{outbound_transfer}/post",
  ...
  Future<OutboundTransfer?> postAsync(PostPostRequestBody body,
  ...
  ///  [body] The request body
  ///  [requestConfiguration] Configuration for the request such as headers, query parameters, and middleware options.
  RequestInformation toPostRequestInformation(PostPostRequestBody body,
      [void Function(RequestConfiguration<DefaultQueryParameters>)?
