...
/// auto generated
class ReceivedDebitsPostRequestBodyInitiatingPaymentMethodDetailsUsBankAccount
  ...
  /// Instantiates a new [ReceivedDebitsPostRequestBodyInitiatingPaymentMethodDetailsUsBankAccount] and sets the default values.
  ReceivedDebitsPostRequestBodyInitiatingPaymentMethodDetailsUsBankAccount()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ReceivedDebitsPostRequestBodyInitiatingPaymentMethodDetailsUsBankAccount
      createFromDiscriminatorValue(ParseNode parseNode) {
    return ReceivedDebitsPostRequestBodyInitiatingPaymentMethodDetailsUsBankAccount();
  }
