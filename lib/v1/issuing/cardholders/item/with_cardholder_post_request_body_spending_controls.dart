...
import './with_cardholder_post_request_body_spending_controls_allowed_categories.dart';
import './with_cardholder_post_request_body_spending_controls_blocked_categories.dart';
import './with_cardholder_post_request_body_spending_controls_spending_limits.dart';
...
class WithCardholderPostRequestBodySpendingControls
  ...
  Iterable<WithCardholderPostRequestBodySpendingControlsAllowedCategories>?
      allowedCategories;
  ...
  Iterable<WithCardholderPostRequestBodySpendingControlsBlockedCategories>?
      blockedCategories;
  ...
  Iterable<WithCardholderPostRequestBodySpendingControlsSpendingLimits>?
      spendingLimits;

  ///  The spending_limits_currency property
  String? spendingLimitsCurrency;

  /// Instantiates a new [WithCardholderPostRequestBodySpendingControls] and sets the default values.
  WithCardholderPostRequestBodySpendingControls() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithCardholderPostRequestBodySpendingControls
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithCardholderPostRequestBodySpendingControls();
  }
  ...
  Map<String, void Function(ParseNode)> getFieldDeserializers() {
    ...
    deserializerMap['allowed_categories'] = (node) => allowedCategories =
        node.getCollectionOfEnumValues<
                WithCardholderPostRequestBodySpendingControlsAllowedCategories>(
            (stringValue) =>
                WithCardholderPostRequestBodySpendingControlsAllowedCategories
                    .values
    ...
    deserializerMap['blocked_categories'] = (node) => blockedCategories =
        node.getCollectionOfEnumValues<
                WithCardholderPostRequestBodySpendingControlsBlockedCategories>(
            (stringValue) =>
                WithCardholderPostRequestBodySpendingControlsBlockedCategories
                    .values
                    .where((enumVal) => enumVal.value == stringValue)
    ...
    deserializerMap['spending_limits'] = (node) => spendingLimits =
        node.getCollectionOfObjectValues<
                WithCardholderPostRequestBodySpendingControlsSpendingLimits>(
            WithCardholderPostRequestBodySpendingControlsSpendingLimits
