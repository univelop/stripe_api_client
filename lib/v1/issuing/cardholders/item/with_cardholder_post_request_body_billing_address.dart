...
/// auto generated
class WithCardholderPostRequestBodyBillingAddress
  ...
  /// Instantiates a new [WithCardholderPostRequestBodyBillingAddress] and sets the default values.
  WithCardholderPostRequestBodyBillingAddress() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithCardholderPostRequestBodyBillingAddress
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithCardholderPostRequestBodyBillingAddress();
  }
