...
/// auto generated
class CardholdersPostRequestBodyBillingAddress
  ...
  /// Instantiates a new [CardholdersPostRequestBodyBillingAddress] and sets the default values.
  CardholdersPostRequestBodyBillingAddress() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static CardholdersPostRequestBodyBillingAddress createFromDiscriminatorValue(
      ParseNode parseNode) {
    return CardholdersPostRequestBodyBillingAddress();
  }
