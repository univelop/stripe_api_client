...
class TransactionsRequestBuilder
  ...
  /// Gets an item from the ApiSdk.v1.issuing.transactions.item collection
  ...
  TransactionsRequestBuilder(
      ...
      : super(
            requestAdapter,
            "{+baseurl}/v1/issuing/transactions{?card*,cardholder*,created*,ending_before*,expand*,limit*,starting_after*,type*}",
            pathParameters);
