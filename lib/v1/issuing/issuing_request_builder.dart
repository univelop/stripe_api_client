...
import './cardholders/cardholders_request_builder.dart';
...
import './physical_bundles/physical_bundles_request_builder.dart';
...
class IssuingRequestBuilder extends BaseRequestBuilder<IssuingRequestBuilder> {
  ...
  ///  The cardholders property
  CardholdersRequestBuilder get cardholders {
  ...
  ///  The physical_bundles property
  PhysicalBundlesRequestBuilder get physicalBundles {
  ...
  IssuingRequestBuilder(
      ...
      : super(requestAdapter, "{+baseurl}/v1/issuing", pathParameters);

  /// Instantiates a new [IssuingRequestBuilder] and sets the default values.
  ///  [rawUrl] The raw URL to use for the request builder.
  ///  [requestAdapter] The request adapter to use to execute the requests.
  IssuingRequestBuilder.withUrl(String rawUrl, RequestAdapter requestAdapter)
      : super(requestAdapter, "{+baseurl}/v1/issuing",
