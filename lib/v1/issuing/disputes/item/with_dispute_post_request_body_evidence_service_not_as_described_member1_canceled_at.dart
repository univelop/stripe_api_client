...
class WithDisputePostRequestBodyEvidenceServiceNotAsDescribedMember1CanceledAt
    implements Parsable {
  ...
  static WithDisputePostRequestBodyEvidenceServiceNotAsDescribedMember1CanceledAt
