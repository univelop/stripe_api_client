...
class DisputesPostRequestBodyEvidenceServiceNotAsDescribedMember1CanceledAt
    implements Parsable {
  ...
  static DisputesPostRequestBodyEvidenceServiceNotAsDescribedMember1CanceledAt
