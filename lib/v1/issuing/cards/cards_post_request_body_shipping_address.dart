...
/// auto generated
class CardsPostRequestBodyShippingAddress
  ...
  /// Instantiates a new [CardsPostRequestBodyShippingAddress] and sets the default values.
  CardsPostRequestBodyShippingAddress() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static CardsPostRequestBodyShippingAddress createFromDiscriminatorValue(
      ParseNode parseNode) {
    return CardsPostRequestBodyShippingAddress();
  }
