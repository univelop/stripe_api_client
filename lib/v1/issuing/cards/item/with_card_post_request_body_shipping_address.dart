...
/// auto generated
class WithCardPostRequestBodyShippingAddress
  ...
  /// Instantiates a new [WithCardPostRequestBodyShippingAddress] and sets the default values.
  WithCardPostRequestBodyShippingAddress() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithCardPostRequestBodyShippingAddress createFromDiscriminatorValue(
      ParseNode parseNode) {
    return WithCardPostRequestBodyShippingAddress();
  }
