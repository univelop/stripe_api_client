...
/// auto generated
class SetupIntentsPostRequestBodyPaymentMethodDataPayto
  ...
  /// Instantiates a new [SetupIntentsPostRequestBodyPaymentMethodDataPayto] and sets the default values.
  SetupIntentsPostRequestBodyPaymentMethodDataPayto() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static SetupIntentsPostRequestBodyPaymentMethodDataPayto
      createFromDiscriminatorValue(ParseNode parseNode) {
    return SetupIntentsPostRequestBodyPaymentMethodDataPayto();
  }
