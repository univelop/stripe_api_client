...
/// auto generated
class SetupIntentsPostRequestBodyPaymentMethodDataAcssDebit
  ...
  /// Instantiates a new [SetupIntentsPostRequestBodyPaymentMethodDataAcssDebit] and sets the default values.
  SetupIntentsPostRequestBodyPaymentMethodDataAcssDebit() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static SetupIntentsPostRequestBodyPaymentMethodDataAcssDebit
      createFromDiscriminatorValue(ParseNode parseNode) {
    return SetupIntentsPostRequestBodyPaymentMethodDataAcssDebit();
  }
