...
import './with_intent_post_request_body_payment_method_data_us_bank_account_account_holder_type.dart';
import './with_intent_post_request_body_payment_method_data_us_bank_account_account_type.dart';

/// auto generated
class WithIntentPostRequestBodyPaymentMethodDataUsBankAccount
    implements AdditionalDataHolder, Parsable {
  ///  The account_holder_type property
  WithIntentPostRequestBodyPaymentMethodDataUsBankAccountAccountHolderType?
      accountHolderType;
  ...
  WithIntentPostRequestBodyPaymentMethodDataUsBankAccountAccountType?
      accountType;
  ...
  /// Instantiates a new [WithIntentPostRequestBodyPaymentMethodDataUsBankAccount] and sets the default values.
  WithIntentPostRequestBodyPaymentMethodDataUsBankAccount()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithIntentPostRequestBodyPaymentMethodDataUsBankAccount
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithIntentPostRequestBodyPaymentMethodDataUsBankAccount();
  }
