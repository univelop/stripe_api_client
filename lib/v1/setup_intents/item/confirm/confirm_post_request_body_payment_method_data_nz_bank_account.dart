...
/// auto generated
class ConfirmPostRequestBodyPaymentMethodDataNzBankAccount
  ...
  /// Instantiates a new [ConfirmPostRequestBodyPaymentMethodDataNzBankAccount] and sets the default values.
  ConfirmPostRequestBodyPaymentMethodDataNzBankAccount() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ConfirmPostRequestBodyPaymentMethodDataNzBankAccount
      createFromDiscriminatorValue(ParseNode parseNode) {
    return ConfirmPostRequestBodyPaymentMethodDataNzBankAccount();
  }
