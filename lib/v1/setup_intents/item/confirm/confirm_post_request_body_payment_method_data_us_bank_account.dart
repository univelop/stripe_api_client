...
import './confirm_post_request_body_payment_method_data_us_bank_account_account_holder_type.dart';
import './confirm_post_request_body_payment_method_data_us_bank_account_account_type.dart';

/// auto generated
class ConfirmPostRequestBodyPaymentMethodDataUsBankAccount
    implements AdditionalDataHolder, Parsable {
  ///  The account_holder_type property
  ConfirmPostRequestBodyPaymentMethodDataUsBankAccountAccountHolderType?
      accountHolderType;
  ...
  ConfirmPostRequestBodyPaymentMethodDataUsBankAccountAccountType? accountType;
  ...
  /// Instantiates a new [ConfirmPostRequestBodyPaymentMethodDataUsBankAccount] and sets the default values.
  ConfirmPostRequestBodyPaymentMethodDataUsBankAccount() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ConfirmPostRequestBodyPaymentMethodDataUsBankAccount
      createFromDiscriminatorValue(ParseNode parseNode) {
    return ConfirmPostRequestBodyPaymentMethodDataUsBankAccount();
  }
  ...
  Map<String, void Function(ParseNode)> getFieldDeserializers() {
    ...
    deserializerMap['account_type'] = (node) => accountType = node.getEnumValue<
            ConfirmPostRequestBodyPaymentMethodDataUsBankAccountAccountType>(
        (stringValue) =>
            ConfirmPostRequestBodyPaymentMethodDataUsBankAccountAccountType
                .values
                .where((enumVal) => enumVal.value == stringValue)
