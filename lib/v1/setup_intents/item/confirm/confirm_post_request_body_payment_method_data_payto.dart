...
/// auto generated
class ConfirmPostRequestBodyPaymentMethodDataPayto
  ...
  /// Instantiates a new [ConfirmPostRequestBodyPaymentMethodDataPayto] and sets the default values.
  ConfirmPostRequestBodyPaymentMethodDataPayto() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ConfirmPostRequestBodyPaymentMethodDataPayto
      createFromDiscriminatorValue(ParseNode parseNode) {
    return ConfirmPostRequestBodyPaymentMethodDataPayto();
  }
