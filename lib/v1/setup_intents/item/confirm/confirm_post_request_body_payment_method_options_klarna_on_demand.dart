...
import './confirm_post_request_body_payment_method_options_klarna_on_demand_purchase_interval.dart';

/// auto generated
class ConfirmPostRequestBodyPaymentMethodOptionsKlarnaOnDemand
  ...
  ConfirmPostRequestBodyPaymentMethodOptionsKlarnaOnDemandPurchaseInterval?
      purchaseInterval;

  ///  The purchase_interval_count property
  int? purchaseIntervalCount;

  /// Instantiates a new [ConfirmPostRequestBodyPaymentMethodOptionsKlarnaOnDemand] and sets the default values.
  ConfirmPostRequestBodyPaymentMethodOptionsKlarnaOnDemand()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ConfirmPostRequestBodyPaymentMethodOptionsKlarnaOnDemand
      createFromDiscriminatorValue(ParseNode parseNode) {
    return ConfirmPostRequestBodyPaymentMethodOptionsKlarnaOnDemand();
  }
