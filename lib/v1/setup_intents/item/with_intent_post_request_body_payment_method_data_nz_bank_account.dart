...
/// auto generated
class WithIntentPostRequestBodyPaymentMethodDataNzBankAccount
  ...
  /// Instantiates a new [WithIntentPostRequestBodyPaymentMethodDataNzBankAccount] and sets the default values.
  WithIntentPostRequestBodyPaymentMethodDataNzBankAccount()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithIntentPostRequestBodyPaymentMethodDataNzBankAccount
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithIntentPostRequestBodyPaymentMethodDataNzBankAccount();
  }
