...
import './with_intent_post_request_body_payment_method_options_card_three_d_secure_ares_trans_status.dart';
import './with_intent_post_request_body_payment_method_options_card_three_d_secure_electronic_commerce_indicator.dart';
import './with_intent_post_request_body_payment_method_options_card_three_d_secure_network_options.dart';
import './with_intent_post_request_body_payment_method_options_card_three_d_secure_version.dart';

/// auto generated
class WithIntentPostRequestBodyPaymentMethodOptionsCardThreeDSecure
  ...
  WithIntentPostRequestBodyPaymentMethodOptionsCardThreeDSecureAresTransStatus?
      aresTransStatus;
  ...
  WithIntentPostRequestBodyPaymentMethodOptionsCardThreeDSecureElectronicCommerceIndicator?
  ...
  WithIntentPostRequestBodyPaymentMethodOptionsCardThreeDSecureVersion? version;

  /// Instantiates a new [WithIntentPostRequestBodyPaymentMethodOptionsCardThreeDSecure] and sets the default values.
  WithIntentPostRequestBodyPaymentMethodOptionsCardThreeDSecure()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithIntentPostRequestBodyPaymentMethodOptionsCardThreeDSecure
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithIntentPostRequestBodyPaymentMethodOptionsCardThreeDSecure();
  }
  ...
  Map<String, void Function(ParseNode)> getFieldDeserializers() {
    ...
    deserializerMap['version'] = (node) => version = node.getEnumValue<
            WithIntentPostRequestBodyPaymentMethodOptionsCardThreeDSecureVersion>(
        (stringValue) =>
            WithIntentPostRequestBodyPaymentMethodOptionsCardThreeDSecureVersion
                .values
                .where((enumVal) => enumVal.value == stringValue)
