...
import './setup_intents_post_request_body_payment_method_options_klarna_on_demand_purchase_interval.dart';

/// auto generated
class SetupIntentsPostRequestBodyPaymentMethodOptionsKlarnaOnDemand
  ...
  SetupIntentsPostRequestBodyPaymentMethodOptionsKlarnaOnDemandPurchaseInterval?
      purchaseInterval;

  ///  The purchase_interval_count property
  int? purchaseIntervalCount;

  /// Instantiates a new [SetupIntentsPostRequestBodyPaymentMethodOptionsKlarnaOnDemand] and sets the default values.
  SetupIntentsPostRequestBodyPaymentMethodOptionsKlarnaOnDemand()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static SetupIntentsPostRequestBodyPaymentMethodOptionsKlarnaOnDemand
      createFromDiscriminatorValue(ParseNode parseNode) {
    return SetupIntentsPostRequestBodyPaymentMethodOptionsKlarnaOnDemand();
  }
