...
/// auto generated
class SetupIntentsPostRequestBodyPaymentMethodDataAuBecsDebit
  ...
  /// Instantiates a new [SetupIntentsPostRequestBodyPaymentMethodDataAuBecsDebit] and sets the default values.
  SetupIntentsPostRequestBodyPaymentMethodDataAuBecsDebit()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static SetupIntentsPostRequestBodyPaymentMethodDataAuBecsDebit
      createFromDiscriminatorValue(ParseNode parseNode) {
    return SetupIntentsPostRequestBodyPaymentMethodDataAuBecsDebit();
  }
