...
/// auto generated
class SetupIntentsPostRequestBodyPaymentMethodDataBillingDetailsAddressMember1
  ...
  /// Instantiates a new [SetupIntentsPostRequestBodyPaymentMethodDataBillingDetailsAddressMember1] and sets the default values.
  SetupIntentsPostRequestBodyPaymentMethodDataBillingDetailsAddressMember1()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static SetupIntentsPostRequestBodyPaymentMethodDataBillingDetailsAddressMember1
      createFromDiscriminatorValue(ParseNode parseNode) {
    return SetupIntentsPostRequestBodyPaymentMethodDataBillingDetailsAddressMember1();
  }
