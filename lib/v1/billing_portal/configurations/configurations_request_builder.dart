...
class ConfigurationsRequestBuilder
  ...
  /// Gets an item from the ApiSdk.v1.billing_portal.configurations.item collection
  ...
  ConfigurationsRequestBuilder(
      ...
      : super(
            requestAdapter,
            "{+baseurl}/v1/billing_portal/configurations{?active*,ending_before*,expand*,is_default*,limit*,starting_after*}",
            pathParameters);
