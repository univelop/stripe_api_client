...
class SubscriptionSchedulesPostRequestBodyPhasesInvoiceSettingsAccountTaxIds
    implements Parsable {
  ...
  String?
      subscriptionSchedulesPostRequestBodyPhasesInvoiceSettingsAccountTaxIdsString;

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static SubscriptionSchedulesPostRequestBodyPhasesInvoiceSettingsAccountTaxIds
      createFromDiscriminatorValue(ParseNode parseNode) {
    var result =
        SubscriptionSchedulesPostRequestBodyPhasesInvoiceSettingsAccountTaxIds();
    if (parseNode.getStringValue() != null) {
      result.subscriptionSchedulesPostRequestBodyPhasesInvoiceSettingsAccountTaxIdsString =
  ...
  void serialize(SerializationWriter writer) {
    if (subscriptionSchedulesPostRequestBodyPhasesInvoiceSettingsAccountTaxIdsString !=
        null) {
