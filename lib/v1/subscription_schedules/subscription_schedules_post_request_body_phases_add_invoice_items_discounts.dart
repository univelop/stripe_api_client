...
/// auto generated
class SubscriptionSchedulesPostRequestBodyPhasesAddInvoiceItemsDiscounts
  ...
  /// Instantiates a new [SubscriptionSchedulesPostRequestBodyPhasesAddInvoiceItemsDiscounts] and sets the default values.
  SubscriptionSchedulesPostRequestBodyPhasesAddInvoiceItemsDiscounts()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static SubscriptionSchedulesPostRequestBodyPhasesAddInvoiceItemsDiscounts
      createFromDiscriminatorValue(ParseNode parseNode) {
    return SubscriptionSchedulesPostRequestBodyPhasesAddInvoiceItemsDiscounts();
  }
