...
/// auto generated
class SubscriptionSchedulesPostRequestBodyPhasesTransferData
  ...
  /// Instantiates a new [SubscriptionSchedulesPostRequestBodyPhasesTransferData] and sets the default values.
  SubscriptionSchedulesPostRequestBodyPhasesTransferData()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static SubscriptionSchedulesPostRequestBodyPhasesTransferData
      createFromDiscriminatorValue(ParseNode parseNode) {
    return SubscriptionSchedulesPostRequestBodyPhasesTransferData();
  }
