...
/// auto generated
class WithSchedulePostRequestBodyPhasesAddInvoiceItemsDiscounts
  ...
  /// Instantiates a new [WithSchedulePostRequestBodyPhasesAddInvoiceItemsDiscounts] and sets the default values.
  WithSchedulePostRequestBodyPhasesAddInvoiceItemsDiscounts()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithSchedulePostRequestBodyPhasesAddInvoiceItemsDiscounts
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithSchedulePostRequestBodyPhasesAddInvoiceItemsDiscounts();
  }
