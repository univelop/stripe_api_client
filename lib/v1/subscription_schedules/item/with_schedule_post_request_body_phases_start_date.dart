...
class WithSchedulePostRequestBodyPhasesStartDate implements Parsable {
  ...
  static WithSchedulePostRequestBodyPhasesStartDate
      createFromDiscriminatorValue(ParseNode parseNode) {
    var result = WithSchedulePostRequestBodyPhasesStartDate();
