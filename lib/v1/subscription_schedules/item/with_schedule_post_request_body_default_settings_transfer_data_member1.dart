...
/// auto generated
class WithSchedulePostRequestBodyDefaultSettingsTransferDataMember1
  ...
  /// Instantiates a new [WithSchedulePostRequestBodyDefaultSettingsTransferDataMember1] and sets the default values.
  WithSchedulePostRequestBodyDefaultSettingsTransferDataMember1()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithSchedulePostRequestBodyDefaultSettingsTransferDataMember1
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithSchedulePostRequestBodyDefaultSettingsTransferDataMember1();
  }
