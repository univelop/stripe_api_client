...
class WithSchedulePostRequestBodyPhasesDefaultTaxRates implements Parsable {
  ///  Composed type representation for type [Iterable<String>?]
  Iterable<String>? string_;

  ///  Composed type representation for type [String?]
  String? withSchedulePostRequestBodyPhasesDefaultTaxRatesString;

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithSchedulePostRequestBodyPhasesDefaultTaxRates
      createFromDiscriminatorValue(ParseNode parseNode) {
    var result = WithSchedulePostRequestBodyPhasesDefaultTaxRates();
    if (parseNode.getStringValue() != null) {
      result.withSchedulePostRequestBodyPhasesDefaultTaxRatesString =
  ...
  void serialize(SerializationWriter writer) {
    if (withSchedulePostRequestBodyPhasesDefaultTaxRatesString != null) {
      writer.writeStringValue(
          null, withSchedulePostRequestBodyPhasesDefaultTaxRatesString);
