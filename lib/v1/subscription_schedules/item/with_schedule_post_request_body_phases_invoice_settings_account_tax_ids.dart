...
class WithSchedulePostRequestBodyPhasesInvoiceSettingsAccountTaxIds
    implements Parsable {
  ///  Composed type representation for type [Iterable<String>?]
  Iterable<String>? string_;

  ///  Composed type representation for type [String?]
  String? withSchedulePostRequestBodyPhasesInvoiceSettingsAccountTaxIdsString;

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithSchedulePostRequestBodyPhasesInvoiceSettingsAccountTaxIds
      createFromDiscriminatorValue(ParseNode parseNode) {
    var result =
        WithSchedulePostRequestBodyPhasesInvoiceSettingsAccountTaxIds();
    if (parseNode.getStringValue() != null) {
      result.withSchedulePostRequestBodyPhasesInvoiceSettingsAccountTaxIdsString =
  ...
  void serialize(SerializationWriter writer) {
    if (withSchedulePostRequestBodyPhasesInvoiceSettingsAccountTaxIdsString !=
        null) {
      writer.writeStringValue(null,
          withSchedulePostRequestBodyPhasesInvoiceSettingsAccountTaxIdsString);
