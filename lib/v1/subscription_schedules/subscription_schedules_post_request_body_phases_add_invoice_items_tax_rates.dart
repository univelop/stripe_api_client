...
class SubscriptionSchedulesPostRequestBodyPhasesAddInvoiceItemsTaxRates
    implements Parsable {
  ...
  String?
      subscriptionSchedulesPostRequestBodyPhasesAddInvoiceItemsTaxRatesString;

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static SubscriptionSchedulesPostRequestBodyPhasesAddInvoiceItemsTaxRates
      createFromDiscriminatorValue(ParseNode parseNode) {
    var result =
        SubscriptionSchedulesPostRequestBodyPhasesAddInvoiceItemsTaxRates();
    if (parseNode.getStringValue() != null) {
      result.subscriptionSchedulesPostRequestBodyPhasesAddInvoiceItemsTaxRatesString =
  ...
  void serialize(SerializationWriter writer) {
    if (subscriptionSchedulesPostRequestBodyPhasesAddInvoiceItemsTaxRatesString !=
        null) {
