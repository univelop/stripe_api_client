...
/// auto generated
class ReportPaymentPostRequestBodyPaymentMethodDetailsBillingDetailsAddress
  ...
  /// Instantiates a new [ReportPaymentPostRequestBodyPaymentMethodDetailsBillingDetailsAddress] and sets the default values.
  ReportPaymentPostRequestBodyPaymentMethodDetailsBillingDetailsAddress()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ReportPaymentPostRequestBodyPaymentMethodDetailsBillingDetailsAddress
      createFromDiscriminatorValue(ParseNode parseNode) {
    return ReportPaymentPostRequestBodyPaymentMethodDetailsBillingDetailsAddress();
  }
