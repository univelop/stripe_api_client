...
/// auto generated
class ReportPaymentPostRequestBodyShippingDetailsAddress
  ...
  /// Instantiates a new [ReportPaymentPostRequestBodyShippingDetailsAddress] and sets the default values.
  ReportPaymentPostRequestBodyShippingDetailsAddress() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ReportPaymentPostRequestBodyShippingDetailsAddress
      createFromDiscriminatorValue(ParseNode parseNode) {
    return ReportPaymentPostRequestBodyShippingDetailsAddress();
  }
