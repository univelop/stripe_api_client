...
/// auto generated
class ReportPaymentAttemptPostRequestBodyPaymentMethodDetailsBillingDetailsAddress
  ...
  /// Instantiates a new [ReportPaymentAttemptPostRequestBodyPaymentMethodDetailsBillingDetailsAddress] and sets the default values.
  ReportPaymentAttemptPostRequestBodyPaymentMethodDetailsBillingDetailsAddress()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ReportPaymentAttemptPostRequestBodyPaymentMethodDetailsBillingDetailsAddress
      createFromDiscriminatorValue(ParseNode parseNode) {
    return ReportPaymentAttemptPostRequestBodyPaymentMethodDetailsBillingDetailsAddress();
  }
