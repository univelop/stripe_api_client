...
/// auto generated
class ReportPaymentAttemptPostRequestBodyShippingDetailsAddress
  ...
  /// Instantiates a new [ReportPaymentAttemptPostRequestBodyShippingDetailsAddress] and sets the default values.
  ReportPaymentAttemptPostRequestBodyShippingDetailsAddress()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ReportPaymentAttemptPostRequestBodyShippingDetailsAddress
      createFromDiscriminatorValue(ParseNode parseNode) {
    return ReportPaymentAttemptPostRequestBodyShippingDetailsAddress();
  }
