...
/// auto generated
class ReportPaymentAttemptInformationalPostRequestBodyShippingDetailsMember1Address
  ...
  /// Instantiates a new [ReportPaymentAttemptInformationalPostRequestBodyShippingDetailsMember1Address] and sets the default values.
  ReportPaymentAttemptInformationalPostRequestBodyShippingDetailsMember1Address()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ReportPaymentAttemptInformationalPostRequestBodyShippingDetailsMember1Address
      createFromDiscriminatorValue(ParseNode parseNode) {
    return ReportPaymentAttemptInformationalPostRequestBodyShippingDetailsMember1Address();
  }
