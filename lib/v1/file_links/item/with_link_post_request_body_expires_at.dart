...
class WithLinkPostRequestBodyExpiresAt implements Parsable {
  ...
  static WithLinkPostRequestBodyExpiresAt createFromDiscriminatorValue(
      ParseNode parseNode) {
    var result = WithLinkPostRequestBodyExpiresAt();
