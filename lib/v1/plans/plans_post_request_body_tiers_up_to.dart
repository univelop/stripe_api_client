...
class PlansPostRequestBodyTiersUpTo implements Parsable {
  ...
  static PlansPostRequestBodyTiersUpTo createFromDiscriminatorValue(
      ParseNode parseNode) {
    var result = PlansPostRequestBodyTiersUpTo();
