...
class WithInvoiceitemPostRequestBodyTaxRates implements Parsable {
  ///  Composed type representation for type [Iterable<String>?]
  Iterable<String>? string_;

  ///  Composed type representation for type [String?]
  String? withInvoiceitemPostRequestBodyTaxRatesString;

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithInvoiceitemPostRequestBodyTaxRates createFromDiscriminatorValue(
      ParseNode parseNode) {
    var result = WithInvoiceitemPostRequestBodyTaxRates();
    if (parseNode.getStringValue() != null) {
      result.withInvoiceitemPostRequestBodyTaxRatesString =
  ...
  void serialize(SerializationWriter writer) {
    if (withInvoiceitemPostRequestBodyTaxRatesString != null) {
      writer.writeStringValue(
          null, withInvoiceitemPostRequestBodyTaxRatesString);
