...
class PricesPostRequestBodyTiersUpTo implements Parsable {
  ...
  static PricesPostRequestBodyTiersUpTo createFromDiscriminatorValue(
      ParseNode parseNode) {
    var result = PricesPostRequestBodyTiersUpTo();
