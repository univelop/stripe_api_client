...
import './dispute_post_request_body_evidence_enhanced_evidence.dart';

/// auto generated
/// Evidence to upload, to respond to a dispute. Updating any field in the hash will submit all fields in the hash for review. The combined character count of all fields is limited to 150,000.
class DisputePostRequestBodyEvidence implements AdditionalDataHolder, Parsable {
  ...
  DisputePostRequestBodyEvidenceEnhancedEvidence? enhancedEvidence;
  ...
  /// Instantiates a new [DisputePostRequestBodyEvidence] and sets the default values.
  DisputePostRequestBodyEvidence() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static DisputePostRequestBodyEvidence createFromDiscriminatorValue(
      ParseNode parseNode) {
    return DisputePostRequestBodyEvidence();
  }
  ...
  Map<String, void Function(ParseNode)> getFieldDeserializers() {
    ...
    deserializerMap['enhanced_evidence'] = (node) => enhancedEvidence =
        node.getObjectValue<DisputePostRequestBodyEvidenceEnhancedEvidence>(
            DisputePostRequestBodyEvidenceEnhancedEvidence
  ...
  void serialize(SerializationWriter writer) {
    ...
    writer.writeObjectValue<DisputePostRequestBodyEvidenceEnhancedEvidence>(
