...
/// auto generated
class WithChargePostRequestBodyShippingAddress
  ...
  /// Instantiates a new [WithChargePostRequestBodyShippingAddress] and sets the default values.
  WithChargePostRequestBodyShippingAddress() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithChargePostRequestBodyShippingAddress createFromDiscriminatorValue(
      ParseNode parseNode) {
    return WithChargePostRequestBodyShippingAddress();
  }
