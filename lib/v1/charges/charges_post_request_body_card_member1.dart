...
import './charges_post_request_body_card_member1_metadata.dart';
import './charges_post_request_body_card_member1_object.dart';

/// auto generated
class ChargesPostRequestBodyCardMember1
  ...
  ChargesPostRequestBodyCardMember1Metadata? metadata;
  ...
  ///  The object property
  ChargesPostRequestBodyCardMember1Object? object;

  /// Instantiates a new [ChargesPostRequestBodyCardMember1] and sets the default values.
  ChargesPostRequestBodyCardMember1() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ChargesPostRequestBodyCardMember1 createFromDiscriminatorValue(
      ParseNode parseNode) {
    return ChargesPostRequestBodyCardMember1();
  }
  ...
  Map<String, void Function(ParseNode)> getFieldDeserializers() {
    ...
    deserializerMap['metadata'] = (node) => metadata = node.getObjectValue<
            ChargesPostRequestBodyCardMember1Metadata>(
        ChargesPostRequestBodyCardMember1Metadata.createFromDiscriminatorValue);
    deserializerMap['name'] = (node) => name = node.getStringValue();
    deserializerMap['number'] = (node) => number = node.getStringValue();
    deserializerMap['object'] = (node) => object =
        node.getEnumValue<ChargesPostRequestBodyCardMember1Object>(
            (stringValue) => ChargesPostRequestBodyCardMember1Object.values
  ...
  void serialize(SerializationWriter writer) {
    ...
    writer.writeObjectValue<ChargesPostRequestBodyCardMember1Metadata>(
        'metadata', metadata);
    writer.writeStringValue('name', name);
    writer.writeStringValue('number', number);
    writer.writeEnumValue<ChargesPostRequestBodyCardMember1Object>(
