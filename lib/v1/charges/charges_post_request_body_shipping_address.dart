...
/// auto generated
class ChargesPostRequestBodyShippingAddress
  ...
  /// Instantiates a new [ChargesPostRequestBodyShippingAddress] and sets the default values.
  ChargesPostRequestBodyShippingAddress() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ChargesPostRequestBodyShippingAddress createFromDiscriminatorValue(
      ParseNode parseNode) {
    return ChargesPostRequestBodyShippingAddress();
  }
