...
class WithPaymentLinkPostRequestBodyInvoiceCreationInvoiceDataAccountTaxIds
    implements Parsable {
  ...
  String?
      withPaymentLinkPostRequestBodyInvoiceCreationInvoiceDataAccountTaxIdsString;

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithPaymentLinkPostRequestBodyInvoiceCreationInvoiceDataAccountTaxIds
      createFromDiscriminatorValue(ParseNode parseNode) {
    var result =
        WithPaymentLinkPostRequestBodyInvoiceCreationInvoiceDataAccountTaxIds();
    if (parseNode.getStringValue() != null) {
      result.withPaymentLinkPostRequestBodyInvoiceCreationInvoiceDataAccountTaxIdsString =
  ...
  void serialize(SerializationWriter writer) {
    if (withPaymentLinkPostRequestBodyInvoiceCreationInvoiceDataAccountTaxIdsString !=
        null) {
