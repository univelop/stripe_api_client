...
/// auto generated
class PaymentLinksPostRequestBodyCustomFieldsText
  ...
  /// Instantiates a new [PaymentLinksPostRequestBodyCustomFieldsText] and sets the default values.
  PaymentLinksPostRequestBodyCustomFieldsText() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PaymentLinksPostRequestBodyCustomFieldsText
      createFromDiscriminatorValue(ParseNode parseNode) {
    return PaymentLinksPostRequestBodyCustomFieldsText();
  }
