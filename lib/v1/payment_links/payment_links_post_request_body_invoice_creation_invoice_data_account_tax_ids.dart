...
class PaymentLinksPostRequestBodyInvoiceCreationInvoiceDataAccountTaxIds
    implements Parsable {
  ///  Composed type representation for type [String?]
  String?
      paymentLinksPostRequestBodyInvoiceCreationInvoiceDataAccountTaxIdsString;
  ...
  static PaymentLinksPostRequestBodyInvoiceCreationInvoiceDataAccountTaxIds
      createFromDiscriminatorValue(ParseNode parseNode) {
    var result =
        PaymentLinksPostRequestBodyInvoiceCreationInvoiceDataAccountTaxIds();
    if (parseNode.getStringValue() != null) {
      result.paymentLinksPostRequestBodyInvoiceCreationInvoiceDataAccountTaxIdsString =
  ...
  void serialize(SerializationWriter writer) {
    if (paymentLinksPostRequestBodyInvoiceCreationInvoiceDataAccountTaxIdsString !=
        null) {
