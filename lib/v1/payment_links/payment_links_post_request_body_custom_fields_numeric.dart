...
/// auto generated
class PaymentLinksPostRequestBodyCustomFieldsNumeric
  ...
  /// Instantiates a new [PaymentLinksPostRequestBodyCustomFieldsNumeric] and sets the default values.
  PaymentLinksPostRequestBodyCustomFieldsNumeric() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PaymentLinksPostRequestBodyCustomFieldsNumeric
      createFromDiscriminatorValue(ParseNode parseNode) {
    return PaymentLinksPostRequestBodyCustomFieldsNumeric();
  }
