...
/// auto generated
class SessionsPostRequestBodyCustomFieldsNumeric
  ...
  /// Instantiates a new [SessionsPostRequestBodyCustomFieldsNumeric] and sets the default values.
  SessionsPostRequestBodyCustomFieldsNumeric() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static SessionsPostRequestBodyCustomFieldsNumeric
      createFromDiscriminatorValue(ParseNode parseNode) {
    return SessionsPostRequestBodyCustomFieldsNumeric();
  }
