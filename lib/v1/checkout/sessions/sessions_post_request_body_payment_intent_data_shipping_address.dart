...
/// auto generated
class SessionsPostRequestBodyPaymentIntentDataShippingAddress
  ...
  /// Instantiates a new [SessionsPostRequestBodyPaymentIntentDataShippingAddress] and sets the default values.
  SessionsPostRequestBodyPaymentIntentDataShippingAddress()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static SessionsPostRequestBodyPaymentIntentDataShippingAddress
      createFromDiscriminatorValue(ParseNode parseNode) {
    return SessionsPostRequestBodyPaymentIntentDataShippingAddress();
  }
