...
import './with_session_post_request_body_line_items_price_data_product_data_metadata.dart';

/// auto generated
class WithSessionPostRequestBodyLineItemsPriceDataProductData
  ...
  WithSessionPostRequestBodyLineItemsPriceDataProductDataMetadata? metadata;
  ...
  /// Instantiates a new [WithSessionPostRequestBodyLineItemsPriceDataProductData] and sets the default values.
  WithSessionPostRequestBodyLineItemsPriceDataProductData()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithSessionPostRequestBodyLineItemsPriceDataProductData
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithSessionPostRequestBodyLineItemsPriceDataProductData();
  }
  ...
  Map<String, void Function(ParseNode)> getFieldDeserializers() {
    ...
    deserializerMap['metadata'] = (node) => metadata = node.getObjectValue<
            WithSessionPostRequestBodyLineItemsPriceDataProductDataMetadata>(
        WithSessionPostRequestBodyLineItemsPriceDataProductDataMetadata
