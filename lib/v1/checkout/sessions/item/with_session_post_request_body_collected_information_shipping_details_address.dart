...
/// auto generated
class WithSessionPostRequestBodyCollectedInformationShippingDetailsAddress
  ...
  /// Instantiates a new [WithSessionPostRequestBodyCollectedInformationShippingDetailsAddress] and sets the default values.
  WithSessionPostRequestBodyCollectedInformationShippingDetailsAddress()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithSessionPostRequestBodyCollectedInformationShippingDetailsAddress
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithSessionPostRequestBodyCollectedInformationShippingDetailsAddress();
  }
