...
class WithQuotePostRequestBodyDefaultTaxRates implements Parsable {
  ///  Composed type representation for type [Iterable<String>?]
  Iterable<String>? string_;

  ///  Composed type representation for type [String?]
  String? withQuotePostRequestBodyDefaultTaxRatesString;

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithQuotePostRequestBodyDefaultTaxRates createFromDiscriminatorValue(
      ParseNode parseNode) {
    var result = WithQuotePostRequestBodyDefaultTaxRates();
    if (parseNode.getStringValue() != null) {
      result.withQuotePostRequestBodyDefaultTaxRatesString =
  ...
  void serialize(SerializationWriter writer) {
    if (withQuotePostRequestBodyDefaultTaxRatesString != null) {
      writer.writeStringValue(
          null, withQuotePostRequestBodyDefaultTaxRatesString);
