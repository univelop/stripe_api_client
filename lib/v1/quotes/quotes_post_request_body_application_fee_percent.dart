...
class QuotesPostRequestBodyApplicationFeePercent implements Parsable {
  ...
  static QuotesPostRequestBodyApplicationFeePercent
      createFromDiscriminatorValue(ParseNode parseNode) {
    var result = QuotesPostRequestBodyApplicationFeePercent();
