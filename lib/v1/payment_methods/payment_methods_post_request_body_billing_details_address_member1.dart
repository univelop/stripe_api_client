...
/// auto generated
class PaymentMethodsPostRequestBodyBillingDetailsAddressMember1
  ...
  /// Instantiates a new [PaymentMethodsPostRequestBodyBillingDetailsAddressMember1] and sets the default values.
  PaymentMethodsPostRequestBodyBillingDetailsAddressMember1()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PaymentMethodsPostRequestBodyBillingDetailsAddressMember1
      createFromDiscriminatorValue(ParseNode parseNode) {
    return PaymentMethodsPostRequestBodyBillingDetailsAddressMember1();
  }
