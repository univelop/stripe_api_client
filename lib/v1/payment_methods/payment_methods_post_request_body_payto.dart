...
class PaymentMethodsPostRequestBodyPayto
  ...
  /// Instantiates a new [PaymentMethodsPostRequestBodyPayto] and sets the default values.
  PaymentMethodsPostRequestBodyPayto() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PaymentMethodsPostRequestBodyPayto createFromDiscriminatorValue(
      ParseNode parseNode) {
    return PaymentMethodsPostRequestBodyPayto();
  }
