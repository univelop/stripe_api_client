...
class PaymentMethodsPostRequestBodyAcssDebit
  ...
  /// Instantiates a new [PaymentMethodsPostRequestBodyAcssDebit] and sets the default values.
  PaymentMethodsPostRequestBodyAcssDebit() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static PaymentMethodsPostRequestBodyAcssDebit createFromDiscriminatorValue(
      ParseNode parseNode) {
    return PaymentMethodsPostRequestBodyAcssDebit();
  }
