...
/// auto generated
class WithPaymentMethodPostRequestBodyBillingDetailsAddressMember1
  ...
  /// Instantiates a new [WithPaymentMethodPostRequestBodyBillingDetailsAddressMember1] and sets the default values.
  WithPaymentMethodPostRequestBodyBillingDetailsAddressMember1()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithPaymentMethodPostRequestBodyBillingDetailsAddressMember1
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithPaymentMethodPostRequestBodyBillingDetailsAddressMember1();
  }
