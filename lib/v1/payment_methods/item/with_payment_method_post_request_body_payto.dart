...
class WithPaymentMethodPostRequestBodyPayto
  ...
  /// Instantiates a new [WithPaymentMethodPostRequestBodyPayto] and sets the default values.
  WithPaymentMethodPostRequestBodyPayto() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithPaymentMethodPostRequestBodyPayto createFromDiscriminatorValue(
      ParseNode parseNode) {
    return WithPaymentMethodPostRequestBodyPayto();
  }
