...
/// auto generated
class ConfigurationsPostRequestBodyTippingMember1Cad
  ...
  /// Instantiates a new [ConfigurationsPostRequestBodyTippingMember1Cad] and sets the default values.
  ConfigurationsPostRequestBodyTippingMember1Cad() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ConfigurationsPostRequestBodyTippingMember1Cad
      createFromDiscriminatorValue(ParseNode parseNode) {
    return ConfigurationsPostRequestBodyTippingMember1Cad();
  }
