...
/// auto generated
class ConfigurationsPostRequestBodyWifiMember1EnterpriseEapPeap
  ...
  /// Instantiates a new [ConfigurationsPostRequestBodyWifiMember1EnterpriseEapPeap] and sets the default values.
  ConfigurationsPostRequestBodyWifiMember1EnterpriseEapPeap()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ConfigurationsPostRequestBodyWifiMember1EnterpriseEapPeap
      createFromDiscriminatorValue(ParseNode parseNode) {
    return ConfigurationsPostRequestBodyWifiMember1EnterpriseEapPeap();
  }
