...
/// auto generated
class ConfigurationsPostRequestBodyTippingMember1Mxn
  ...
  /// Instantiates a new [ConfigurationsPostRequestBodyTippingMember1Mxn] and sets the default values.
  ConfigurationsPostRequestBodyTippingMember1Mxn() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ConfigurationsPostRequestBodyTippingMember1Mxn
      createFromDiscriminatorValue(ParseNode parseNode) {
    return ConfigurationsPostRequestBodyTippingMember1Mxn();
  }
