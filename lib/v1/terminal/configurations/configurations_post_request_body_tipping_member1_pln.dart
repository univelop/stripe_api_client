...
/// auto generated
class ConfigurationsPostRequestBodyTippingMember1Pln
  ...
  /// Instantiates a new [ConfigurationsPostRequestBodyTippingMember1Pln] and sets the default values.
  ConfigurationsPostRequestBodyTippingMember1Pln() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ConfigurationsPostRequestBodyTippingMember1Pln
      createFromDiscriminatorValue(ParseNode parseNode) {
    return ConfigurationsPostRequestBodyTippingMember1Pln();
  }
