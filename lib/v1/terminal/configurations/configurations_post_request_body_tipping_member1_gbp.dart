...
/// auto generated
class ConfigurationsPostRequestBodyTippingMember1Gbp
  ...
  /// Instantiates a new [ConfigurationsPostRequestBodyTippingMember1Gbp] and sets the default values.
  ConfigurationsPostRequestBodyTippingMember1Gbp() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ConfigurationsPostRequestBodyTippingMember1Gbp
      createFromDiscriminatorValue(ParseNode parseNode) {
    return ConfigurationsPostRequestBodyTippingMember1Gbp();
  }
