...
/// auto generated
class ConfigurationsPostRequestBodyTippingMember1Hkd
  ...
  /// Instantiates a new [ConfigurationsPostRequestBodyTippingMember1Hkd] and sets the default values.
  ConfigurationsPostRequestBodyTippingMember1Hkd() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ConfigurationsPostRequestBodyTippingMember1Hkd
      createFromDiscriminatorValue(ParseNode parseNode) {
    return ConfigurationsPostRequestBodyTippingMember1Hkd();
  }
