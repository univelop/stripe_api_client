...
/// auto generated
class ConfigurationsPostRequestBodyTippingMember1Bgn
  ...
  /// Instantiates a new [ConfigurationsPostRequestBodyTippingMember1Bgn] and sets the default values.
  ConfigurationsPostRequestBodyTippingMember1Bgn() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ConfigurationsPostRequestBodyTippingMember1Bgn
      createFromDiscriminatorValue(ParseNode parseNode) {
    return ConfigurationsPostRequestBodyTippingMember1Bgn();
  }
