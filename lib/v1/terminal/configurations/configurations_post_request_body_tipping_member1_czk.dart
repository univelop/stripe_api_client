...
/// auto generated
class ConfigurationsPostRequestBodyTippingMember1Czk
  ...
  /// Instantiates a new [ConfigurationsPostRequestBodyTippingMember1Czk] and sets the default values.
  ConfigurationsPostRequestBodyTippingMember1Czk() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ConfigurationsPostRequestBodyTippingMember1Czk
      createFromDiscriminatorValue(ParseNode parseNode) {
    return ConfigurationsPostRequestBodyTippingMember1Czk();
  }
