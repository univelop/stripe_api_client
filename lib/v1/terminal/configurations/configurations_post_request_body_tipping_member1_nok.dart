...
/// auto generated
class ConfigurationsPostRequestBodyTippingMember1Nok
  ...
  /// Instantiates a new [ConfigurationsPostRequestBodyTippingMember1Nok] and sets the default values.
  ConfigurationsPostRequestBodyTippingMember1Nok() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ConfigurationsPostRequestBodyTippingMember1Nok
      createFromDiscriminatorValue(ParseNode parseNode) {
    return ConfigurationsPostRequestBodyTippingMember1Nok();
  }
