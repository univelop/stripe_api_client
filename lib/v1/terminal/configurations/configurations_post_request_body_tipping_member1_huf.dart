...
/// auto generated
class ConfigurationsPostRequestBodyTippingMember1Huf
  ...
  /// Instantiates a new [ConfigurationsPostRequestBodyTippingMember1Huf] and sets the default values.
  ConfigurationsPostRequestBodyTippingMember1Huf() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ConfigurationsPostRequestBodyTippingMember1Huf
      createFromDiscriminatorValue(ParseNode parseNode) {
    return ConfigurationsPostRequestBodyTippingMember1Huf();
  }
