...
/// auto generated
class ConfigurationsPostRequestBodyTippingMember1Ron
  ...
  /// Instantiates a new [ConfigurationsPostRequestBodyTippingMember1Ron] and sets the default values.
  ConfigurationsPostRequestBodyTippingMember1Ron() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ConfigurationsPostRequestBodyTippingMember1Ron
      createFromDiscriminatorValue(ParseNode parseNode) {
    return ConfigurationsPostRequestBodyTippingMember1Ron();
  }
