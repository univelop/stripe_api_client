...
/// auto generated
class ConfigurationsPostRequestBodyWifiMember1EnterpriseEapTls
  ...
  /// Instantiates a new [ConfigurationsPostRequestBodyWifiMember1EnterpriseEapTls] and sets the default values.
  ConfigurationsPostRequestBodyWifiMember1EnterpriseEapTls()
      : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ConfigurationsPostRequestBodyWifiMember1EnterpriseEapTls
      createFromDiscriminatorValue(ParseNode parseNode) {
    return ConfigurationsPostRequestBodyWifiMember1EnterpriseEapTls();
  }
