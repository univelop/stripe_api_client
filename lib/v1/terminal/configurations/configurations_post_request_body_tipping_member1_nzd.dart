...
/// auto generated
class ConfigurationsPostRequestBodyTippingMember1Nzd
  ...
  /// Instantiates a new [ConfigurationsPostRequestBodyTippingMember1Nzd] and sets the default values.
  ConfigurationsPostRequestBodyTippingMember1Nzd() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ConfigurationsPostRequestBodyTippingMember1Nzd
      createFromDiscriminatorValue(ParseNode parseNode) {
    return ConfigurationsPostRequestBodyTippingMember1Nzd();
  }
