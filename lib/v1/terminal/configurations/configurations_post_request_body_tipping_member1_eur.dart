...
/// auto generated
class ConfigurationsPostRequestBodyTippingMember1Eur
  ...
  /// Instantiates a new [ConfigurationsPostRequestBodyTippingMember1Eur] and sets the default values.
  ConfigurationsPostRequestBodyTippingMember1Eur() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ConfigurationsPostRequestBodyTippingMember1Eur
      createFromDiscriminatorValue(ParseNode parseNode) {
    return ConfigurationsPostRequestBodyTippingMember1Eur();
  }
