...
/// auto generated
class ConfigurationsPostRequestBodyTippingMember1Usd
  ...
  /// Instantiates a new [ConfigurationsPostRequestBodyTippingMember1Usd] and sets the default values.
  ConfigurationsPostRequestBodyTippingMember1Usd() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ConfigurationsPostRequestBodyTippingMember1Usd
      createFromDiscriminatorValue(ParseNode parseNode) {
    return ConfigurationsPostRequestBodyTippingMember1Usd();
  }
