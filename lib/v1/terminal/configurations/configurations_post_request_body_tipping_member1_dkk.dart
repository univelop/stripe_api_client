...
/// auto generated
class ConfigurationsPostRequestBodyTippingMember1Dkk
  ...
  /// Instantiates a new [ConfigurationsPostRequestBodyTippingMember1Dkk] and sets the default values.
  ConfigurationsPostRequestBodyTippingMember1Dkk() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ConfigurationsPostRequestBodyTippingMember1Dkk
      createFromDiscriminatorValue(ParseNode parseNode) {
    return ConfigurationsPostRequestBodyTippingMember1Dkk();
  }
