...
/// auto generated
class ConfigurationsPostRequestBodyTippingMember1Sek
  ...
  /// Instantiates a new [ConfigurationsPostRequestBodyTippingMember1Sek] and sets the default values.
  ConfigurationsPostRequestBodyTippingMember1Sek() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ConfigurationsPostRequestBodyTippingMember1Sek
      createFromDiscriminatorValue(ParseNode parseNode) {
    return ConfigurationsPostRequestBodyTippingMember1Sek();
  }
