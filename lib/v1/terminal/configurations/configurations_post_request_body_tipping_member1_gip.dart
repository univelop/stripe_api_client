...
/// auto generated
class ConfigurationsPostRequestBodyTippingMember1Gip
  ...
  /// Instantiates a new [ConfigurationsPostRequestBodyTippingMember1Gip] and sets the default values.
  ConfigurationsPostRequestBodyTippingMember1Gip() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ConfigurationsPostRequestBodyTippingMember1Gip
      createFromDiscriminatorValue(ParseNode parseNode) {
    return ConfigurationsPostRequestBodyTippingMember1Gip();
  }
