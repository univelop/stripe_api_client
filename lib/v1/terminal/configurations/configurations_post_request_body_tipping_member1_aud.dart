...
/// auto generated
class ConfigurationsPostRequestBodyTippingMember1Aud
  ...
  /// Instantiates a new [ConfigurationsPostRequestBodyTippingMember1Aud] and sets the default values.
  ConfigurationsPostRequestBodyTippingMember1Aud() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ConfigurationsPostRequestBodyTippingMember1Aud
      createFromDiscriminatorValue(ParseNode parseNode) {
    return ConfigurationsPostRequestBodyTippingMember1Aud();
  }
