...
/// auto generated
class WithConfigurationPostRequestBodyTippingMember1Eur
  ...
  /// Instantiates a new [WithConfigurationPostRequestBodyTippingMember1Eur] and sets the default values.
  WithConfigurationPostRequestBodyTippingMember1Eur() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithConfigurationPostRequestBodyTippingMember1Eur
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithConfigurationPostRequestBodyTippingMember1Eur();
  }
