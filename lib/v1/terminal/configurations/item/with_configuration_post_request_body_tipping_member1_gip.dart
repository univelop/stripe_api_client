...
/// auto generated
class WithConfigurationPostRequestBodyTippingMember1Gip
  ...
  /// Instantiates a new [WithConfigurationPostRequestBodyTippingMember1Gip] and sets the default values.
  WithConfigurationPostRequestBodyTippingMember1Gip() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithConfigurationPostRequestBodyTippingMember1Gip
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithConfigurationPostRequestBodyTippingMember1Gip();
  }
