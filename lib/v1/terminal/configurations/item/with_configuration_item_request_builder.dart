...
import '../../../../models/deleted_terminal/configuration.dart';
import '../../../../models/error.dart';
import './with_configuration_delete_request_body.dart';
import './with_configuration_get_request_body.dart';
import './with_configuration_get_response.dart';
import './with_configuration_item_request_builder_get_query_parameters.dart';
import './with_configuration_post_request_body.dart';
import './with_configuration_post_response.dart';
...
class WithConfigurationItemRequestBuilder
  ...
  WithConfigurationItemRequestBuilder(
      ...
      : super(
            requestAdapter,
            "{+baseurl}/v1/terminal/configurations/{configuration}{?expand*}",
            pathParameters);
  ...
  Future<Configuration?> deleteAsync(WithConfigurationDeleteRequestBody body,
  ...
  ///  [body] The request body
  ///  [requestConfiguration] Configuration for the request such as headers, query parameters, and middleware options.
  Future<WithConfigurationGetResponse?> getAsync(
    ...
    return await requestAdapter.send<WithConfigurationGetResponse>(
        requestInfo,
        WithConfigurationGetResponse.createFromDiscriminatorValue,
        errorMapping);
  }
  ...
  ///  [body] The request body
  ///  [requestConfiguration] Configuration for the request such as headers, query parameters, and middleware options.
  Future<WithConfigurationPostResponse?> postAsync(
    ...
    return await requestAdapter.send<WithConfigurationPostResponse>(
        requestInfo,
        WithConfigurationPostResponse.createFromDiscriminatorValue,
        errorMapping);
  }
  ...
  RequestInformation toDeleteRequestInformation(
      WithConfigurationDeleteRequestBody body,
      [void Function(RequestConfiguration<DefaultQueryParameters>)?
          requestConfiguration]) {
