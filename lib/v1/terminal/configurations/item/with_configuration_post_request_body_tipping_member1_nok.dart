...
/// auto generated
class WithConfigurationPostRequestBodyTippingMember1Nok
  ...
  /// Instantiates a new [WithConfigurationPostRequestBodyTippingMember1Nok] and sets the default values.
  WithConfigurationPostRequestBodyTippingMember1Nok() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithConfigurationPostRequestBodyTippingMember1Nok
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithConfigurationPostRequestBodyTippingMember1Nok();
  }
