...
class WithConfigurationGetResponse implements Parsable {
  ///  Composed type representation for type [Configuration]
  Configuration? configuration;

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithConfigurationGetResponse createFromDiscriminatorValue(
      ParseNode parseNode) {
    var result = WithConfigurationGetResponse();
