...
/// auto generated
class WithConfigurationPostRequestBodyTippingMember1Aud
  ...
  /// Instantiates a new [WithConfigurationPostRequestBodyTippingMember1Aud] and sets the default values.
  WithConfigurationPostRequestBodyTippingMember1Aud() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithConfigurationPostRequestBodyTippingMember1Aud
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithConfigurationPostRequestBodyTippingMember1Aud();
  }
