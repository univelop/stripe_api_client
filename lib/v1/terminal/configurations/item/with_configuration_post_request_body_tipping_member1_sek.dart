...
/// auto generated
class WithConfigurationPostRequestBodyTippingMember1Sek
  ...
  /// Instantiates a new [WithConfigurationPostRequestBodyTippingMember1Sek] and sets the default values.
  WithConfigurationPostRequestBodyTippingMember1Sek() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithConfigurationPostRequestBodyTippingMember1Sek
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithConfigurationPostRequestBodyTippingMember1Sek();
  }
