...
/// auto generated
class WithConfigurationPostRequestBodyTippingMember1Ron
  ...
  /// Instantiates a new [WithConfigurationPostRequestBodyTippingMember1Ron] and sets the default values.
  WithConfigurationPostRequestBodyTippingMember1Ron() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithConfigurationPostRequestBodyTippingMember1Ron
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithConfigurationPostRequestBodyTippingMember1Ron();
  }
