...
/// auto generated
class WithConfigurationPostRequestBodyTippingMember1Huf
  ...
  /// Instantiates a new [WithConfigurationPostRequestBodyTippingMember1Huf] and sets the default values.
  WithConfigurationPostRequestBodyTippingMember1Huf() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithConfigurationPostRequestBodyTippingMember1Huf
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithConfigurationPostRequestBodyTippingMember1Huf();
  }
