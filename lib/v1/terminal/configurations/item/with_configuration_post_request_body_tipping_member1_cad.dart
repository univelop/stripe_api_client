...
/// auto generated
class WithConfigurationPostRequestBodyTippingMember1Cad
  ...
  /// Instantiates a new [WithConfigurationPostRequestBodyTippingMember1Cad] and sets the default values.
  WithConfigurationPostRequestBodyTippingMember1Cad() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithConfigurationPostRequestBodyTippingMember1Cad
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithConfigurationPostRequestBodyTippingMember1Cad();
  }
