...
/// auto generated
class WithConfigurationPostRequestBodyTippingMember1Myr
  ...
  /// Instantiates a new [WithConfigurationPostRequestBodyTippingMember1Myr] and sets the default values.
  WithConfigurationPostRequestBodyTippingMember1Myr() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithConfigurationPostRequestBodyTippingMember1Myr
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithConfigurationPostRequestBodyTippingMember1Myr();
  }
