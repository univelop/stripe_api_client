...
/// auto generated
class WithConfigurationPostRequestBodyTippingMember1Chf
  ...
  /// Instantiates a new [WithConfigurationPostRequestBodyTippingMember1Chf] and sets the default values.
  WithConfigurationPostRequestBodyTippingMember1Chf() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithConfigurationPostRequestBodyTippingMember1Chf
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithConfigurationPostRequestBodyTippingMember1Chf();
  }
