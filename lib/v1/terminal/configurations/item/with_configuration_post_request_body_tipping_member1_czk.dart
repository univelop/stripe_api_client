...
/// auto generated
class WithConfigurationPostRequestBodyTippingMember1Czk
  ...
  /// Instantiates a new [WithConfigurationPostRequestBodyTippingMember1Czk] and sets the default values.
  WithConfigurationPostRequestBodyTippingMember1Czk() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithConfigurationPostRequestBodyTippingMember1Czk
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithConfigurationPostRequestBodyTippingMember1Czk();
  }
