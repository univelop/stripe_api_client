...
/// auto generated
class WithConfigurationPostRequestBodyTippingMember1Dkk
  ...
  /// Instantiates a new [WithConfigurationPostRequestBodyTippingMember1Dkk] and sets the default values.
  WithConfigurationPostRequestBodyTippingMember1Dkk() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithConfigurationPostRequestBodyTippingMember1Dkk
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithConfigurationPostRequestBodyTippingMember1Dkk();
  }
