...
/// auto generated
class WithConfigurationPostRequestBodyTippingMember1Bgn
  ...
  /// Instantiates a new [WithConfigurationPostRequestBodyTippingMember1Bgn] and sets the default values.
  WithConfigurationPostRequestBodyTippingMember1Bgn() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithConfigurationPostRequestBodyTippingMember1Bgn
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithConfigurationPostRequestBodyTippingMember1Bgn();
  }
