...
/// auto generated
class WithConfigurationPostRequestBodyTippingMember1Mxn
  ...
  /// Instantiates a new [WithConfigurationPostRequestBodyTippingMember1Mxn] and sets the default values.
  WithConfigurationPostRequestBodyTippingMember1Mxn() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithConfigurationPostRequestBodyTippingMember1Mxn
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithConfigurationPostRequestBodyTippingMember1Mxn();
  }
