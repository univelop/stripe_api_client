...
/// auto generated
class WithConfigurationPostRequestBodyTippingMember1Hkd
  ...
  /// Instantiates a new [WithConfigurationPostRequestBodyTippingMember1Hkd] and sets the default values.
  WithConfigurationPostRequestBodyTippingMember1Hkd() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithConfigurationPostRequestBodyTippingMember1Hkd
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithConfigurationPostRequestBodyTippingMember1Hkd();
  }
