...
/// auto generated
class WithConfigurationPostRequestBodyTippingMember1Nzd
  ...
  /// Instantiates a new [WithConfigurationPostRequestBodyTippingMember1Nzd] and sets the default values.
  WithConfigurationPostRequestBodyTippingMember1Nzd() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithConfigurationPostRequestBodyTippingMember1Nzd
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithConfigurationPostRequestBodyTippingMember1Nzd();
  }
