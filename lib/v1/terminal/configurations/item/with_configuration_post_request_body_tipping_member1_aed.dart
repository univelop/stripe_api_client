...
/// auto generated
class WithConfigurationPostRequestBodyTippingMember1Aed
  ...
  /// Instantiates a new [WithConfigurationPostRequestBodyTippingMember1Aed] and sets the default values.
  WithConfigurationPostRequestBodyTippingMember1Aed() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithConfigurationPostRequestBodyTippingMember1Aed
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithConfigurationPostRequestBodyTippingMember1Aed();
  }
