...
/// auto generated
class WithConfigurationPostRequestBodyTippingMember1Pln
  ...
  /// Instantiates a new [WithConfigurationPostRequestBodyTippingMember1Pln] and sets the default values.
  WithConfigurationPostRequestBodyTippingMember1Pln() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithConfigurationPostRequestBodyTippingMember1Pln
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithConfigurationPostRequestBodyTippingMember1Pln();
  }
