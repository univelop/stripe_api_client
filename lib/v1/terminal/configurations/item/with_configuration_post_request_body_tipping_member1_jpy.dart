...
/// auto generated
class WithConfigurationPostRequestBodyTippingMember1Jpy
  ...
  /// Instantiates a new [WithConfigurationPostRequestBodyTippingMember1Jpy] and sets the default values.
  WithConfigurationPostRequestBodyTippingMember1Jpy() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithConfigurationPostRequestBodyTippingMember1Jpy
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithConfigurationPostRequestBodyTippingMember1Jpy();
  }
