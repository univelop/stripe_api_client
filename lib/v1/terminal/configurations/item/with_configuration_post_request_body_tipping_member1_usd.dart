...
/// auto generated
class WithConfigurationPostRequestBodyTippingMember1Usd
  ...
  /// Instantiates a new [WithConfigurationPostRequestBodyTippingMember1Usd] and sets the default values.
  WithConfigurationPostRequestBodyTippingMember1Usd() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithConfigurationPostRequestBodyTippingMember1Usd
      createFromDiscriminatorValue(ParseNode parseNode) {
    return WithConfigurationPostRequestBodyTippingMember1Usd();
  }
