...
/// auto generated
class ConfigurationsPostRequestBodyTippingMember1Chf
  ...
  /// Instantiates a new [ConfigurationsPostRequestBodyTippingMember1Chf] and sets the default values.
  ConfigurationsPostRequestBodyTippingMember1Chf() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ConfigurationsPostRequestBodyTippingMember1Chf
      createFromDiscriminatorValue(ParseNode parseNode) {
    return ConfigurationsPostRequestBodyTippingMember1Chf();
  }
