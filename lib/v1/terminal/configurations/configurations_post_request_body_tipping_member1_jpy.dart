...
/// auto generated
class ConfigurationsPostRequestBodyTippingMember1Jpy
  ...
  /// Instantiates a new [ConfigurationsPostRequestBodyTippingMember1Jpy] and sets the default values.
  ConfigurationsPostRequestBodyTippingMember1Jpy() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ConfigurationsPostRequestBodyTippingMember1Jpy
      createFromDiscriminatorValue(ParseNode parseNode) {
    return ConfigurationsPostRequestBodyTippingMember1Jpy();
  }
