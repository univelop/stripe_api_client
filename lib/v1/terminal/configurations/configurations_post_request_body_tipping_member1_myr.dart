...
/// auto generated
class ConfigurationsPostRequestBodyTippingMember1Myr
  ...
  /// Instantiates a new [ConfigurationsPostRequestBodyTippingMember1Myr] and sets the default values.
  ConfigurationsPostRequestBodyTippingMember1Myr() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static ConfigurationsPostRequestBodyTippingMember1Myr
      createFromDiscriminatorValue(ParseNode parseNode) {
    return ConfigurationsPostRequestBodyTippingMember1Myr();
  }
