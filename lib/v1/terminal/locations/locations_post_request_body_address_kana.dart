...
class LocationsPostRequestBodyAddressKana
  ...
  /// Instantiates a new [LocationsPostRequestBodyAddressKana] and sets the default values.
  LocationsPostRequestBodyAddressKana() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static LocationsPostRequestBodyAddressKana createFromDiscriminatorValue(
      ParseNode parseNode) {
    return LocationsPostRequestBodyAddressKana();
  }
