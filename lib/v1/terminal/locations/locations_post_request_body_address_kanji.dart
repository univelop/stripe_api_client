...
class LocationsPostRequestBodyAddressKanji
  ...
  /// Instantiates a new [LocationsPostRequestBodyAddressKanji] and sets the default values.
  LocationsPostRequestBodyAddressKanji() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static LocationsPostRequestBodyAddressKanji createFromDiscriminatorValue(
      ParseNode parseNode) {
    return LocationsPostRequestBodyAddressKanji();
  }
