...
class WithLocationPostRequestBodyAddressKana
  ...
  /// Instantiates a new [WithLocationPostRequestBodyAddressKana] and sets the default values.
  WithLocationPostRequestBodyAddressKana() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithLocationPostRequestBodyAddressKana createFromDiscriminatorValue(
      ParseNode parseNode) {
    return WithLocationPostRequestBodyAddressKana();
  }
