...
class WithLocationPostRequestBodyAddress
  ...
  /// Instantiates a new [WithLocationPostRequestBodyAddress] and sets the default values.
  WithLocationPostRequestBodyAddress() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithLocationPostRequestBodyAddress createFromDiscriminatorValue(
      ParseNode parseNode) {
    return WithLocationPostRequestBodyAddress();
  }
