...
class WithLocationPostRequestBodyAddressKanji
  ...
  /// Instantiates a new [WithLocationPostRequestBodyAddressKanji] and sets the default values.
  WithLocationPostRequestBodyAddressKanji() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static WithLocationPostRequestBodyAddressKanji createFromDiscriminatorValue(
      ParseNode parseNode) {
    return WithLocationPostRequestBodyAddressKanji();
  }
