...
class LocationsPostRequestBodyAddress
  ...
  /// Instantiates a new [LocationsPostRequestBodyAddress] and sets the default values.
  LocationsPostRequestBodyAddress() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static LocationsPostRequestBodyAddress createFromDiscriminatorValue(
      ParseNode parseNode) {
    return LocationsPostRequestBodyAddress();
  }
