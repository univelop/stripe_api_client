...
/// auto generated
class SettingsPostRequestBodyHeadOfficeAddress
  ...
  /// Instantiates a new [SettingsPostRequestBodyHeadOfficeAddress] and sets the default values.
  SettingsPostRequestBodyHeadOfficeAddress() : additionalData = {};

  /// Creates a new instance of the appropriate class based on discriminator value
  ///  [parseNode] The parse node to use to read the discriminator value and create the object
  static SettingsPostRequestBodyHeadOfficeAddress createFromDiscriminatorValue(
      ParseNode parseNode) {
    return SettingsPostRequestBodyHeadOfficeAddress();
  }
