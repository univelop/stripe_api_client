...
class TaxIdsRequestBuilder extends BaseRequestBuilder<TaxIdsRequestBuilder> {
  /// Gets an item from the ApiSdk.v1.tax_ids.item collection
  ...
  TaxIdsRequestBuilder(
      ...
      : super(
            requestAdapter,
            "{+baseurl}/v1/tax_ids{?ending_before*,expand*,limit*,owner*,starting_after*}",
            pathParameters);
  ...
  Future<TaxIdsGetResponse?> getAsync(TaxIdsGetRequestBody body,
      [void Function(
